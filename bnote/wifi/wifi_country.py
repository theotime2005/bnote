    ...
    def network_get_country():
        ...
        with subprocess.Popen(args, stdout=subprocess.PIPE, stderr=subprocess.PIPE) as x:
            ...
            for line in lines:
                line = line.strip()
                if is_global:
                    res = re.search(r'country\s*(\w+)', line)
                    return res.group(1)
                else:
                    if line == "global":
                        is_global = True
