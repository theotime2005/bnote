...
from ui.ui_multi_lines_box import UiMultiLinesBox
...
from debug.colored_log import ColoredLogger, SKELETON_APP_LOG
...
class SkeletonApp(BnoteApp):
    ...
    def __init__(self, put_in_function_queue):
        ...
        """
        # Call base class.
        super(SkeletonApp, self).__init__(put_in_function_queue)
        # menu creation.
            ...
            menu_item_list=[
                UiMenuBar(
                    ...
                    menu_item_list=[
                        ...
                        UiMenuItem(name=_("&choose_file"), action=self._exec_choose_file_menu),
                    ]),
        ...
        self._current_dialog = UiDialogBox(
            ...
            item_list=[
                 ...
                 UiMultiLinesBox(
                     ...
                     value=("message", "line 1\nline 2\nline 3"),
                     is_read_only=True),
                 UiEditBox(name=_("&editbox"), value=("editbox", "Text to edit")),
                 UiListBox(name=_("&listbox"), value=("line", ["line 1", "line 2", "line 3"]), current_index=1),
                 UiCheckBox(name=_("&checkbox"), value=("checkbox", True)),
                 UiButton(name=_("&ok"), action=self._exec_valid_sample_dialog),
    ...
    def _exec_choose_file_menu(self):
        self._current_dialog = UiDialogBox(
            name=_("insert file"),
            item_list=[
                UiFileBox(root=FileManager.get_root_path(), suffix_filter=(".txt", ".pdf")),
    ...
    def _exec_about(self):
        ...
        self._current_dialog = UiMessageDialogBox(
            name=_("information"),
            message=_("application skeleton V1.0.0"),
            buttons=[
