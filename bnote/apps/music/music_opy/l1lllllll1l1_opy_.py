...
from .l1l1lll11l11_opy_ import l1l1lll11l1l_opy_
from .l1l1l1ll11_opy_ import *


class l1llllll1l1l_opy_:
    def __init__(
        self, lou, l11111l1ll_opy_, l1ll1111l1_opy_, l111111l1l_opy_, extension
    ):
        self.lou = lou
        self._11111ll11_opy_ = l11111l1ll_opy_
        self._1ll1l1l1l_opy_ = l1ll1111l1_opy_
        if extension.lower() == "musicxml":
            self._1l1lll11ll1_opy_ = "music_xml"
        else:
            self._1l1lll11ll1_opy_ = "music_bxml"
    ...
    def l1111ll1lll_opy_(self, l1111ll1l1l_opy_):
        ...
        self._1111ll1l11_opy_ = None
        try:
            self._1111llll11_opy_ = open("trace_midi1.txt", "w", encoding="utf-8")
            l1lll111ll_opy_ = l1ll1l111l_opy_(
                self.lou,
                self.l1111ll1ll1_opy_,
                self._1ll1l1l1l_opy_,
                self._1llllll1l_opy_,
                (self.l111111l1l_opy_, self._1l1lll11ll1_opy_),
            )
            ...
            l1l1lll11l11_opy_ = l1l1lll11l1l_opy_(l11l11llll1_opy_)
            l1l1lll11l11_opy_.create_file(self._11111ll11_opy_)
