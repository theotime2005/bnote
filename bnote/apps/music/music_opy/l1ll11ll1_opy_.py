...
from .l1l11l11l_opy_ import l1l11l111_opy_
from .l1l1l111l_opy_ import *
class l1ll1111l_opy_:
    ...
    def l1lll1111_opy_(self, l1ll11111_opy_):
        ...
        self._1l1l1lll_opy_ = None
        try:
            self._1l11l1ll_opy_ = open("trace_braille.txt", "w", encoding="utf-8")
            self._1l11ll11_opy_ = open(self._1l1lllll_opy_, 'wb')
            l1l1l1l11_opy_ = l1l1l1111_opy_(self.lou, self.l1l111l1l_opy_, self._1l1lll11_opy_, self._1l111ll1_opy_, (self.l1l1ll111_opy_, 'music_xml'))
            ...
            l1l11l11l_opy_ = l1l11l111_opy_(self.l1l1l11l1_opy_, self.l1l111l1l_opy_, l1l11ll1l_opy_)
            l1l11l11l_opy_.create_file()
