...
class MusicWriteFile(threading.Thread):
    ...
    l1l1ll11l_opy_ = 1
    l1l1l1111_opy_ = 2
    def __init__(self, lou, settings, l1l1lllll_opy_, l1l11ll11_opy_, l1l11llll_opy_, l1l1l11l1_opy_, function, extension=None):
    ...
    def run(self):
        ...
        try:
            if l1l1l111l_opy_ == ".bxml":
                l1l1lll11_opy_ = l1ll111ll_opy_(self._1l1ll1ll_opy_, self._1l1ll111_opy_, self._1l1l11ll_opy_, self._1l1l1l1l_opy_)
                self.error = l1l1lll11_opy_.l1ll111l1_opy_(self._1l11lll1_opy_)
            elif l1l1l111l_opy_ == ".musicxml":
                l1l1lll11_opy_ = l1l11ll1l_opy_(self._1l1ll1ll_opy_, self._1l1ll111_opy_, self._1l1l11ll_opy_, self._1l1l1l1l_opy_)
                self.error = l1l1lll11_opy_.l1ll111l1_opy_(self._1l11lll1_opy_)
            elif l1l1l111l_opy_ == ".midi" or l1l1l111l_opy_ == ".mid":
                l1l1lll11_opy_ = l1l1lll1l_opy_(self._1l1ll1ll_opy_, self._1l1ll111_opy_, self._1l1l11ll_opy_, self._1l1l1l1l_opy_, self.extension)
                self.error = l1l1lll11_opy_.l1ll111l1_opy_(self._1l11lll1_opy_)
            else:
