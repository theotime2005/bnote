            ...
            if element.t == "part":
                    ...
                    for event in l111111l1l_opy_.l111l11lll_opy_:
                        ...
                        if event.t == "attributes":
                            ...
                            if l11l1l1l1l_opy_ or l1lllll11ll_opy_ or l11111l11l_opy_ or l1l1111l11_opy_ or l1111lllll_opy_ or l11ll111l1_opy_:
                                ...
                                if l11l1l1l1l_opy_:
                                    l1llllllll1_opy_ = l111lllll1_opy_.SubElement(l1l11l111l_opy_, "divisions").text = l1l111lll1_opy_
                                    l11l1l1l1l_opy_ = False
                                if l1lllll11ll_opy_:
                                    l1l111l1l1_opy_ = l111lllll1_opy_.SubElement(l1l11l111l_opy_, "key")
                                    l1llll1l1ll_opy_ = l111lllll1_opy_.SubElement(l1l111l1l1_opy_, "fifths").text = l11llll1ll_opy_
                                    if l11l11llll_opy_ !="no":
                                        l111ll111l_opy_ = l111lllll1_opy_.SubElement(l1l111l1l1_opy_, "mode").text = l11l11llll_opy_
                                    l1lllll11ll_opy_ = False
                                if l11111l11l_opy_:
                                    l111111lll_opy_ = l111lllll1_opy_.SubElement(l1l11l111l_opy_, "time")
                                    l1lll1ll1l1_opy_ = l111lllll1_opy_.SubElement(l111111lll_opy_, "beats").text = l11l1l1111_opy_
                                    l111111l11_opy_ = l111lllll1_opy_.SubElement(l111111lll_opy_, "beat-type").text = l1lll11lll1_opy_
                                    if l1l11llll1_opy_ != "no":
                                        l111111lll_opy_.attrib = {"symbol":l1l11llll1_opy_}
                                    l11111l11l_opy_ = False
                                if l1l1111l11_opy_:
                                    l111l111l1_opy_ = l111lllll1_opy_.SubElement(l1l11l111l_opy_, "staves").text = l1lll1ll111_opy_
                                    l1l1111l11_opy_ = False
                                if l1111lllll_opy_:
                                    l11111l1l1_opy_ = l111lllll1_opy_.SubElement(l1l11l111l_opy_, "clef")
                                    l11l11l11l_opy_ = l111lllll1_opy_.SubElement(l11111l1l1_opy_, "sign").text = l11111lll1_opy_
                                    l111ll1l1l_opy_ = l111lllll1_opy_.SubElement(l11111l1l1_opy_, "line").text = l11l11111l_opy_
                                    if l111l1ll11_opy_ !="no":
                                        l1lll1lll1l_opy_ = l111lllll1_opy_.SubElement(l11111l1l1_opy_, "clef-octave-change").text = l111l1ll11_opy_
                                    l1111lllll_opy_ = False
                                if l11ll111l1_opy_:
                                    l11ll111ll_opy_ = l111lllll1_opy_.SubElement(l1l11l111l_opy_, "transpose")
                                    l1l11ll1ll_opy_ = l111lllll1_opy_.SubElement(l11ll111ll_opy_, "diatonic").text = l1lll11l1l1_opy_
                                    l11l1l1l11_opy_ = l111lllll1_opy_.SubElement(l11ll111ll_opy_, "chromatic").text = l11ll1111l_opy_
                                    l11111llll_opy_ = l111lllll1_opy_.SubElement(l11ll111ll_opy_, "octave-change").text = l11l111l1l_opy_
                                    if l111ll1lll_opy_:
                        ...
                        if event.t == "note":
                            ...
                            if event.step !="no":
                                ...
                                l1l111llll_opy_ = l111lllll1_opy_.SubElement(l1lll111ll1_opy_, "step").text = l11ll1l111_opy_[event.step]
                            if event.l11lll11ll_opy_ !="no":
                                l111l111ll_opy_ = l111lllll1_opy_.SubElement(l1lll111ll1_opy_, "alter").text = l11l1lll11_opy_[event.l11lll11ll_opy_]
                            if event.l1l11111ll_opy_ !=100:
                                l11lllllll_opy_ = l111lllll1_opy_.SubElement(l1lll111ll1_opy_, "octave").text = str(event.l1l11111ll_opy_)
                            if event.rest:
                                l1111ll1l1_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "rest")
                            if event.l11lll1l11_opy_ != 0:
                                l11l1ll1ll_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "duration").text = str(event.l11lll1l11_opy_)
                            ...
                            if event.l1111l1lll_opy_ != 0:
                                l111l1llll_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "voice").text = str(event.l1111l1lll_opy_)
                            if event.type !="no":
                                l1lllll1l1l_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "type").text = l111ll1l11_opy_[event.type]
                            if event.dot:
                                l1llll11l11_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "dot")
                            if event.l1llll11ll1_opy_ != "no":
                                l1l11lll1l_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "accidental").text = event.l1llll11ll1_opy_
                            if event.l1llllll11l_opy_ !=0 and event.l1lll1lll11_opy_ != 0:
                                ...
                                l111l1l111_opy_ = l111lllll1_opy_.SubElement(l1lll1lllll_opy_, "actual-notes").text = str(event.l1llllll11l_opy_)
                                l11lll1lll_opy_ = l111lllll1_opy_.SubElement(l1lll1lllll_opy_, "normal-notes").text = str(event.l1lll1lll11_opy_)
                            if event.l11111ll11_opy_ !="no":
                                l111l11111_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "staff").text = str(event.l11111ll11_opy_)
                            if event.l1l11l11l1_opy_:
                            ...
                            if event.l11llll111_opy_ !="no":
                                ...
                                l1l1111l1l_opy_ = l111lllll1_opy_.SubElement(l1l111111l_opy_, "fingering").text = event.l11llll111_opy_
                            ...
                            if event.l11l1ll111_opy_ or event.l1lllllll11_opy_:
                                if not l1111l1ll1_opy_:
                                    l11ll1ll11_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "notations")
                                    l1111l1ll1_opy_ = True
                                l1lll11ll11_opy_ = l111lllll1_opy_.SubElement(l11ll1ll11_opy_, "arpeggiate")
                                if event.l1lllll11l1_opy_ == "down" or event.l111l1lll1_opy_ == "down":
                                    l1lll11ll11_opy_.attrib = {"direction": "down"}
                            if event.text != "":
                                l11ll1l1l1_opy_ = l111lllll1_opy_.SubElement(l1lll1l1ll1_opy_, "lyric")
                                l11l1l111l_opy_ = l111lllll1_opy_.SubElement(l11ll1l1l1_opy_, "syllabic").text = event.l111llllll_opy_
                            ...
                            for l11lllll11_opy_ in event.l1lll1111l1_opy_:
                                if l11lllll11_opy_.t == "dynamics":
                                    ...
                                    l1111l1111_opy_ = l111lllll1_opy_.SubElement(l111l1ll1l_opy_, l11lllll11_opy_.l1l11l1ll1_opy_)
                                ...
                                if l11lllll11_opy_.t == "metronome":
                                    ...
                                    if l11lllll11_opy_.l11111l111_opy_ != "no":
                                        l1l111ll11_opy_ = l111lllll1_opy_.SubElement(l1lll11l1ll_opy_, "beat-unit").text = l11lllll11_opy_.l11111l111_opy_
                                    ...
                                    if l11lllll11_opy_.l111111ll1_opy_ != "no":
                                        l11l1l11l1_opy_ = l111lllll1_opy_.SubElement(l1lll11l1ll_opy_, "per-minute").text = l11lllll11_opy_.l111111ll1_opy_
                                ...
                                if l11lllll11_opy_.t == "words":
                                    l11l1ll11l_opy_ = l111lllll1_opy_.SubElement(l1llll111ll_opy_, "direction-type")
                                    l1111ll11l_opy_ = l111lllll1_opy_.SubElement(l11l1ll11l_opy_, "words").text = l11lllll11_opy_.words
                            if event.l11111ll11_opy_ != 1:
                                l11l1l11ll_opy_ = l111lllll1_opy_.SubElement(l1llll111ll_opy_, "staff").text = str(event.l11111ll11_opy_)
                        elif event.t == "backup":
                            l11lll1ll1_opy_ = l111lllll1_opy_.SubElement(l111l11l1l_opy_, "backup")
                            l11l1ll1ll_opy_ = l111lllll1_opy_.SubElement(l11lll1ll1_opy_, "duration").text = str(event.l11lll1l11_opy_)
                            ...
                            if event.l11ll1lll1_opy_ != "no":
                                l1llll1l111_opy_ = l111lllll1_opy_.SubElement(l11l1ll1l1_opy_, "bar-style").text = event.l11ll1lll1_opy_
                            if event.l1lll1ll111l_opy_:
                                l1l1llll1ll1_opy_ = l111lllll1_opy_.SubElement(l11l1ll1l1_opy_, "ending")
                                if event.l1llll1111l1_opy_ != "no":
                                    l1l1llll1ll1_opy_.attrib = {"number": event.l1llll1111l1_opy_}
                                if event.l1llll11ll11_opy_ != "no":
                                    l1l1llll1ll1_opy_.attrib.update({"type": event.l1llll11ll11_opy_})
                ...
                for l1l11111l1_opy_ in element.l111l1l1l1_opy_:
                    ...
                    if l1l11111l1_opy_.l111lll1ll_opy_ != "no":
                        l1lll1l11ll_opy_ = l111lllll1_opy_.SubElement(l1111l1l1l_opy_, "part-name").text = l1l11111l1_opy_.l111lll1ll_opy_
                    if l1l11111l1_opy_.l11111ll1l_opy_ != "no":
                        l1l1l1111l_opy_ = l111lllll1_opy_.SubElement(l1111l1l1l_opy_, "part-abbreviation").text = l1l11111l1_opy_.l11111ll1l_opy_
                    ...
                    if l1l11111l1_opy_.l1lllll111l_opy_ != "no":
                        l11l11ll1l_opy_ = l111lllll1_opy_.SubElement(l1lll11ll1l_opy_, "instrument-name").text = l1l11111l1_opy_.l1lllll111l_opy_
                    if l1l11111l1_opy_.l1l11l11ll_opy_ != "no" or l1l11111l1_opy_.l11l11l111_opy_ != "no":
                        ...
                        l1l1111ll1_opy_.attrib = {"id":l1l11111l1_opy_.l1l11l11ll_opy_, "port":l1l11111l1_opy_.l11l11l111_opy_}
                    ...
                    if l1l11111l1_opy_.l111ll11ll_opy_ != "no":
                        l11ll1ll1l_opy_ = l111lllll1_opy_.SubElement(l1llllll111_opy_, "midi-channel").text = l1l11111l1_opy_.l111ll11ll_opy_
                    if l1l11111l1_opy_.l11ll11l11_opy_ != "no":
                        l1l11lll11_opy_ = l111lllll1_opy_.SubElement(l1llllll111_opy_, "midi-program").text = l1l11111l1_opy_.l11ll11l11_opy_
                    if l1l11111l1_opy_.l1lllll1lll_opy_ != "no":
                        l111lll1l1_opy_ = l111lllll1_opy_.SubElement(l1llllll111_opy_, "volume").text = l1l11111l1_opy_.l1lllll1lll_opy_
                    if l1l11111l1_opy_.l1111ll1ll_opy_ != "no":
                        l11ll1l1ll_opy_ = l111lllll1_opy_.SubElement(l1llllll111_opy_, "pan").text = l1l11111l1_opy_.l1111ll1ll_opy_
                ...
                if element.l111lll111_opy_ !="no":
                    l111l11ll1_opy_ = l111lllll1_opy_.SubElement(l11l11lll1_opy_, "credit-type").text = element.l111lll111_opy_
                l11ll11lll_opy_ = l111lllll1_opy_.SubElement(l11l11lll1_opy_, "credit-words").text = element.l1llll1ll11_opy_
            elif element.t == "work":
                if not l1l1llll1lll_opy_ and not l1l1llll1l1l_opy_:
                    l1l1lllll11l_opy_ = l111lllll1_opy_.SubElement(root, "work")
                if element.l1lll1lll1ll_opy_ !="no":
                    l1l1llll1lll_opy_ = True
                    l1lll1lll1ll_opy_ = element.l1lll1lll1ll_opy_
                if element.l1llll11l11l_opy_ !="no":
                    l1l1llll1l1l_opy_ = True
                    l1llll11l11l_opy_ = element.l1llll11l11l_opy_
        if l1l1llll1lll_opy_:
            l1l1lllll111_opy_ = l111lllll1_opy_.SubElement(l1l1lllll11l_opy_, "work-number").text = l1lll1lll1ll_opy_
        if l1l1llll1l1l_opy_:
            l1l1llll1l11_opy_ = l111lllll1_opy_.SubElement(l1l1lllll11l_opy_, "work-title").text = l1llll11l11l_opy_
        l111llll1l_opy_ = minidom.parseString(l111lllll1_opy_.tostring(root)).toprettyxml(indent="   ", encoding="UTF-8", standalone="")
        if l1l11ll11l_opy_:
            self._11lllll1_opy_(str(l111llll1l_opy_))
        self._1l1111ll_opy_ (l111llll1l_opy_)
        l1l1111lll_opy_ = time.time()
        print("temps model to xml", l1l1111lll_opy_-t1)