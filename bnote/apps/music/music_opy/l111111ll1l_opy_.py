...
class l111111l1ll_opy_:
    ...
    def l11lll11l11_opy_(self, l11llll11l_opy_, encoding=None):
        ...
        self._11llllll_opy_ = open("trace_bxml.txt", "w", encoding='utf-8')
        l1l11ll11_opy_ = l111111lll1_opy_()
        l111111l1l1_opy_ = l1l1llll1l1_opy_(self.lou, self._1l1ll111_opy_, self.l11llll11_opy_)
        l111111l1l1_opy_.l11lll11l11_opy_(self.l11lll1ll_opy_, l1l11ll11_opy_)
        l1l11l111_opy_ = l11lll1l1_opy_(self.l11lll1ll_opy_, l1l11ll11_opy_)
        l1l11l111_opy_.l1l1111l1_opy_()
        l1l11l111_opy_.l11lll111_opy_()
        l111111ll11_opy_ = l11111l1111_opy_(self.lou, self.l1l111lll_opy_, self.l11lll1ll_opy_, l1l11ll11_opy_, (self.l11llll11_opy_, 'music_bxml'))
