        ...
        for element in self._1l1l11ll_opy_.l1lll1l111l_opy_:
            if element.t == "part-list":
                for item in element.l111l1l1l1_opy_:
                    l1ll1ll111l_opy_.append([int(item.l11ll11l11_opy_) - 1, int(item.l111ll11ll_opy_) - 1,
                                             int(item.l1lllll1lll_opy_.split(".")[0])])
            if element.t == "part":
                l1ll1ll11ll_opy_ = 0
                l1ll1l1ll1l_opy_ += 1
                ...
                l1lll111111_opy_ = 0
                l1ll1l1ll11_opy_.append(
                    [l1lll111111_opy_, 1, 'program_change', l1ll1ll111l_opy_[l1ll1l1ll1l_opy_ - 1][0], 0, 0])
                l1ll1l1ll11_opy_.append(
                    [l1lll111111_opy_, 1, 'control_change', l1ll1ll111l_opy_[l1ll1l1ll1l_opy_ - 1][2], 7, 0])
                    ...
                    for event in l111111l1l_opy_.l111l11lll_opy_:
                        if event.t == "note":
                            ...
                            if not event.rest:
                                ...
                                midi_hight = 12 + event.l1l11111ll_opy_ * 12 + l1ll1lll1ll_opy_[
                                    event.step] + l1ll1ll11ll_opy_
                            ...
                            if not event.rest and l1ll1llll1l_opy_ and event.l1l1111111_opy_ == "start":
                                l1ll1l1ll11_opy_.append(
                                    [l1lll111111_opy_ - event.l11lll1l11_opy_, 3, 'note_on', midi_hight,
                                     l1ll1lll11l_opy_, event.l11lll1l11_opy_, l111111l1l_opy_.l1lll111l11_opy_,
                                     event.text])
                            elif not event.rest and l1ll1llll1l_opy_ and event.l1l1111111_opy_ == "stop":
                                l1ll1l1ll11_opy_.append(
                                    [l1lll111111_opy_, 3, 'note_off', midi_hight, l1ll1lll11l_opy_, 0,
                                     l111111l1l_opy_.l1lll111l11_opy_, ""])
                                ...
                                l1ll1l1ll11_opy_.append(
                                    [l1lll111111_opy_, 3, 'note_on', midi_hight, l1ll1lll11l_opy_, 0,
                                     l111111l1l_opy_.l1lll111l11_opy_, event.text])
                                if l1ll1ll11l1_opy_.l1ll1ll1lll_opy_:
                                    l1ll1l1ll11_opy_.append([l1lll111111_opy_, 4, 'lyrics', event.text, 0, 0])
                                l1ll1l1ll11_opy_.append(
                                    [l1lll111111_opy_ + event.l11lll1l11_opy_, 3, 'note_off', midi_hight,
                                     l1ll1lll11l_opy_, event.l11lll1l11_opy_, l111111l1l_opy_.l1lll111l11_opy_, ""])
                                l1lll111111_opy_ += event.l11lll1l11_opy_
                            elif not event.rest and not event.l1l11l11l1_opy_ and event.l1lll1l11l1_opy_:
                                l1ll1l1ll11_opy_.append(
                                    [l1lll111111_opy_ - event.l11lll1l11_opy_, 3, 'note_on', midi_hight,
                                     l1ll1lll11l_opy_, 0, l111111l1l_opy_.l1lll111l11_opy_, event.text])
                                l1ll1l1ll11_opy_.append(
                                    [l1lll111111_opy_, 3, 'note_off', midi_hight, l1ll1lll11l_opy_, 0,
                                     l111111l1l_opy_.l1lll111l11_opy_, ""])
                                ...
                                l1ll1l1ll11_opy_.append(
                                    [l1lll111111_opy_ + event.l11lll1l11_opy_, 3, 'note_off', midi_hight,
                                     l1ll1lll11l_opy_, l1ll1l1l1l1_opy_ + event.l11lll1l11_opy_,
                                     l111111l1l_opy_.l1lll111l11_opy_, ""])
                                l1lll111111_opy_ += event.l11lll1l11_opy_
                                l1ll1l1l1l1_opy_ = 0
                            ...
                            if event.rest:
                                l1ll1l1ll11_opy_.append(
                                    [l1lll111111_opy_, 3, 'note_on', 1, 0, 0, l111111l1l_opy_.l1lll111l11_opy_,
                                     event.text])
                                l1ll1l1ll11_opy_.append([l1lll111111_opy_ + event.l11lll1l11_opy_, 3, 'note_off', 1, 0,
                                                         event.l11lll1l11_opy_, l111111l1l_opy_.l1lll111l11_opy_, ""])
                                l1lll111111_opy_ += event.l11lll1l11_opy_
                            ...
                            for l11lllll11_opy_ in event.l1lll1111l1_opy_:
                                if l11lllll11_opy_.t == "sound":
                                    if l11lllll11_opy_.l11111l1ll_opy_ != "no":
                                        l1ll1l1ll11_opy_.append([l1lll111111_opy_, 2, 'set_tempo',
                                                                 int(1000000 * 60 / int(
                                                                     l11lllll11_opy_.l11111l1ll_opy_)), 0, 0])
                                    ...
                                    l1ll1l1ll11_opy_.append([l1lll111111_opy_, 2, 'set_tempo',
                                                             int(1000000 * 60 / int(l11lllll11_opy_.l111111ll1_opy_)),
                                                             0, 0])
                ...
                for message in l1ll1lll111_opy_:
                    f.write(str(message[0]) + " " + str(message[1]) + " " + str(message[2]) + " " + str(
                        message[3]) + " " + str(message[4]) + " " + str(message[5]) + "\n")
                    if message[1] == 3:
                        l1ll1l1l11l_opy_.append(
                            mido.Message(message[2], note=message[3], velocity=message[4], time=message[5] * tempo,
                                         channel=l1ll1ll111l_opy_[l1ll1l1ll1l_opy_ - 1][1]))
                    elif message[1] == 2:
                        ...
                        l1ll1l1l11l_opy_.append(mido.Message(message[2], program=message[3],
                                                             channel=l1ll1ll111l_opy_[l1ll1l1ll1l_opy_ - 1][1]))
                    elif message[1] == 1 and message[2] == "control_change":
                        l1ll1l1l11l_opy_.append(mido.Message(message[2], control=message[4], value=message[3],
                                                             channel=l1ll1ll111l_opy_[l1ll1l1ll1l_opy_ - 1][1]))
