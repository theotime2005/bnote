            ...
            if element.t == "part":
                ...
                for l1lllll11ll_opy_ in element.l1lllllll11_opy_:
                    ...
                    for event in l1lllll11ll_opy_.l111111lll_opy_:
                            ...
                            if l11l1l1111_opy_ or l11llll1ll_opy_ or l111ll1l1l_opy_ or l1l11l1l1l_opy_ or l111l11ll1_opy_ or l111ll1111_opy_:
                                ...
                                if l111l11ll1_opy_:
                                    ...
                                    if l1l11111ll_opy_ !="no":
                                        l1l11lll1l_opy_ = l1lll1l11ll_opy_.SubElement(l111111l11_opy_, "braille-clef").text = l1l11111ll_opy_
                                    l111l11ll1_opy_ = False
                                if l111ll1111_opy_:
                        ...
                        if event.t == "note":
                            ...
                            if event.l1l1111l11_opy_:
                                if not l1lllllll1l_opy_:
                                    l1111l1lll_opy_ = l1lll1l11ll_opy_.SubElement(l111lll111_opy_, "notations")
                                    l1lllllll1l_opy_ = True
                                l11l11111l_opy_ = l1lll1l11ll_opy_.SubElement(l1111l1lll_opy_, "two-hands-arpeggiate")
                        ...
                        if event.t == "karaoke":
                            l1111lllll_opy_ = l1lll1l11ll_opy_.SubElement(l1l111ll11_opy_, "karaoke").text = event.l11llllll1_opy_
                ...
                for l1l11lllll_opy_ in element.l111l1l1l1_opy_:
                    ...
                    if l1l11lllll_opy_.l111l1ll11_opy_ == True:
                        l1111l1l11_opy_ = l1lll1l11ll_opy_.SubElement(l1l11llll1_opy_, "braille-ascending-chords").text = "1"
                    elif l1l11lllll_opy_.l111l1ll11_opy_ == False:
                        l1111l1l11_opy_ = l1lll1l11ll_opy_.SubElement(l1l11llll1_opy_, "braille-ascending-chords").text = "-1"
                    else:
                        l1111l1l11_opy_ = l1lll1l11ll_opy_.SubElement(l1l11llll1_opy_, "braille-ascending-chords").text = l1l11lllll_opy_.l111l1ll11_opy_
                ...
                for event in element.l1l111l11l_opy_:
                    if event.t == "global-key":
                        l11l11l1ll_opy_ = l1lll1l11ll_opy_.SubElement(l1111l1111_opy_, "global-key")
                        l1111l11ll_opy_ = l1lll1l11ll_opy_.SubElement(l11l11l1ll_opy_, "global-fifths").text = str(event.l11ll1111l_opy_)
                    if event.t == "global-time":
                        l1111111ll_opy_ = l1lll1l11ll_opy_.SubElement(l1111l1111_opy_, "global-time")
                        l1l11l1l11_opy_ = l1lll1l11ll_opy_.SubElement(l1111111ll_opy_, "global-beats").text = event.l1l1l1l1l1_opy_
                        l11ll1ll1l_opy_ = l1lll1l11ll_opy_.SubElement(l1111111ll_opy_, "global-beat-type").text = event.l1llll1l1l1_opy_
