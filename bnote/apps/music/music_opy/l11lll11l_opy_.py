...
class l1l11l1l1_opy_:
    def __init__(self, lou, l11llll11l_opy_, l1l11ll11_opy_, text, settings):
        ...
        self._1ll1ll1ll1l_opy_ = ["0","0","0"] # l1ll1llll111_opy_ l1ll1l11l111_opy_ to l1lll11ll1l1_opy_ l1llllll1ll_opy_ type, index 0 for l1ll1l11ll11_opy_, 1 for l1ll1llll11l_opy_, 2 for l1lll111ll11_opy_
    ...
    def l11ll1ll1_opy_(self):
        ...
        for block in self.l1ll1ll1lll1_opy_:
            if block in l1l1_opy_ or block[0:2] == b56 + b23 or (block[0] == NumeralPrefix and block[1] not in braille_low_numeral_dict) or b2356 + b3456 in block or b2356 + b6 + b3456 in block or (block[0] == b2356 and block[-1] == b2356) or (block[0:2] == b345 + b345 and block[-1] == b3):
    ...
    def l1ll11ll1l1l_opy_(self):
        for l1ll1ll11lll_opy_ in self.l1ll1ll1lll1_opy_:
                if (l1ll1ll11lll_opy_ in l1l1lll_opy_ or l1ll1ll11lll_opy_[0:4] == b56 + b23 + b23 + b1234) and l1ll1ll11lll_opy_ not in self._1ll11ll11ll_opy_:
    ...
    def l1ll1llllll1_opy_(self):
        l1ll1l11l1l1_opy_ = {
            b46 + b345: (True, l11l1ll_opy_.l111l11_opy_, l11l1ll_opy_.l1ll_opy_, l11l1ll_opy_.l11l1l1l_opy_, l11l1ll_opy_.l111ll11_opy_, l11l1ll_opy_.l1111ll1_opy_, l11l1ll_opy_.l1l1111l_opy_, l11l1ll_opy_.l1ll1l11l_opy_),
            b46 + b345 + b345: (True, l11l1ll_opy_.l1l1l_opy_, l11l1ll_opy_.l11l1l1_opy_, l11l1ll_opy_.l1ll111l_opy_, l11l1ll_opy_.l1ll11ll_opy_, l11l1ll_opy_.l1l1l111_opy_, l11l1ll_opy_.l1lllll1l_opy_, l11l1ll_opy_.l1lllll11_opy_),
            b456 + b345: (True, l11l1ll_opy_.l1l111l_opy_, l11l1ll_opy_.l1l1ll_opy_, l11l1ll_opy_.l11l1ll1_opy_, l11l1ll_opy_.l1ll1ll1l_opy_, l11l1ll_opy_.l1ll1111_opy_, l11l1ll_opy_.l11l1111_opy_, l11l1ll_opy_.l1ll1ll11_opy_),
            b456 + b345 + b345: (True, l11l1ll_opy_.l11ll1_opy_, l11l1ll_opy_.l1l1111_opy_, l11l1ll_opy_.l1ll1l111_opy_, l11l1ll_opy_.l11llll1_opy_, l11l1ll_opy_.l1ll11ll1_opy_, l11l1ll_opy_.l1l1ll1l_opy_, l11l1ll_opy_.l111l111_opy_),
            b5 + b345: (True, l11l1ll_opy_.l11lll_opy_, l11l1ll_opy_.l111_opy_, l11l1ll_opy_.l1l11l11_opy_, l11l1ll_opy_.l1ll1llll_opy_, l11l1ll_opy_.l1lll11ll_opy_, l11l1ll_opy_.l11ll1l1_opy_, l11l1ll_opy_.l11l111l_opy_),
            b45 + b345: (True, l11l1ll_opy_.l11ll11_opy_, l11l1ll_opy_.l1lll1_opy_, l11l1ll_opy_.l1lll1lll_opy_, l11l1ll_opy_.l11l11l1_opy_, l11l1ll_opy_.l1llll1l_opy_, l11l1ll_opy_.l1lll11l1_opy_, l11l1ll_opy_.l1l1llll_opy_),
            b345 + b234 + b3: (True, l11l1ll_opy_.l11lll1_opy_, l11l1ll_opy_.l1llll_opy_, l11l1ll_opy_.l1l1l1ll_opy_, l11l1ll_opy_.l1lll1111_opy_, l11l1ll_opy_.l1ll1l1l1_opy_, l11l1ll_opy_.l11lllll_opy_, '0'),
            b345 + b1 + b3: (True, l11l1ll_opy_.l111ll_opy_, l11l1ll_opy_.l1llll1_opy_, l11l1ll_opy_.l1ll1l1l_opy_, l11l1ll_opy_.l1lll1ll1_opy_, l11l1ll_opy_.l11ll111_opy_, l11l1ll_opy_.l111ll1l_opy_, '0'),
            b345 + b2345 + b3: (True, l11l1ll_opy_.l1ll1l1_opy_, l11l1ll_opy_.l111lll_opy_, l11l1ll_opy_.l1ll1l1ll_opy_, l11l1ll_opy_.l1ll11l11_opy_, l11l1ll_opy_.l111l1l1_opy_, l11l1ll_opy_.l1llllll1_opy_, '0'),
            b345 + b12 + b3: (True, l11l1ll_opy_.l1l1ll1_opy_, l11l1ll_opy_.l111ll1_opy_, l11l1ll_opy_.l1lll1l1_opy_, l11l1ll_opy_.l1l1lll1_opy_, l11l1ll_opy_.l11l11ll_opy_, l11l1ll_opy_.l1ll1lll1_opy_, '0'),
            b345 + b234 + b2 + b3: (True, l11l1ll_opy_.l11ll1l_opy_, l11l1ll_opy_.l11_opy_, l11l1ll_opy_.l111llll_opy_, l11l1ll_opy_.l1llll11_opy_, l11l1ll_opy_.l111111l_opy_, l11l1ll_opy_.l1lllllll_opy_, '0'),
            b345 + b1 + b2 + b3: (True, l11l1ll_opy_.l11llll_opy_, l11l1ll_opy_.l1111_opy_, l11l1ll_opy_.l1lll111_opy_, l11l1ll_opy_.l1l11111_opy_, l11l1ll_opy_.l1l111ll_opy_, l11l1ll_opy_.l1ll1ll1_opy_, '0'),
            b345 + b2345 + b2 + b3: (True, l11l1ll_opy_.l1l1l1_opy_, l11l1ll_opy_.l11l11_opy_, l11l1ll_opy_.l11l1l11_opy_, l11l1ll_opy_.l1ll1lll_opy_, l11l1ll_opy_.l1llll11l_opy_, l11l1ll_opy_.l111l11l_opy_, '0'),
            b345 + b12 + b2 + b3: (True, l11l1ll_opy_.l1l11l_opy_, l11l1ll_opy_.l1l111_opy_, l11l1ll_opy_.l1l111l1_opy_, l11l1ll_opy_.l1lll11l_opy_, l11l1ll_opy_.l11111l1_opy_, l11l1ll_opy_.l1111lll_opy_, '0'),
            b345 + b234 + b23 + b3: (True, l11l1ll_opy_.l1lllll_opy_, l11l1ll_opy_.l1l11l1_opy_, l11l1ll_opy_.l1lll1l1l_opy_, l11l1ll_opy_.l1111l11_opy_, l11l1ll_opy_.l1l1l1l1_opy_, l11l1ll_opy_.l1ll11lll_opy_, '0'),
            b345 + b1 + b23 + b3: (True, l11l1ll_opy_.l11l1_opy_, l11l1ll_opy_.l11l11l_opy_, l11l1ll_opy_.l11ll11l_opy_, l11l1ll_opy_.l1l11lll_opy_, l11l1ll_opy_.l1l11ll1_opy_, l11l1ll_opy_.l111l1ll_opy_, '0'),
            b345 + b2345 + b23 + b3: (True, l11l1ll_opy_.l1_opy_, l11l1ll_opy_.ll_opy_, l11l1ll_opy_.l11lll11_opy_, l11l1ll_opy_.l1lllll1_opy_, l11l1ll_opy_.l1llll1l1_opy_, l11l1ll_opy_.l1111111_opy_, '0'),
            b345 + b12 + b23 + b3: (True, l11l1ll_opy_.l1l1l1l_opy_, l11l1ll_opy_.l1l1l11_opy_, l11l1ll_opy_.l1111l1l_opy_, l11l1ll_opy_.l1lll111l_opy_, l11l1ll_opy_.l11l1lll_opy_, l11l1ll_opy_.l1llll1ll_opy_, '0')
        }
        ...
        for part in self._1ll11ll11ll_opy_:
            l1ll1l11lll1_opy_ += 1
            found = False
            (l1ll11llll1l_opy_, l111lll1ll_opy_, l11111ll1l_opy_, l1lllll111l_opy_, l11ll11l11_opy_, l1lllll1lll_opy_, l1111ll1ll_opy_, l1ll11l1l11l_opy_) = l1ll1l11l1l1_opy_.get(part, (None, None, None, None, None, None, None, None))
            for element in self._1111111ll1_opy_.l1lll1l111l_opy_:
                if element.t == "part-list":
                    for l1l11111l1_opy_ in element.l111l1l1l1_opy_:
                        if (self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'name' and self.l1ll111lll1l_opy_(part[4:]) == l1l11111l1_opy_.l111lll1ll_opy_) or (self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'abbreviation' and self.l1ll111lll1l_opy_(part[4:]) == l1l11111l1_opy_.l11111ll1l_opy_) or (l1ll11llll1l_opy_ and l111lll1ll_opy_ == l1l11111l1_opy_.l111lll1ll_opy_):
                            found = True
            ...
            if not found:
                if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'name' and part[:4] == "".join([b56, b23, b23, b1234]):
                    l1ll11111l1l_opy_.l1111lll111_opy_(self.l1ll1l1llll1_opy_(l1ll1l11lll1_opy_, "no", l11l1ll_opy_.l1lll1l_opy_, l11l1ll_opy_.l1l1ll11_opy_, l11l1ll_opy_.l11ll1ll_opy_, l11l1ll_opy_.l1lll1l11_opy_, l11l1ll_opy_.l1ll11l1l_opy_, l11l1ll_opy_.l11lll1l_opy_, self.l1ll111lll1l_opy_(part[4:])))
                elif self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'abbreviation' and part[:4] == "".join([b56, b23, b23, b1234]):
                    l1ll11111l1l_opy_.l1111lll111_opy_(self.l1ll1l1llll1_opy_(l1ll1l11lll1_opy_, l11l1ll_opy_.l11l_opy_, "no", l11l1ll_opy_.l1l1ll11_opy_, l11l1ll_opy_.l11ll1ll_opy_, l11l1ll_opy_.l1lll1l11_opy_, l11l1ll_opy_.l1ll11l1l_opy_, l11l1ll_opy_.l11lll1l_opy_, self.l1ll111lll1l_opy_(part[4:])))
                elif l1ll11llll1l_opy_:
                    l1ll11111l1l_opy_.l1111lll111_opy_(self.l1ll1l1llll1_opy_(l1ll1l11lll1_opy_, l111lll1ll_opy_, l11111ll1l_opy_, l1lllll111l_opy_, l11ll11l11_opy_, l1lllll1lll_opy_, l1111ll1ll_opy_, l1ll11l1l11l_opy_))
        if l1ll1l11lll1_opy_ == 0:
            l1ll11111l1l_opy_.l1111lll111_opy_(self.l1ll1l1llll1_opy_(l1ll1l11lll1_opy_ + 1, l11l1ll_opy_.l11l_opy_, l11l1ll_opy_.l1lll1l_opy_, l11l1ll_opy_.l1l1ll11_opy_, l11l1ll_opy_.l11ll1ll_opy_, l11l1ll_opy_.l1lll1l11_opy_, l11l1ll_opy_.l1ll11l1l_opy_, l11l1ll_opy_.l11lll1l_opy_))
            self._1ll11111ll1_opy_.append([0,0])
        else:
            self._1ll11lll111_opy_ = l1ll1l11lll1_opy_
    def l1ll1l1llll1_opy_(self, l1ll1l11lll1_opy_, l111lll1ll_opy_, l11111ll1l_opy_, l1lllll111l_opy_, l11ll11l11_opy_, l1lllll1lll_opy_, l1111ll1ll_opy_, l1ll11l1l11l_opy_, l1ll1111l1l1_opy_="no"):
    ...
    def l1ll1lll1lll_opy_(self):
        ...
        for l1ll1ll11lll_opy_ in l1ll1ll1l1l1_opy_:
            (l1ll1l1ll111_opy_, sign, line, l1lllll1111_opy_, braille) = l1ll1l11111l_opy_.get(l1ll1ll11lll_opy_, (None, None, None, None, None))
    ...
    def l1ll111llll1_opy_(self):
        ...
        for l1ll1ll11lll_opy_ in self.l1ll1ll1lll1_opy_:
                    if l1ll1ll11lll_opy_ not in l1l1_opy_:
                        if l1ll1ll11lll_opy_[0:2] != b56 + b23 and l1ll1ll11lll_opy_[0] != NumeralPrefix and b2356 + b3456 not in l1ll1ll11lll_opy_ and b2356 + b6 + b3456 not in l1ll1ll11lll_opy_ and (l1ll1ll11lll_opy_[0] != b2356 and l1ll1ll11lll_opy_[-1] != b2356) and (l1ll1ll11lll_opy_[0:2] != b345 + b345 and l1ll1ll11lll_opy_[-1] != b3):
        ...
        if self.l1l11ll11l_opy_:
            self._1l1111ll_opy_("smallest " + str(l1ll1l11ll1l_opy_) + " self._divisions " + str(self._1ll11l1l1l1_opy_) + "\n")
        ...
        self._1l1l11ll_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[0].l1l11l1llll_opy_(l1ll1l1l1ll1_opy_)
    def l1ll1ll11l11_opy_(self, l1ll1ll11lll_opy_):
        ...
        if l1ll1ll11lll_opy_ in l1llllll_opy_:
            ...
            for element in self._1l1l11ll_opy_.l1lll1l111l_opy_:
                if element.t == "part-list":
                    self._1l1l11ll_opy_.l1lll1l111l_opy_[l1lll1l1111l_opy_].l111l1l1l1_opy_[self._1lll111l111_opy_ - 1].l11l111l1ll_opy_("-1")
                l1lll1l1111l_opy_ += 1
        ...
        return (
            (self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'name'
                and (l1l11111l1_opy_.l111lll1ll_opy_ == self.l1ll111lll1l_opy_(l1lll1111l11_opy_)
                    or (l1lll1111l11_opy_ in l1l1lll_opy_ and l1l1lll_opy_[l1lll1111l11_opy_][0] == l1l11111l1_opy_.l111lll1ll_opy_)
                )
            )
            or (self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'abbreviation'
                and (l1l11111l1_opy_.l11111ll1l_opy_ == self.l1ll111lll1l_opy_(l1lll1111l11_opy_)
                     or (l1lll1111l11_opy_ in l1l1lll_opy_ and l1l1lll_opy_[l1lll1111l11_opy_][1] == l1l11111l1_opy_.l11111ll1l_opy_)
                )
            )
        )
            ...
            if element.t == "part-list":
                ...
                for l1l11111l1_opy_ in element.l111l1l1l1_opy_:
                    if self._1ll1ll1ll11_opy_(l1l11111l1_opy_, l1ll1ll11lll_opy_):
                        self._1l1l11ll_opy_.l1lll1l111l_opy_[l1lll1l1111l_opy_].l111l1l1l1_opy_[l1l1lllll1ll_opy_].l11lll111ll_opy_(
    ...
    def l111ll11ll_opy_(self, l1ll1ll11lll_opy_):
        ...
        for element in self._1l1l11ll_opy_.l1lll1l111l_opy_:
            if element.t == "part-list":
                ...
                for l1l11111l1_opy_ in element.l111l1l1l1_opy_:
                    if self._1ll1ll1ll11_opy_(l1l11111l1_opy_, l1ll1ll11lll_opy_):
                        self._1l1l11ll_opy_.l1lll1l111l_opy_[l1lll1l1111l_opy_].l111l1l1l1_opy_[l1l1lllll1ll_opy_].l111l1llll1_opy_(
                            self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:]))
                    l1l1lllll1ll_opy_ += 1
            l1lll1l1111l_opy_ += 1
    def l1lllll1lll_opy_(self, l1ll1ll11lll_opy_):
        ...
        for element in self._1l1l11ll_opy_.l1lll1l111l_opy_:
            if element.t == "part-list":
                ...
                for l1l11111l1_opy_ in element.l111l1l1l1_opy_:
                    if self._1ll1ll1ll11_opy_(l1l11111l1_opy_, l1ll1ll11lll_opy_):
                        self._1l1l11ll_opy_.l1lll1l111l_opy_[l1lll1l1111l_opy_].l111l1l1l1_opy_[l1l1lllll1ll_opy_].l11lll1ll11_opy_(
                            self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:]))
                    l1l1lllll1ll_opy_ += 1
            l1lll1l1111l_opy_ += 1
    def l1ll1l1111l1_opy_ (self):
        ...
        for key in  self.l1ll111l111l_opy_.items():
            ...
            l1lll1l1111l_opy_ = 0
            for element in self._1l1l11ll_opy_.l1lll1l111l_opy_:
                if element.t == "part" and ((self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'name' and element.l111lll1ll_opy_ == key[0]) or (self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'abbreviation' and element.l11111ll1l_opy_ == key[0])):
                    if key[1][0] != "":
    ...
    def l1ll1lll1ll1_opy_(self, line, l1l11ll11_opy_):
        def l1lll1111lll_opy_(a, b, c, d):
            if self._1ll1ll1111l_opy_ and not self._1ll11l111l1_opy_:
                for i in l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l111l11lll_opy_:
                    if i.t == "note":
                        i.l11lll1111l_opy_(l11lll1l11_opy_ = int(self._1ll1111l111_opy_) * self._1ll11l1l1l1_opy_ * 4 / int(self._1ll1ll1l111_opy_))
            self._1ll1l1l11l1_opy_ += 1
            self._1ll11111ll1_opy_ [self._1lll111l111_opy_-1] = [self._1lll111l111_opy_, self._1ll1l1l11l1_opy_]
            l111111l1l_opy_ = l1l1l1l1l1l_opy_()
            l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l11111_opy_ (l111111l1l_opy_)
            l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1ll111l111_opy_(self._1ll1l1l11l1_opy_ + 1)
            self._1ll11l111l1_opy_ = False
            self._1ll1ll1111l_opy_ = False
        def l1ll11l111ll_opy_(sign, line, l1lllll1111_opy_, braille):
            ...
            if self._1ll111l1111_opy_:
                for event in l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l111l11lll_opy_:
                    if event.t == "attributes":
                        event.l1l11l1llll_opy_(l1l1ll1l111_opy_)
            else:
                l1l1l11l1ll_opy_ = l111l1ll11l_opy_()
                l1l1l11l1ll_opy_.l1l11l1llll_opy_(l1l1ll1l111_opy_)
                l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1l11l1llll_opy_(l1l1l11l1ll_opy_)
        ...
        (l1ll1l1ll111_opy_, sign, line, l1lllll1111_opy_, braille) = l1ll1ll111l1_opy_.get(l1ll1ll11lll_opy_, (None, None, None, None, None))
        if l1ll1l1ll111_opy_:
            l1ll1l1ll111_opy_(sign, line, l1lllll1111_opy_, braille)
        if l1ll1ll11lll_opy_[0] == NumeralPrefix:
            l1ll11ll1lll_opy_ = l1ll1ll11ll1_opy_ = ""
        ...
        if b2356 + b3456 in l1ll1ll11lll_opy_:
            ...
            l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1l11l1llll_opy_(direction)
        if b2356 + b6 + b3456 in l1ll1ll11lll_opy_:
            ...
            l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1l11l1llll_opy_(l1l11l1ll1l_opy_)
        ...
        if l1ll1ll11lll_opy_[0:4] == b56 + b23 + b23 + b13:
            ...
            l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1l11l1llll_opy_(l111l1l11l_opy_)
        if l1ll1ll11lll_opy_ in self._1ll11ll11ll_opy_:
        ...
        if l1ll1ll11lll_opy_[:7] == "".join([b56, b23, b3, b2345, b1235, b145, b24]):
            if self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)]) in self.l1ll111l111l_opy_:
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])][0] = l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:])
            else:
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])] = [self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:]), "", "", False, ""]
        if l1ll1ll11lll_opy_[:7] == "".join([b56, b23, b3, b2345, b1235, b14, b125]):
            if self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)]) in self.l1ll111l111l_opy_:
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])][1] = self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:])
            else:
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])] = ["", self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:]), "", False, ""]
        if l1ll1ll11lll_opy_[:7] == "".join([b56, b23, b3, b2345, b1235, b135, b14]):
            if self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)]) in self.l1ll111l111l_opy_:
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])][2] = self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:])
            else:
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])] = ["", "", self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:]), False, ""]
        if l1ll1ll11lll_opy_[:7] == "".join([b56, b23, b3, b2345, b1235, b145, b135]):
            if self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)]) in self.l1ll111l111l_opy_:
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])][3] = True
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])][4] = self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:])
            else:
                self.l1ll111l111l_opy_[self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[8:l1ll1ll11lll_opy_.index(b25)])] = ["", "", "", True, self.l1ll111lll1l_opy_(l1ll1ll11lll_opy_[l1ll1ll11lll_opy_.index(b25) + 1:])]
    ...
    def l1lll111l1ll_opy_(self, line, l1l11ll11_opy_):
        def l1ll1l1l1lll_opy_():
            ...
            l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1l11l1llll_opy_(l1ll111l1l11_opy_)
            self._1ll1l1l11l1_opy_ += 1
            self._1ll11111ll1_opy_ [self._1lll111l111_opy_-1] = [self._1lll111l111_opy_, self._1ll1l1l11l1_opy_]
            l111111l1l_opy_ = l1l1l1l1l1l_opy_()
            l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l11111_opy_(l111111l1l_opy_)
            ...
            l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1l11l1llll_opy_(l1ll1lllllll_opy_)
            self._1ll11l111l1_opy_ = False
            self._1ll1ll1111l_opy_ = False
        ...
        while b345 + b345 in line:
            ...
            l1ll1ll11lll_opy_ = line.replace(line[l1ll1lllll1l_opy_:l1ll1111llll_opy_ + 1], "_words_" + self.l1ll111lll1l_opy_(line[l1ll1lllll1l_opy_ + 2:l1ll1111llll_opy_]) + "·")
            line = l1ll1ll11lll_opy_
        for element in l1111l_opy_:
            if element in line:
        ...
        for content in l1ll1llll1l1_opy_:
            ...
            if l1lll111111l_opy_ == False and content in l1ll1l_opy_:
                ...
                l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1l11l1llll_opy_(self.note)
            ...
            if content in l1111ll_opy_:
                ...
                if l11lll1l11_opy_ > int(self._1ll1111l111_opy_) * self._1ll11l1l1l1_opy_ and not self._1ll11l111l1_opy_:
            ...
            if content in l1l_opy_:
                ...
                if l11lll1l11_opy_ > int(self._1ll1111l111_opy_) * 4 * self._1ll11l1l1l1_opy_ / int(self._1ll1ll1l111_opy_):
                    l11lll1l11_opy_ = int(self._1ll1111l111_opy_) * self._1ll11l1l1l1_opy_ * 4 / int(self._1ll1ll1l111_opy_)
                self.note.l11lll1111l_opy_(l11lll1l11_opy_)
                self.note.l11ll11lll1_opy_(str(l1l1l1ll1l1_opy_))
            ...
            if content in l111l1_opy_:
                ...
                self.note.l11ll11lll1_opy_(str(l1l1l1ll1l1_opy_))
                if l1ll1ll11l1l_opy_ == False:
                    l1ll11lll1l1_opy_ = self._1ll1lll11l1_opy_ + l11ll_opy_[(self._1ll1l1l1l11_opy_, content, self._1ll111111ll_opy_)][1]
                    self.note.l111lll11l1_opy_(str(l1ll11lll1l1_opy_))
                else:
                    self.note.l111lll11l1_opy_(l1ll111l11ll_opy_)
                if l1ll1l11l1ll_opy_:
                    l1ll111lllll_opy_.append([l11ll_opy_[(self._1ll1l1l1l11_opy_, content, self._1ll111111ll_opy_)][0], l1ll1111ll1l_opy_])
                else:
                    self.note.l1l1111lll1_opy_(l1lll11_opy_[(l11ll_opy_[(self._1ll1l1l1l11_opy_, content, self._1ll111111ll_opy_)][0], self._1ll1l111l11_opy_)])
                if l1ll11l1l111_opy_ != 0:
                    self.note.l1l1lllll11_opy_("3")
                    self.note.l11ll1lll11_opy_("2")
            ...
            if l1lll111111l_opy_ and [self.note.step, self.note.l11lll11ll_opy_, self.note.l1l11111ll_opy_] in self.l1lll111l11l_opy_:
            ...
            if content == "single_note_tie":
                ...
                if [self.note.step, self.note.l11lll11ll_opy_, self.note.l1l11111ll_opy_] not in self.l1lll111l11l_opy_:
                    self.l1lll111l11l_opy_.append([self.note.step, self.note.l11lll11ll_opy_, self.note.l1l11111ll_opy_])
                else:
            ...
            if content == "full_measure_in_accord":
                ...
                l1l11ll11_opy_.l1lll1l111l_opy_[-(1+self._1ll11lll111_opy_-self._1lll111l111_opy_)].l11l1l1ll1_opy_[self._1ll1l1l11l1_opy_].l1l11l1llll_opy_(l1ll1111ll11_opy_)
