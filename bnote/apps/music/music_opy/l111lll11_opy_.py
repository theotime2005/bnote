...
l1lll111l1_opy_ = 7
print ('{} (TM) Configurable Multi Module Python Obfuscator Version {}'.format (l1ll1llll1_opy_.capitalize (), l1l111111_opy_))
...
def l111lll11_opy_(args=sys.argv):
    ...
    def l1l1llll11_opy_ (l1ll11lll1_opy_):
        global l1llll1ll1_opy_
        if l1ll11l1l1_opy_:
            l11l1l11l_opy_ = l1ll11ll11_opy_ () .join ([l11l11l11_opy_ (l1llll1l1l_opy_ + ord (char) + (l1lll1111l_opy_ + l1llll1ll1_opy_) % l1lll111l1_opy_) for l1lll1111l_opy_, char in enumerate (l1ll11lll1_opy_)])
            l1l1llllll_opy_ = l11l11l11_opy_ (l1llll1ll1_opy_)
        else:
            l11l1l11l_opy_ = str () .join ([chr (l1llll1l1l_opy_ + ord (char) + (l1lll1111l_opy_ + l1llll1ll1_opy_) % l1lll111l1_opy_) for l1lll1111l_opy_, char in enumerate (l1ll11lll1_opy_)])
            l1l1llllll_opy_ = chr (l1llll1ll1_opy_)
        l1ll11l111_opy_ = l1llll1ll1_opy_ % len (l1ll11lll1_opy_)
        l111l111l_opy_ = l11l1l11l_opy_ [:-l1ll11l111_opy_] + l11l1l11l_opy_ [-l1ll11l111_opy_:]
...
def unScramble{0} (keyedStringLiteral):
    ...
    '''.format (l1111lll1_opy_, l1llll1l1l_opy_, l1lll111l1_opy_)
...
{3}
===============================================================================
        '''.format (l1ll1llll1_opy_.capitalize (), l1ll1llll1_opy_, r'#', license))
    ...
    if len (args) > 2:
        ...
        l11l11111_opy_ = '{0}/{1}_{2}'.format (* (l1llllllll_opy_.rsplit ('/', 1) + [l1ll1llll1_opy_]))
    if len (args) > 3:
    ...
    l1lllllll1_opy_ = l11l111ll_opy_ ('obfuscated_name_tail', '_{}_'.format (l1ll1llll1_opy_))
    ...
    def l1ll1ll111_opy_ (l1ll111111_opy_):
        for l111l1l11_opy_ in l1l1ll11ll_opy_:
            if l111l1l11_opy_ in l1ll111111_opy_:
                return True
        return False
    l1llll1lll_opy_ = [l1ll111111_opy_ for l1ll111111_opy_ in l1lll11lll_opy_ if not l1ll1ll111_opy_ (l1ll111111_opy_)]
    ...
    def l1l1lllll1_opy_ (l1ll111l1l_opy_):
        ...
        if l1ll11l1ll_opy_:
            if l11111l1l_opy_.search (string): # l1ll11llll_opy_, l1lllll11l_opy_ no l1l1ll1ll1_opy_ for l111ll1l1_opy_
    ...
    l1ll1ll1l1_opy_ = re.compile (r'([ru]|ru|ur)?(({0})|({1})|({2})|({3}))'.format (
        r"'''.*?(?<![^\\]\\)(?<![^\\]\')'''",
        r'""".*?(?<![^\\]\\)(?<![^\\]\")"""',
        r"'.*?(?<![^\\]\\)'",
        r'".*?(?<![^\\]\\)"'
    ...
    l111lllll_opy_ = re.compile (r'''
        ...
        (?<!{1})
        \b
    '''.format (l11l111l1_opy_, l1lll111ll_opy_), re.VERBOSE) # l1l1ll1lll_opy_ l1ll1ll11l_opy_
    l1l1lll111_opy_ = re.compile (r'\bchr\b')
    l1111ll1l_opy_ = set (keyword.kwlist + ['__init__'] + l1ll1l1111_opy_)
    l11l1l111_opy_ = ['{0}/{1}'.format (l1llllllll_opy_, l1l11111l_opy_) for l1l11111l_opy_ in l111ll111_opy_]
    l111l1lll_opy_ = [l1ll111l11_opy_ for l1ll111l11_opy_ in l11l1l111_opy_ if os.path.exists (l1ll111l11_opy_)]
...
import {0} as currentModule
                        '''.format (l11lll1l1_opy_),
                        globals ()
                    )
                    setattr (self, l1111ll11_opy_, l1111llll_opy_)
                except Exception as exception:
                    print (exception)
                    setattr (self, l1111ll11_opy_, None) # l11l1llll_opy_ l1l1lll11l_opy_ l1ll1l11l1_opy_ the l1ll1111ll_opy_ name will be l1ll1l1lll_opy_
                    print ('Warning: could not inspect external module {0}'.format (l11lll1l1_opy_))
    ...
    def l11ll11ll_opy_ (l1111l11l_opy_):
        ...
        try:
            ...
            l1l1111l1_opy_ = []
        l11ll1lll_opy_ = [getattr (l1111l11l_opy_, l1111ll11_opy_) for l1111ll11_opy_ in l111ll11l_opy_]
        l1l1ll1l11_opy_ = (l1111lll1_opy_.join (l111ll11l_opy_)) .split (l1111lll1_opy_) # l1llll11ll_opy_ module name chunks that l111l1ll1_opy_ l1ll1111l1_opy_ by l1l1111ll_opy_
        l111l11ll_opy_ = set ([entry for entry in (l1l1111l1_opy_ + l1l1ll1l11_opy_) if not (entry.startswith ('__') and entry.endswith ('__'))])
        ...
        if l1lll11111_opy_ in l111l11l1_opy_ and not l1ll111111_opy_ in l111l1lll_opy_:
            ...
            if len (l11ll1ll1_opy_) > 0:
                if l1l1lll1l1_opy_.search (l11ll1ll1_opy_ [0]):
                    l1ll1ll1ll_opy_ += 1
                    if len (l11ll1ll1_opy_) > 1 and l11l1ll1l_opy_.search (l11ll1ll1_opy_ [1]):
                        l1ll1ll1ll_opy_ += 1
            ...
            if l1ll11l1ll_opy_ and l1ll1l1ll1_opy_:
                ...
                l1ll1ll1ll_opy_ += 1
            if l1ll11l1ll_opy_:
                l1lll1llll_opy_ = '\n'.join ([l1lll11l1l_opy_ (l1ll1l1l1l_opy_)] + l11ll1ll1_opy_ [l1ll1ll1ll_opy_:])
            else:
            ...
            l1llll1111_opy_ = set (re.findall (l111lllll_opy_, l1lll1llll_opy_) + [l1ll11111l_opy_])
            l1lllll1ll_opy_ = l1llll1111_opy_.difference (l11ll1l1l_opy_).difference (l1111ll1l_opy_)
            l1ll1lll1l_opy_ = list (l1lllll1ll_opy_)
            l11111lll_opy_ = [re.compile (r'\b{0}\b'.format (l111lll1l_opy_)) for l111lll1l_opy_ in l1ll1lll1l_opy_]
            ...
            try:
                l11111l11_opy_ = l11llll1l_opy_ (l11ll1l1l_opy_.index (l1ll11111l_opy_), l1ll11111l_opy_)
            ...
            for index in range (len (l1lll1l11l_opy_)):
                try:
                    l1lll1l11l_opy_ [index] = l11llll1l_opy_ (l11ll1l1l_opy_.index (l1lll1l11l_opy_ [index]), l1lll1l11l_opy_ [index])
                except: # l111111l1_opy_ in list
                    pass
            l1l1ll111l_opy_ = '/'.join (l1lll1l11l_opy_)
            l1lllll1l1_opy_ = '{0}{1}'.format (l11l11111_opy_, l1l1ll111l_opy_) .rsplit ('/', 1) [0]
            l1ll1lllll_opy_ = l1lll1l1ll_opy_ ('{0}/{1}.{2}'.format (l1lllll1l1_opy_, l11111l11_opy_, l1lll11111_opy_), open = True)
