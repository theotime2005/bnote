...
class l11111ll1l_opy_:
    ...
    def l1111111l1_opy_(self, l1l1l111_opy_, encoding=None):
        ...
        self._1111llll11_opy_ = open("trace_musicxml.txt", "w", encoding="utf-8")
        l1ll1111l1_opy_ = l1l11ll11_opy_()
        l1111111111_opy_ = l111111111l_opy_(
            self.lou, self._11111ll11_opy_, self.l111111l1l_opy_
        )
        l1111111111_opy_.l1111111l1_opy_(self.l1111ll1ll1_opy_, l1ll1111l1_opy_)
        l1llllllllll_opy_ = l1l11l111l1_opy_(self.l1111ll1ll1_opy_, l1ll1111l1_opy_)
        l1llllllllll_opy_.l1l11l1111l_opy_()
        l1llllllllll_opy_.l1l11l1ll11_opy_()
