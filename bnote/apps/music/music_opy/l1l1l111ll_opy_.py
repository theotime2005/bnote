...
l111l11l1_opy_ = 7
print('{} (TM) Configurable Multi Module Python Obfuscator Version {}'.format(l1ll1ll1ll_opy_.capitalize(),
                                                                              l1ll1lllll_opy_))
...
def l1l1l111ll_opy_(args=sys.argv):
    ...
    def l111llll1_opy_(l11ll1l1l_opy_):
        global l1ll1111l1_opy_
        if l1l1l11lll_opy_:
            l1l1ll11ll_opy_ = l1ll11111l_opy_().join(
                [l1l1l1ll11_opy_(l1lll11111_opy_ + ord(char) + (l11111lll_opy_ + l1ll1111l1_opy_) % l111l11l1_opy_) for
                 l11111lll_opy_, char in enumerate(l11ll1l1l_opy_)])
            l1lllll11l_opy_ = l1l1l1ll11_opy_(l1ll1111l1_opy_)
        else:
            l1l1ll11ll_opy_ = str().join(
                [chr(l1lll11111_opy_ + ord(char) + (l11111lll_opy_ + l1ll1111l1_opy_) % l111l11l1_opy_) for
                 l11111lll_opy_, char in enumerate(l11ll1l1l_opy_)])
...
===============================================================================
    ...
    l1llll11l1_opy_ = (
        re.compile(r'{0}{1}{2}.*?$'.format(
            ...
            r'(?<!")',
            r'  # '
            # l111ll1l1_opy_ to l1lll1llll_opy_ l11l11111_opy_ l11111111_opy_ comment should start l11ll11ll_opy_ this.
        ), re.MULTILINE)
...
import {0} as currentModule
                    ...
                    print(exception)
                    setattr(self, l1ll11l11l_opy_,
                            None)  # l1l1l1llll_opy_ l111l1lll_opy_ l111l11ll_opy_ the l1ll11ll1l_opy_ name will be l11l1l1ll_opy_
    ...
    def l1lll111l1_opy_(l1ll1111ll_opy_):
        ...
        l1l1l1l11l_opy_ = (l1111llll_opy_.join(l1ll1l111l_opy_)).split(
            l1111llll_opy_)  # l1lll1l1l1_opy_ module name chunks that l1ll1ll1l1_opy_ l1lll11lll_opy_ by l1ll1ll11l_opy_
        l1111l1ll_opy_ = set([entry for entry in (l1l1lll1l1_opy_ + l1l1l1l11l_opy_) if
    ...
    for l1lll1ll11_opy_ in l11l1l11l_opy_:
        ...
        if l1l1ll1111_opy_ in l11111l11_opy_ and not l1lll1ll11_opy_ in l1lll1l11l_opy_:
            ...
            for index in range(len(l1l1llll11_opy_)):
                try:
                    l1l1llll11_opy_[index] = l1ll1l1l11_opy_(l1ll11l1l1_opy_.index(l1l1llll11_opy_[index]),
                                                             l1l1llll11_opy_[index])
            ...
            l111lll1l_opy_ = l1l1l1l1l1_opy_('{0}/{1}.{2}'.format(l1lll1111l_opy_, l1llllllll_opy_, l1l1ll1111_opy_),
                                             open=True)
