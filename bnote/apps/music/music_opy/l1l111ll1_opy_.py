...
class l1l111l111l_opy_(l1lll1l1l11l_opy_):
    ...
    def l1l11l1ll11_opy_(self, step):
        l1lll1l1lll1_opy_ = {"A": l1l111l111l_opy_.l11111111ll_opy_.a, "B": l1l111l111l_opy_.l11111111ll_opy_.b,
                             "C": l1l111l111l_opy_.l11111111ll_opy_.c, "D": l1l111l111l_opy_.l11111111ll_opy_.d,
                             "E": l1l111l111l_opy_.l11111111ll_opy_.e,
                             "F": l1l111l111l_opy_.l11111111ll_opy_.f, "G": l1l111l111l_opy_.l11111111ll_opy_.g,
                             "no": "no"}
        self.step = l1lll1l1lll1_opy_[step]

    def l1l1111lll1_opy_(self, l11lll11ll_opy_):
        l1llll1l1lll_opy_ = {"-2": l1l111l111l_opy_.l1llllllll11_opy_.l1111111l11_opy_,
                             "-1.5": l1l111l111l_opy_.l1llllllll11_opy_.l1lllllll1ll_opy_,
                             "-1": l1l111l111l_opy_.l1llllllll11_opy_.l111111111l_opy_,
                             "-0.5": l1l111l111l_opy_.l1llllllll11_opy_.l1lllllll1l1_opy_,
                             "0": l1l111l111l_opy_.l1llllllll11_opy_.l1llllllllll_opy_,
                             "": l1l111l111l_opy_.l1llllllll11_opy_.l1llllllllll_opy_,
                             "0.5": l1l111l111l_opy_.l1llllllll11_opy_.l11111111l1_opy_,
                             "1": l1l111l111l_opy_.l1llllllll11_opy_.l1lllllllll1_opy_,
                             "1.5": l1l111l111l_opy_.l1llllllll11_opy_.l1111111111_opy_,
                             "2": l1l111l111l_opy_.l1llllllll11_opy_.l1llllllll1l_opy_, "no": "no"}
    ...
    def l11ll1l1l1l_opy_(self, l1llll111l11_opy_):
        l1lll1ll11ll_opy_ = {"maxima": l1l111l111l_opy_.l1lllll1ll11_opy_.l1lllllll111_opy_,
                             "long": l1l111l111l_opy_.l1lllll1ll11_opy_.l1llllll1ll1_opy_,
                             "breve": l1l111l111l_opy_.l1lllll1ll11_opy_.l1llllll1l1l_opy_,
                             "whole": l1l111l111l_opy_.l1lllll1ll11_opy_.l1lllll1ll1l_opy_,
                             "half": l1l111l111l_opy_.l1lllll1ll11_opy_.l1llllll11l1_opy_,
                             "quarter": l1l111l111l_opy_.l1lllll1ll11_opy_.l1lllll1l1ll_opy_,
                             "eighth": l1l111l111l_opy_.l1lllll1ll11_opy_.l1llllll11ll_opy_,
                             "16th": l1l111l111l_opy_.l1lllll1ll11_opy_.l1llllll111l_opy_,
                             "32nd": l1l111l111l_opy_.l1lllll1ll11_opy_.l1lllll1llll_opy_,
                             "64th": l1l111l111l_opy_.l1lllll1ll11_opy_.l1llllll1111_opy_,
                             "128th": l1l111l111l_opy_.l1lllll1ll11_opy_.l1llllll1l11_opy_,
                             "256th": l1l111l111l_opy_.l1lllll1ll11_opy_.l1lllllll11l_opy_,
                             "512th": l1l111l111l_opy_.l1lllll1ll11_opy_.l1lllll1lll1_opy_,
                             "1024th": l1l111l111l_opy_.l1lllll1ll11_opy_.l1llllll1lll_opy_}
    ...
    def l1ll111llll_opy_(self):
        l1llll1l11ll_opy_ = {l1l111l111l_opy_.l11111111ll_opy_.c: 0, l1l111l111l_opy_.l11111111ll_opy_.d: 1,
                             l1l111l111l_opy_.l11111111ll_opy_.e: 2, l1l111l111l_opy_.l11111111ll_opy_.f: 3,
                             l1l111l111l_opy_.l11111111ll_opy_.g: 4, l1l111l111l_opy_.l11111111ll_opy_.a: 5,
                             l1l111l111l_opy_.l11111111ll_opy_.b: 6, "no": 0}
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + \
            "note : measure position<{}> end measure position<{} duration<{}> beat_number<{}> beat_position<{}> rest<{}> chord<{}> chord-state<{}> grace<{}> slash<{}> step<{}> alter<{}> accidental<{}> octave<{}> voice<{}> type<{}> dot<{}> staff<{}> finger<{}> slur<{}> slur_placement<{}> slur_number<{}> slur_type<{}> slur2<{}> slur_placement2<{}> slur_number2<{}> slur_type2<{}> tie<{}> tie-type<{}> tied<{}> tied-type<{}> actual-notes<{}> normal-notes<{}> note_hight<{}> syllabic<{}> text<{}> staccato<{}> staccatissimo<{}> accent<{}> breath-mark<{}> fermata<{}> trill<{}> inverted-mordent<{}> inverted-mordent-placement<{}> inverted-mordent-long<{}> mordent<{}> mordent-placement<{}> mordent-long<{}> arpeggiate<{}> arpeggiate-direction<{}> two-hands-arpeggiate<{}> two-hands-arpeggiate-direction<{}> current_voice<{}> braille-group<{}>\n".format(
                self.l1llll111ll1_opy_, self.l1llll11ll1l_opy_, self.l11lll1l11_opy_, self.l1llll11l1ll_opy_,
                self.l1lll1lll111_opy_, self.rest, self.l1lll1l11l1_opy_, self.l1ll1llll11_opy_, self.l1111lll1l_opy_,
                self.l11lll1111_opy_, self.step, self.l11lll11ll_opy_, self.l1llll11ll1_opy_, self.l1l11111ll_opy_,
                self.l1111l1lll_opy_, self.type, self.dot, self.l11111ll11_opy_, self.l11llll111_opy_,
                self.l1llllll1ll_opy_, self.l11l1111ll_opy_, self.l1lll1111ll_opy_, self.l1111l1l11_opy_,
                self.l111ll11l1_opy_, self.l1llll1lll1_opy_, self.l11l11l1ll_opy_, self.l11l111l11_opy_,
                self.l1l11l11l1_opy_, self.l1l1111111_opy_, self.l1lll1l111l1_opy_, self.l1lll1llll11_opy_,
                self.l1llllll11l_opy_, self.l1lll1lll11_opy_, self.l1llll1l111l_opy_, self.l111llllll_opy_, self.text,
                self.l1llll1l1l1_opy_, self.l1l111l11l_opy_, self.l1lll1l1lll_opy_, self.l1l11l1l1l_opy_,
                self.l1llll111l1_opy_, self.l11llllll1_opy_, self.l1l111l111_opy_, self.l11ll11l1l_opy_,
                self.l1lll1ll11l_opy_, self.l111l11l11_opy_, self.l1lll1ll1ll_opy_, self.l1l11ll1l1_opy_,
                self.l11l1ll111_opy_, self.l1lllll11l1_opy_, self.l1lllllll11_opy_, self.l111l1lll1_opy_,
                self.l1lll1llllll_opy_, self.l1lll1l11ll1_opy_)
...
class l111ll1ll1l_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + "backup : measure position<{}> duration<{}> full measure<{}> same staff<{}> staff<{}> current_voice<{}>\n".format(
            self.l1llll111ll1_opy_, self.l11lll1l11_opy_, self.l1llll1l1ll1_opy_, self.l1llll1l11l1_opy_,
            self.l11111ll11_opy_, self.l1lll1llllll_opy_)
...
class l11l1l1l1l1_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + "transpose : diatonic<{}> chromatic<{}> octave-change<{}> double<{}> double-above<{}>\n".format(
            self.l11lll111l_opy_, self.l111111111_opy_, self.l1lll1llll1_opy_, self.l1111l11l1_opy_,
            self.l1lllllll1l_opy_)
...
class l1l111l11l1_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + "clef number<{}> sign<{}> line<{}> clef-octave-change<{}> braille-clef<{}>\n".format(
            self.l1lll1l11l11_opy_, self.sign, self.line, self.l1lllll1111_opy_, self.l1lllll1ll1_opy_)
...
class l11llll11ll_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + "metronome : beat-unit<{}> beat-unit-dot<{}> per minute<{}> parenthesis<{}> current_voice<{}>\n".format(
            self.l11111l111_opy_, self.l1l11lllll_opy_, self.l111111ll1_opy_, self.l1lll1ll1111_opy_,
...
class l1l1l111l11_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + \
            "sound<{}> sound_tempo<{}> sound_dynamics<{}>\n".format(self.l1l11l1ll1l_opy_, self.l11111l1ll_opy_,
...
class l11ll11l1l1_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        text = " " * level + "direction : placement<{}> staff<{}>, self.current_voice<{}>\n".format(
            self.l111lll11l_opy_, self.l11111ll11_opy_, self.l1lll1llllll_opy_)
...
class l1l1l1l111l_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + "barline : location<{}> bar-style<{}> repeat<{}> ending<{}> ending_number<{}> ending_type<{}> current_voice<{}>\n".format(
            self.location, self.l11ll1lll1_opy_, self.l1l111l1ll_opy_, self.l1lll1ll111l_opy_, self.l1llll1111l1_opy_,
            self.l1llll11ll11_opy_, self.l1lll1llllll_opy_)
...
class l11ll11ll11_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + "Measure-style : multiple-rest<{}> measurerepeat<{}> repeat-type<{}>\n".format(
            self.l1lll1l111ll_opy_, self.l1llll1111ll_opy_, self.l1l1ll1lll1_opy_)
...
class l1l11lll11l_opy_(l1lll1l1l11l_opy_):
    ...
    def l1llll111lll_opy_(self, level):
        return " " * level + "part id<{}> part-name<{}> part-abbreviation<{}> score-instrument<{}> instrument-name<{}> midi-device-id<{}> midi-device-port<{}> midi-instrument-id<{}> midi-channel<{}> midi-program<{}> midi-volume<{}> midi-pan<{}> ascending-chords<{}>\n".format(
            self.l111l1l1ll_opy_, self.l111lll1ll_opy_, self.l11111ll1l_opy_, self.l111ll1111_opy_,
            self.l1lllll111l_opy_, self.l1l11l11ll_opy_, self.l11l11l111_opy_, self.l111ll1ll1_opy_,
            self.l111ll11ll_opy_, self.l11ll11l11_opy_, self.l1lllll1lll_opy_, self.l1111ll1ll_opy_,
