...
class l1lllllll111_opy_:
    ...
    def l1ll1l11lll_opy_(self, l11ll1ll11_opy_, encoding=None):
        ...
        self._1l111l1l_opy_ = open("trace_musicxml.txt", "w", encoding='utf-8')
        l1ll1l1ll_opy_ = l11111ll1ll_opy_()
        l11l1lll111_opy_ = l1l11111l1l_opy_(self.lou, self._1ll11lll_opy_, self.l1l111ll1_opy_)
        l11l1lll111_opy_.l1ll1l11lll_opy_(self.l1l11l111_opy_, l1ll1l1ll_opy_)
        l1llllll1ll1_opy_ = l1l1l1lll_opy_(self.l1l11l111_opy_, l1ll1l1ll_opy_)
        l1llllll1ll1_opy_.l1l1l1111_opy_()
        l1llllll1ll1_opy_.l1l11llll_opy_()
        l11111llll1_opy_ = l11111ll1l1_opy_(self.lou, self.l1l1ll111_opy_, self.l1l11l111_opy_, l1ll1l1ll_opy_, (self.l1l111ll1_opy_, 'music_xml'))
