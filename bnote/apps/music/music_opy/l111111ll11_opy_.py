...
class l11111l1111_opy_:
    ...
    def l1lll1111l11_opy_(self, element):
        ...
        (l1ll11llll1l_opy_, braille) = l1l11l1ll111_opy_.get((element.l111lll1ll_opy_, element.l11111ll1l_opy_),
                                                             (None, None))
    ...
    def l1l1lll11l1l_opy_(self, element):
        ...
        elif self._1ll111l11l1_opy_[self._1ll111ll111_opy_][
            "parts"] == 'abbreviation' and element.l11111ll1l_opy_ != "no":
    ...
    def l1l1ll1ll111_opy_(self, text):
        if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['lyrics'] == 'after_each_note' or \
                self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['edit_mode'] == 'edit':
            if text != "":
                return "".join([b0, b56, b23, self.l1ll111ll1ll_opy_(text), b0])
            else:
                return ""
        elif self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['lyrics'] in ['before_each_section',
                                                                          'after_each_section'] and \
                self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['edit_mode'] != 'edit':
    ...
    def l1l1lll111l1_opy_(self, l11111l111_opy_, l1l11lllll_opy_, l111111ll1_opy_):
        ...
        self._1l11ll111l1_opy_ = "".join(
            [b0, self._1l1ll111ll1_opy_, self._1l1lll1111l_opy_, b2356, NumeralPrefix, self._1l11l1ll1ll_opy_, b0])
    ...
    def l1l1ll1lll11_opy_(self, l1ll1llll111_opy_, l1l11l1lllll_opy_):
        ...
        if ((self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['edit_mode'] in ['edit',
                                                                             'listen'] and l1l11l1lllll_opy_) or (
                    self._1ll111l11l1_opy_[self._1ll111ll111_opy_][
                        'measure_b123'] and l1l11l1lllll_opy_)) and not self.l1l11llll1ll_opy_:
            l1l1ll1ll1ll_opy_ += b123 + b0
        if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['measure_number'] and l1ll1llll111_opy_ % int(
                self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['measure_every']) == 0:
    ...
    def l1lllll1ll1_opy_(self, sign, line, l1lllll1111_opy_, l11111ll11_opy_, l1l1l11l111l_opy_):
        ...
        if ((sign == "G" and line == "2") or (sign == "F" and line == "4") or (
                sign == "C" and line == "4")) and l1l1l11l111l_opy_ not in ["double", "double-hand"]:
            l1l11l1l111l_opy_ = ""
    ...
    def l1l1l1ll11ll_opy_(self, l1l11ll111ll_opy_, l11ll11l11_opy_):
        return "".join([b56, b23, b3, b134, b1234, b36, self.l1ll111ll1ll_opy_(l1l11ll111ll_opy_), b25,
                        self.l1ll111ll1ll_opy_(l11ll11l11_opy_)])

    def l1l11ll1l1l1_opy_(self, l1l11ll111ll_opy_, l111ll11ll_opy_):
        return "".join([b56, b23, b3, b134, b14, b36, self.l1ll111ll1ll_opy_(l1l11ll111ll_opy_), b25,
                        self.l1ll111ll1ll_opy_(l111ll11ll_opy_)])

    def l1l1l1ll1ll1_opy_(self, l1l11ll111ll_opy_, l1lllll1lll_opy_):
        return "".join([b56, b23, b3, b134, b1236, b36, self.l1ll111ll1ll_opy_(l1l11ll111ll_opy_), b25,
                        self.l1ll111ll1ll_opy_(l1lllll1lll_opy_)])

    def l1l1l111ll11_opy_(self, element, l11lll111l_opy_):
        l1ll1l1111l1_opy_ = ""
        if l11lll111l_opy_ != 0:
            if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'name':
                l1ll1l1111l1_opy_ = "".join(
                    [b56, b23, b3, b2345, b1235, b145, b24, b36, self.l1ll111ll1ll_opy_(element.l111lll1ll_opy_), b25,
                     self.l1ll111ll1ll_opy_(l11lll111l_opy_)])
            elif self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'abbreviation':
                l1ll1l1111l1_opy_ = "".join(
                    [b56, b23, b3, b2345, b1235, b145, b24, b36, self.l1ll111ll1ll_opy_(element.l11111ll1l_opy_), b25,
                     self.l1ll111ll1ll_opy_(l11lll111l_opy_)])
    ...
    def l1l11llllll1_opy_(self, element, l111111111_opy_):
        ...
        if l111111111_opy_ != 0:
            if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'name':
                l1ll1l1111l1_opy_ = "".join(
                    [b56, b23, b3, b2345, b1235, b14, b125, b36, self.l1ll111ll1ll_opy_(element.l111lll1ll_opy_), b25,
                     self.l1ll111ll1ll_opy_(l111111111_opy_)])
            elif self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'abbreviation':
                l1ll1l1111l1_opy_ = "".join(
                    [b56, b23, b3, b2345, b1235, b14, b125, b36, self.l1ll111ll1ll_opy_(element.l11111ll1l_opy_), b25,
                     self.l1ll111ll1ll_opy_(l111111111_opy_)])
            return l1ll1l1111l1_opy_
        else:
            return ""
    ...
    def l1l1l1ll1l11_opy_(self, element, l1lll1llll1_opy_):
        ...
        if l1lll1llll1_opy_ != 0:
            if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'name':
                l1ll1l1111l1_opy_ = "".join(
                    [b56, b23, b3, b2345, b1235, b135, b14, b36, self.l1ll111ll1ll_opy_(element.l111lll1ll_opy_), b25,
                     self.l1ll111ll1ll_opy_(l1lll1llll1_opy_)])
            elif self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'abbreviation':
                l1ll1l1111l1_opy_ = "".join(
                    [b56, b23, b3, b2345, b1235, b135, b14, b36, self.l1ll111ll1ll_opy_(element.l11111ll1l_opy_), b25,
                     self.l1ll111ll1ll_opy_(l1lll1llll1_opy_)])
            return l1ll1l1111l1_opy_
        else:
            return ""
    ...
    def l1l11l1l11ll_opy_(self, element, l1111l11l1_opy_, l1lllllll1l_opy_):
        ...
        if l1111l11l1_opy_:
            if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'name':
                l1ll1l1111l1_opy_ = "".join(
                    [b56, b23, b3, b2345, b1235, b145, b135, b36, self.l1ll111ll1ll_opy_(element.l111lll1ll_opy_), b25])
            elif self._1ll111l11l1_opy_[self._1ll111ll111_opy_]["parts"] == 'abbreviation':
                l1ll1l1111l1_opy_ = "".join(
                    [b56, b23, b3, b2345, b1235, b145, b135, b36, self.l1ll111ll1ll_opy_(element.l11111ll1l_opy_), b25])
            if l1lllllll1l_opy_ != "":
    ...
    def l111111llll_opy_(self):
        ...
        def l1l11lll1l1l_opy_():
            ...
            if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['edit_mode'] in ['edit', 'listen']:
                ...
                if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['section'] == 'system':
                    ...
                    l1l1ll1111l1_opy_ = self.l1l1l1l11l1l_opy_(l1l1ll1l11l1_opy_, int(
                        self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['measures_per_section']))
            ...
            if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['section'] == 'number':
                ...
                while l1ll111l1lll_opy_ < l1l1l11l1111_opy_:
                    ...
                    for part in self.l1l1ll1ll1l1_opy_:
                        ...
                        for l111111l1l_opy_ in part[0][l1ll111l1lll_opy_:min(l1ll111l1lll_opy_ + int(
                                self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['measures_per_section']), len(part[0]))]:
                ...
                for system in l1l1ll11l11l_opy_:
                    ...
                    for part in self.l1l1ll1ll1l1_opy_:
                        self._1l11lll11ll_opy_ = part[2]
                        for l111111l1l_opy_ in part[0][
                                               l1ll111l1lll_opy_:min(l1ll111l1lll_opy_ + system - l1l11l1llll1_opy_,
                                                                     len(part[0]))]:
                            l1l1l1l11111_opy_.append(l111111l1l_opy_)
                        l1l11l1lll1l_opy_(l1l1l1l11111_opy_, l1lll11lll11_opy_)
                        l1l1l1l11111_opy_.clear()
        ...
        for element in self._1l1l11ll_opy_.l1lll1l111l_opy_:
            if element.t == "part":
                ...
                l1l1lll11111_opy_.append(
                    [element.l111l1l1ll_opy_, element.l111lll1ll_opy_, element.l11111ll1l_opy_, self._1l11lll11ll_opy_])
        self._11lllll1_opy_("braille_sub_parts " + str(l1l1lll11111_opy_))
        l1l11ll11l11_opy_ = list()
        for part in l1l1lll11111_opy_:
            if part[3] == 1:
                l1l11ll11l11_opy_.append(
                    [part[0], part[0], part[1], part[1], part[2], part[2], 1, "no", "no", "no", "no"])
            else:
                l1l11ll11l11_opy_.append(
                    [part[0], part[0] + "-br1", part[1], part[1] + "-br1", part[2], part[2] + "-br1", part[3], "no",
                     "no", "no", "no"])
            if part[3] >= 2:
                l1l11ll11l11_opy_.append(
                    [part[0], part[0] + "-br2", part[1], part[1] + "-br2", part[2], part[2] + "-br2", 2, "no", "no",
                     "no", "no"])
            if part[3] >= 3:
                l1l11ll11l11_opy_.append(
                    [part[0], part[0] + "-br3", part[1], part[1] + "-br3", part[2], part[2] + "-br3", 3, "no", "no",
                     "no", "no"])
        l1l11l11llll_opy_ = 0
        l1ll1l11lll1_opy_ = 0
        for element in self._1l1l11ll_opy_.l1lll1l111l_opy_:
            if element.t == "braille-global":
                ...
                for event in element.l11l1l1lll_opy_:
                    if event.t == "global-key":
                        ...
                        l11l1111l1l_opy_ += self.l1l1l11l1l1l_opy_(event.l1l1l11111_opy_, event.l1111lll11_opy_,
                                                                   event.l11lllll1l_opy_)
                if l11l1111l1l_opy_ != "":
                ...
                for item in element.l111l1l1l1_opy_:
                    ...
                    if item.l11ll11l11_opy_ != "no":
                        ...
                        for part in l1l1lll11111_opy_:
                            if part[0] == item.l111l1l1ll_opy_ and part[3] == 1:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_,
                                                               self.l1l1l1ll11ll_opy_(self.l1lll1111l11_opy_(item),
                                                                                      item.l11ll11l11_opy_)])
                            elif part[0] == item.l111l1l1ll_opy_ and part[3] >= 2:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l1l1ll11ll_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br1", item.l11ll11l11_opy_)])
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l1l1ll11ll_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br2", item.l11ll11l11_opy_)])
                            if part[0] == item.l111l1l1ll_opy_ and part[3] == 3:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l1l1ll11ll_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br3", item.l11ll11l11_opy_)])
                    if item.l111ll11ll_opy_ != "no":
                        ...
                        for part in l1l1lll11111_opy_:
                            if part[0] == item.l111l1l1ll_opy_ and part[3] == 1:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_,
                                                               self.l1l11ll1l1l1_opy_(self.l1lll1111l11_opy_(item),
                                                                                      item.l111ll11ll_opy_)])
                            elif part[0] == item.l111l1l1ll_opy_ and part[3] >= 2:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l11ll1l1l1_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br1", item.l111ll11ll_opy_)])
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l11ll1l1l1_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br2", item.l111ll11ll_opy_)])
                            if part[0] == item.l111l1l1ll_opy_ and part[3] == 3:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l11ll1l1l1_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br3", item.l111ll11ll_opy_)])
                    if item.l1lllll1lll_opy_ != "no":
                        ...
                        for part in l1l1lll11111_opy_:
                            if part[0] == item.l111l1l1ll_opy_ and part[3] == 1:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_,
                                                               self.l1l1l1ll1ll1_opy_(self.l1lll1111l11_opy_(item),
                                                                                      item.l1lllll1lll_opy_)])
                            elif part[0] == item.l111l1l1ll_opy_ and part[3] >= 2:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l1l1ll1ll1_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br1", item.l1lllll1lll_opy_)])
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l1l1ll1ll1_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br2", item.l1lllll1lll_opy_)])
                            if part[0] == item.l111l1l1ll_opy_ and part[3] == 3:
                                self.l1l1l111l11l_opy_.append([l1l11lllllll_opy_, self.l1l1l1ll1ll1_opy_(
                                    self.l1lll1111l11_opy_(item) + "-br3", item.l1lllll1lll_opy_)])
            ...
            if element.t == "part":
                ...
                for l111111l1l_opy_ in element.l11l1l1ll1_opy_:
                    ...
                    if self.l1l1l11l1ll1_opy_ and self.l1l11llll1ll_opy_ and element.l111lll1ll_opy_ not in [
                        "Br Piano right hand", "Br Piano left hand", "Br Piano solo", "Bru Piano right hand",
                        "Brd Piano left hand", "Br Organ pedal"]:
                        if self._1l11ll1llll_opy_[l1l11l11llll_opy_] == "1":
                    ...
                    for event in l111111l1l_opy_.l111l11lll_opy_:
                        if event.t == "direction":
                            for l11lllll11_opy_ in event.l1lll1111l1_opy_:
                                if l11lllll11_opy_.t == "words":
                                    l1l11l1ll_opy_(self.l1l11lll1lll_opy_(l11lllll11_opy_.words),
                                                   l11lllll11_opy_.l11111ll11_opy_)
                                elif l11lllll11_opy_.t == "dynamics":
                                    l1l11l1ll_opy_(self.l1l1l1l11lll_opy_(l11lllll11_opy_.l1l11l1ll1_opy_),
                                    ...
                                    l1l11l1ll_opy_(self.l1l1l11lll11_opy_(l11lllll11_opy_.l1l11l1l11_opy_),
                                                   event.l11111ll11_opy_)
                                elif l11lllll11_opy_.t == "wedge":
                                    l1l11l1ll_opy_(self.l1l1ll1l111l_opy_(l11lllll11_opy_.l11ll11ll1_opy_),
                                                   event.l11111ll11_opy_)
                                elif l11lllll11_opy_.t == "metronome":
                                    l1l11l1ll_opy_(self.l1l1lll111l1_opy_(l11lllll11_opy_.l11111l111_opy_,
                                                                          l11lllll11_opy_.l1l11lllll_opy_,
                                                                          l11lllll11_opy_.l111111ll1_opy_),
                                                   event.l11111ll11_opy_)
                                elif l11lllll11_opy_.t == "sound":
                                    if l11lllll11_opy_.l11111l1ll_opy_ != "no":
                                        l1l11l1ll_opy_(self.l1l11lll11l1_opy_(l11lllll11_opy_.l11111l1ll_opy_),
                                                       event.l11111ll11_opy_)
                        ...
                        if event.t == "attributes":
                            for l11lllll11_opy_ in event.l11l111ll1_opy_:
                                if l11lllll11_opy_.t == "key":
                                ...
                                elif l11lllll11_opy_.t == "time" and (
                                        l11lllll11_opy_.l1l1l11111_opy_ != l1l1l1111ll1_opy_ or l11lllll11_opy_.l1111lll11_opy_ != l1l11lll1ll1_opy_ or l11lllll11_opy_.l11lllll1l_opy_ != l1l1l1l1llll_opy_):
                                    l1l11l1ll_opy_(self.l1l1l11l1l1l_opy_(l11lllll11_opy_.l1l1l11111_opy_,
                                                                          l11lllll11_opy_.l1111lll11_opy_,
                                                                          l11lllll11_opy_.l11lllll1l_opy_), 1)
                                    if self._1l11lll11ll_opy_ >= 2:
                                        l1l11l1ll_opy_(self.l1l1l11l1l1l_opy_(l11lllll11_opy_.l1l1l11111_opy_,
                                                                              l11lllll11_opy_.l1111lll11_opy_,
                                                                              l11lllll11_opy_.l11lllll1l_opy_), 2)
                                    if self._1l11lll11ll_opy_ >= 3:
                                        l1l11l1ll_opy_(self.l1l1l11l1l1l_opy_(l11lllll11_opy_.l1l1l11111_opy_,
                                                                              l11lllll11_opy_.l1111lll11_opy_,
                                                                              l11lllll11_opy_.l11lllll1l_opy_), 3)
                                elif l11lllll11_opy_.t == "clef":
                                    l1l11l1ll_opy_(self.l1lllll1ll1_opy_(l11lllll11_opy_.sign, l11lllll11_opy_.line,
                                                                         l11lllll11_opy_.l1lllll1111_opy_,
                                                                         l11lllll11_opy_.l1lll1l11l11_opy_,
                                                                         l11lllll11_opy_.l1lllll1ll1_opy_),
                                                   l11lllll11_opy_.l1lll1l11l11_opy_)
                                elif l11lllll11_opy_.t == "transpose":
                                    self.l1l1l111l11l_opy_.append([l1ll1l11lll1_opy_, self.l1l1l111ll11_opy_(element,
                                                                                                             l11lllll11_opy_.l11lll111l_opy_)])
                                    self.l1l1l111l11l_opy_.append([l1ll1l11lll1_opy_, self.l1l11llllll1_opy_(element,
                                                                                                             l11lllll11_opy_.l111111111_opy_)])
                                    self.l1l1l111l11l_opy_.append([l1ll1l11lll1_opy_, self.l1l1l1ll1l11_opy_(element,
                                                                                                             l11lllll11_opy_.l1lll1llll1_opy_)])
                                    self.l1l1l111l11l_opy_.append([l1ll1l11lll1_opy_, self.l1l11l1l11ll_opy_(element,
                                                                                                             l11lllll11_opy_.l1111l11l1_opy_,
                                                                                                             l11lllll11_opy_.l1lllllll1l_opy_)])
                                    ...
                                    if l11lllll11_opy_.l1llll1111ll_opy_ != "no" and l11lllll11_opy_.l1l1ll1lll1_opy_ == "stop":
                                        self.l1l1l1llllll_opy_ = True
                                        l1l11l1ll_opy_(
                                            self.l1l1ll1lll11_opy_(l111111l1l_opy_.l1lll111l11_opy_, l1l11l1l1111_opy_),
                                            1)
                        if event.t == "barline":
                        ...
                        if event.t == "note" and event.l1ll1llll11_opy_ == 0:
                            if event.l1llll11ll1_opy_ == "natural":
                                l1l11l1ll_opy_(
                                    self.l1l11l11l11l_opy_(l1l111l111l_opy_.l1llllllll11_opy_.l1llllllllll_opy_)[1],
                                    event.l11111ll11_opy_)
                            if (event.step, event.l11lll11ll_opy_) not in l1l1lll11ll1_opy_[l1lll1l1l11_opy_] and (
                                    event.step, event.l11lll11ll_opy_) not in l1ll111lllll_opy_:
                            ...
                            if event.l11111ll11_opy_ == 1:
                                if l1l1ll11ll1l_opy_ == False and (
                                        abs(event.l1llll1l111l_opy_ - l1l11ll11lll_opy_) > 4 or (
                                        abs(event.l1llll1l111l_opy_ - l1l11ll11lll_opy_) > 2 and event.l1l11111ll_opy_ != l1l1ll1lllll_opy_)):
                                    l1l11l1ll_opy_(self.l1l11ll1111l_opy_(event.l1l11111ll_opy_), event.l11111ll11_opy_)
                                if l1l1ll11ll1l_opy_ and (abs(event.l1llll1l111l_opy_ - l1l11l111l11_opy_) > 4 or (
                                        abs(event.l1llll1l111l_opy_ - l1l11l111l11_opy_) > 2 and event.l1l11111ll_opy_ != l1l1l1lll111_opy_)):
                                    l1l11l1ll_opy_(self.l1l11ll1111l_opy_(event.l1l11111ll_opy_), event.l11111ll11_opy_)
                            if event.l11111ll11_opy_ == 2:
                                if l1l1l1111l1l_opy_ == False and (
                                        abs(event.l1llll1l111l_opy_ - l1l11l1l1l11_opy_) > 4 or (
                                        abs(event.l1llll1l111l_opy_ - l1l11l1l1l11_opy_) > 2 and event.l1l11111ll_opy_ != l1l1l11l11l1_opy_)):
                                    l1l11l1ll_opy_(self.l1l11ll1111l_opy_(event.l1l11111ll_opy_), event.l11111ll11_opy_)
                                if l1l1l1111l1l_opy_ and (abs(event.l1llll1l111l_opy_ - l1l1l1111111_opy_) > 4 or (
                                        abs(event.l1llll1l111l_opy_ - l1l1l1111111_opy_) > 2 and event.l1l11111ll_opy_ != l1l11llll11l_opy_)):
                                    l1l11l1ll_opy_(self.l1l11ll1111l_opy_(event.l1l11111ll_opy_), event.l11111ll11_opy_)
                            if event.l11111ll11_opy_ == 3:
                                if l1l11llll1l1_opy_ == False and (
                                        abs(event.l1llll1l111l_opy_ - l1l1l11l11ll_opy_) > 4 or (
                                        abs(event.l1llll1l111l_opy_ - l1l1l11l11ll_opy_) > 2 and event.l1l11111ll_opy_ != l1l11lll1l11_opy_)):
                                    l1l11l1ll_opy_(self.l1l11ll1111l_opy_(event.l1l11111ll_opy_), event.l11111ll11_opy_)
                                if l1l11llll1l1_opy_ and (abs(event.l1llll1l111l_opy_ - l1l1l1ll11l1_opy_) > 4 or (
                                        abs(event.l1llll1l111l_opy_ - l1l1l1ll11l1_opy_) > 2 and event.l1l11111ll_opy_ != l1l11l1l1ll1_opy_)):
                                    l1l11l1ll_opy_(self.l1l11ll1111l_opy_(event.l1l11111ll_opy_), event.l11111ll11_opy_)
                            l1l11l1ll_opy_(self.l1l1ll11llll_opy_(event.step, event.type,
                                                                  event.l1lll1l11ll1_opy_) + self.l1l11ll1l11l_opy_(
                                event.dot) + self.l1l1ll111111_opy_(event.l11llll111_opy_) + self.l1l1l11lllll_opy_(
                                event.l1l1111111_opy_) + self.l1l1ll1ll111_opy_(event.text), event.l11111ll11_opy_)
                        ...
                        if event.t == "note" and event.l1ll1llll11_opy_ == 3:
                            ...
                            if self.l1l11lll111l_opy_:
                                if event.l11111ll11_opy_ == 1:
                                    self.l1l1l1111l11_opy_ = sorted(self.l1l1ll111lll_opy_,
                                                                    key=lambda note: note.l1llll1l111l_opy_,
                                                                    reverse=True)
                                else:
                                    self.l1l1l1111l11_opy_ = sorted(self.l1l1ll111lll_opy_,
                                                                    key=lambda note: note.l1llll1l111l_opy_)
                            ...
                            for i, l1l1l11ll1l1_opy_ in enumerate(self.l1l1l1111l11_opy_):
                                if i == 0:
                                    l1l11l1ll_opy_(self.l1l11l11l11l_opy_(l1l1l11ll1l1_opy_.l11lll11ll_opy_)[1],
                                                   l1l1l11ll1l1_opy_.l11111ll11_opy_)
                                    if event.l11111ll11_opy_ == 1:
                                        if abs(l1l11l111l11_opy_ - l1l11ll11lll_opy_) > 4 or (
                                                abs(l1l11l111l11_opy_ - l1l11ll11lll_opy_) > 2 and l1l1l1lll111_opy_ != l1l1ll1lllll_opy_):
                                            l1l11l1ll_opy_(self.l1l11ll1111l_opy_(l1l1l11ll1l1_opy_.l1l11111ll_opy_),
                                                           l1l1l11ll1l1_opy_.l11111ll11_opy_)
                                    elif event.l11111ll11_opy_ == 2:
                                        if abs(l1l1l1111111_opy_ - l1l11l1l1l11_opy_) > 4 or (
                                                abs(l1l1l1111111_opy_ - l1l11l1l1l11_opy_) > 2 and l1l11llll11l_opy_ != l1l1l11l11l1_opy_):
                                            l1l11l1ll_opy_(self.l1l11ll1111l_opy_(l1l1l11ll1l1_opy_.l1l11111ll_opy_),
                                                           l1l1l11ll1l1_opy_.l11111ll11_opy_)
                                    elif event.l11111ll11_opy_ == 3:
                                        if abs(l1l1l1ll11l1_opy_ - l1l1l11l11ll_opy_) > 4 or (
                                                abs(l1l1l1ll11l1_opy_ - l1l1l11l11ll_opy_) > 2 and l1l11l1l1ll1_opy_ != l1l11lll1l11_opy_):
                                            l1l11l1ll_opy_(self.l1l11ll1111l_opy_(l1l1l11ll1l1_opy_.l1l11111ll_opy_),
                                                           l1l1l11ll1l1_opy_.l11111ll11_opy_)
                                    l1l11l1ll_opy_(
                                        self.l1l1ll11llll_opy_(l1l1l11ll1l1_opy_.step, l1l1l11ll1l1_opy_.type,
                                                               l1l1l11ll1l1_opy_.l1lll1l11ll1_opy_) + self.l1l11ll1l11l_opy_(
                                            l1l1l11ll1l1_opy_.dot) + self.l1l1ll111111_opy_(
                                            l1l1l11ll1l1_opy_.l11llll111_opy_) + self.l1l1l11lllll_opy_(
                                            l1l1l11ll1l1_opy_.l1l1111111_opy_), l1l1l11ll1l1_opy_.l11111ll11_opy_)
                                    ...
                                    while l1l11l111l1l_opy_ > 7:
                                        l1l11l111l1l_opy_ -= 7
                                        l1ll11lll1l1_opy_ = self.l1l11ll1111l_opy_(l1l1l11ll1l1_opy_.l1l11111ll_opy_)
                                    l1l11l1ll_opy_(self.l1l11l11l11l_opy_(l1l1l11ll1l1_opy_.l11lll11ll_opy_)[
                                                       1] + l1ll11lll1l1_opy_ + self.l1l11l11ll1l_opy_(
                                        l1l11l111l1l_opy_) + self.l1l1ll111111_opy_(
                                        l1l1l11ll1l1_opy_.l11llll111_opy_) + self.l1l1l11lllll_opy_(
                                        l1l1l11ll1l1_opy_.l1l1111111_opy_), l1l1l11ll1l1_opy_.l11111ll11_opy_)
                                    l1l11l1ll_opy_(self.l1l1ll1ll111_opy_(l1l11l1l1lll_opy_),
                                                   l1l1l11ll1l1_opy_.l11111ll11_opy_)
                    ...
                    l1l1ll1l11l1_opy_.append(
                        [l1l1l111l111_opy_, l1l1ll1l11ll_opy_, l1l1ll11111l_opy_, self.l1l1l1l1lll1_opy_])
                self.l1l1ll1ll1l1_opy_.append((l1l1ll1l11l1_opy_, l1111l11ll_opy_, self._1l11lll11ll_opy_))
                if self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['view'] == 'by_part' or \
                        self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['section'] == 'total_part' or \
                        self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['edit_mode'] in ['edit', 'listen']:
                    l1l11lll1l1l_opy_()
                l1l11l11llll_opy_ += 1
                self.l1l11lll111l_opy_ = False
        if (self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['view'] == 'by_section' and
            self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['section'] != 'total_part') and \
                self._1ll111l11l1_opy_[self._1ll111ll111_opy_]['edit_mode'] not in ['edit', 'listen']:
            l1l11l111ll1_opy_()
