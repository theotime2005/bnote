...
class l11l1l1l1l1_opy_:
    ...
    def l1ll1l11l1l_opy_(self, l1l1llll1ll_opy_, encoding=None):
        ...
        l111lllll1_opy_ = l11llll1ll_opy_(
            self.lou, self._1ll1llll_opy_, self.l1l111lll_opy_
        )
        l111lllll1_opy_.l1ll1l11l1l_opy_(self.l1l1111ll_opy_, l1ll1l1ll_opy_)
        l11l1l1l11l_opy_ = l1l11llll_opy_(self.l1l1111ll_opy_, l1ll1l1ll_opy_)
        l11l1l1l11l_opy_.l1l1l1l11_opy_()
        l11l1l1l11l_opy_.l1l1ll111_opy_()
        l11ll1l11l1_opy_ = l11ll1l1111_opy_(
            self.lou,
            self.l1l11lll1_opy_,
            self.l1l1111ll_opy_,
            l1ll1l1ll_opy_,
            (self.l1l111lll_opy_, "music_xml"),
        )
