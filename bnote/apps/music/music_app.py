...
class MusicApp(EditorBaseApp):
    ...
    def __init__(self, put_in_function_queue, file_name=None, language=None, read_only=False):
        ...
        if (extention == 'bxml' and Settings().data['music_bxml']['edit_mode'] in ['read', 'listen']) or (extention == 'musicxml' and Settings().data['music_xml']['edit_mode'] in ['read', 'listen']):
            self._menu.get_object(self.export).hide()
            self._menu.get_object(self.insert).hide()
        if (extention == 'bxml' and Settings().data['music_bxml']['edit_mode'] == 'read') or (extention == 'musicxml' and Settings().data['music_xml']['edit_mode'] == 'read'):
    ...
    def enable_write(file):
        ...
        if extention == "bxml" and Settings().data['music_bxml']['edit_mode'] in ['read', 'listen']:
            return False
        elif extention == "musicxml" and Settings().data['music_xml']['edit_mode'] not in ['expert', 'edit']:
            return False
        return True
            ...
            menu_item_list=[
                ui.UiMenuBar(
                    ...
                    menu_item_list=[
                        ...
                        ui.UiMenuBar(name=_("&export"), action=self.export,
                                  menu_item_list=[
                                      ui.UiMenuItem(name=_("&musicxml"), action=self._exec_export_musicxml,
                                                 shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL,
                                                 shortcut_key='M'),
                                      ui.UiMenuItem(name=_("&bxml"), action=self._exec_export_bxml,
                                                 shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL,
                                                 shortcut_key='B'),
                                      ]),
                        ui.UiMenuItem(name=_("&properties"), action=self._exec_properties),
                        ui.UiMenuItem(name=_("sta&tistics"), action=self._exec_statistics),
                    ]),
                self.create_sub_menu_edit(),
                ui.UiMenuBar(
                    name=_("&insert"), action=self.insert,
                    menu_item_list=[
                        self.create_sub_menu_text(),
                        ui.UiMenuItem(name=_("&key signature"), action=self._exec_insert_key_signature),
                        ...
                        ui.UiMenuItem(name=_("&octave sign"), action=self._exec_insert_octave),
                    ]),
                ...
                ui.UiMenuBar(
                    ...
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&play"), action=self._exec_play_score,
                                   shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL, shortcut_key='R'),
                        ui.UiMenuItem(name=_("&stop"), action=self._exec_stop_play_score, is_hide=True,
                                   shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_NONE,
                                   shortcut_key=Keyboard.BrailleFunction.BRAMIGRAPH_ESCAPE),
                        ui.UiMenuItem(name=_("pa&use"), action=self._exec_pause_play_score, is_hide=True,
    ...
    def create_sub_menu_keyboard_signs(self):
        return ui.UiMenuBar(
            ...
            menu_item_list=[
                ui.UiMenuItem(name=_("&fingering"), action=self._exec_insert_keyboard_fingering),
                ui.UiMenuItem(name=_("&pedal"), action=self._exec_insert_keyboard_pedal),
                ]
            )
    ...
    def create_sub_menu_musical_content(self):
        return ui.UiMenuBar(
            ...
            menu_item_list=[
                ...
                ui.UiMenuItem(name=_("rythmic &groups"), action=self._exec_insert_rythmic_groups),
                ui.UiMenuItem(name=_("&alteration"), action=self._exec_insert_alteration),
            ]
        )
    ...
    def create_sub_menu_accord(self):
        return ui.UiMenuBar(
            ...
            menu_item_list=[
                ...
                ui.UiMenuItem(name=_("&measure in-accord"), action=self._exec_insert_measure_in_accord),
            ]
        )
    ...
    def _exec_play_score(self):
        ...
        extension = str(Path(self.opened_file_name.suffix)).replace(".", "")
        write_file = music.MusicWriteFile(BnoteApp.lou, Settings().data, MusicApp.MIDI_FILENAME, self._score,
                                          self._get_line, self._end_save_midi, FunctionId.FUNCTION_CLOSE_DIALOG_BOX,
                                          extension)
        write_file.start()
    ...
    def _exec_insert_title(self):
        self._current_dialog = ui.UiDialogBox(
            ...
            item_list=[
                ...
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_title_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
            ],
            action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_sub_title(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiEditBox(name=_("&sub title"), value=("sub title", _("score's sub title"))),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_sub_title_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
            ],
            action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_composer(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiEditBox(name=_("&composer"), value=("composer", _("score's composer"))),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_composer_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_lyricist(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiEditBox(name=_("&lyricist"), value=("lyricist", "score's lyricist")),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_lyricist_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_text(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiEditBox(name=_("&text"), value=("text", _("text outside of the score"))),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_text_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_part(self):
        self._current_dialog = ui.UiDialogBox(
            ...
            item_list=[
                ...
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_part_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_lyrics(self):
        self._current_dialog = ui.UiDialogBox(
            ...
            item_list=[
                ...
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_lyrics_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_karaoke(self):
        self._current_dialog = ui.UiDialogBox(
            ...
            item_list=[
                ...
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_karaoke_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_keyboard_fingering(self):
        ...
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("choose &finger"), value=("finger", [_("first finger"), _("second finger"), _("third finger"), _("fourth finger"), _("fifth finger")]), current_index=0),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_keyboard_fingering_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_keyboard_pedal(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("&pedal"), value=("pedal", [_("pedal down"), _("pedal up"), _("pedal under note"), _("half-pedal"), _("pedal up as soon as chord is struck")]), current_index=0),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_keyboard_pedal_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_alteration(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &alteration of note"), value=("alteration", [_("flat"), _("natural"), _("sharp")]), current_index=1),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_alteration_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
    ...
    def _exec_insert_key_signature(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &tonality"), value=("key", [_("do (+)/la (-)"), _("re flat (+)/la sharp (-)"), _("re (+)/si (-)"), _("mi flat (+)/do (-)"), _("mi (+)/do sharp (-)"), _("fa (+)/re (-)"), _("sol flat (+)/re sharp (-)"), _("sol (+)/mi (-)"), _("la flat (+)/fa (-)"), _("la (+)/fa sharp (-)"), _("si flat (+)/sol (-)"), _("si (+)/la sharp (-)")]), current_index=0),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_key_signature_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_octave(self):
        ...
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select an &octave"),
                          value=("octave",
                                 [_("a below first octave"),
                                  ...
                                  _("eighth octave")]),
                          current_index=4),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_octave_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_nuance(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select a &nuance"), value=("nuance", [_("crescendo"), _("pianissimo"), _("piano"), _("mezzo piano"), _("mezzo forte"), _("forte"), _("fortissimo"), _("diminuendo")]), current_index=2),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_nuance_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_note(self):
        ...
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &note"), value=("note", [_("a"), _("b"), _("c"), _("d"), _("e"), _("f"), _("g")]), current_index=2),
                ui.UiListBox(name=_("select &value of note"), value=("duration", [_("whole"), _("half"), _("quarter"), _("eighth"), _("16th"), _("32nd"), _("64th"), _("128th")]), current_index=0),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_note_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_silence(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select a &rest type"), value=("type", [_("whole rest"), _("half rest"), _("quarter rest"), _("eighth rest"), _("16th rest"), _("32nd rest"), _("64th rest"), _("128th rest")]), current_index=0),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_silence_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_bar(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &bar"), value=("type", [_("measure"), _("end of composition"), _("end of section"), _("simple repetition of fragment"), _("repeat fragment with prima and seconda volta")]), current_index=0),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_bar_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_interval(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &interval"), value=("interval", [_("seconde"), _("third"), _("fourth"), _("fifth"), _("sixth"), _("seventh"), _("octave")]), current_index=0),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_interval_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_measure_in_accord(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiEditBox(name=_("enter the number of &voice"), value=("number", "2")),
                ui.UiCheckBox(name=_("&full-measure in-accord"), value=("type", True)),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_measure_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_clef(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &clef"), value=("clef", [_("treble"), _("alto"), _("basse")]), current_index=0),
                ui.UiCheckBox(name=_("in &part"), value=("type", False)),
                ui.UiListBox(name=_("clef &line"), value=("line", [_("default"), _("first line"), _("second line"), _("third line"), _("fourth line"), _("fifth line")]), current_index=0),
                ui.UiListBox(name=_("add small &8?"), value=("8", [_("below"), _("no"), _("above")]), current_index=1),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_clef_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_rythmic_groups(self):
        self._current_dialog=ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("&rythm type"), value=("rythm", [_("group of 2 notes"), _("triplet"), _("group of 4 notes"), _("group of 5 notes"), _("group of 6 notes"), _("group of 7 notes"), _("group of 8 notes"), _("group of 9 notes"), _("group of 10 notes")]), current_index=0),
                ui.UiButton(name=_("&insert"), action=self._exec_valid_insert_rythmic_groups_dialog),
                ui.UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
