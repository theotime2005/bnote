...
class MusicApp(EditorBaseApp):
    ...
    def __init__(self, put_in_function_queue, file_name=None, language=None, read_only=False):
        ...
        if (extention == 'bxml' and Settings().data['music_bxml']['edit_mode'] in ['read', 'listen']) or (
                extention == 'musicxml' and Settings().data['music_xml']['edit_mode'] in ['read', 'listen']):
            self._menu.get_object(self.export).hide()
            self._menu.get_object(self.insert).hide()
        if (extention == 'bxml' and Settings().data['music_bxml']['edit_mode'] == 'read') or (
                extention == 'musicxml' and Settings().data['music_xml']['edit_mode'] == 'read'):
        ...
        return ui.UiMenuBar(
            ...
            menu_item_list=[
                ui.UiMenuItem(name=_("&title"), action=self._exec_insert_title,
                              shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL + Keyboard.BrailleModifier.BRAILLE_FLAG_ALT,
                              shortcut_key='T'),
    ...
    def write_data_file(self, lou, full_file_name, get_line, on_end, function):
        ...
        return music.MusicWriteFile(lou, Settings().data, full_file_name, self._score, get_line, on_end, function,
                                    extension)
    ...
    def _exec_insert_keyboard_fingering(self):
        ...
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("choose &finger"), value=("finger",
                                                              [_("first finger"), _("second finger"), _("third finger"),
                                                               _("fourth finger"), _("fifth finger")]),
                             current_index=0),
    ...
    def _exec_insert_keyboard_pedal(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("&pedal"), value=("pedal", [_("pedal down"), _("pedal up"), _("pedal under note"),
                                                                _("half-pedal"),
    ...
    def _exec_insert_alteration(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &alteration of note"),
                             value=("alteration", [_("flat"), _("natural"), _("sharp")]), current_index=1),
    ...
    def _exec_insert_key_signature(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &tonality"), value=("key",
                                                                [_("do (+)/la (-)"), _("re flat (+)/la sharp (-)"),
                                                                 _("re (+)/si (-)"), _("mi flat (+)/do (-)"),
                                                                 _("mi (+)/do sharp (-)"), _("fa (+)/re (-)"),
                                                                 _("sol flat (+)/re sharp (-)"), _("sol (+)/mi (-)"),
                                                                 _("la flat (+)/fa (-)"), _("la (+)/fa sharp (-)"),
                                                                 _("si flat (+)/sol (-)"), _("si (+)/la sharp (-)")]),
                             current_index=0),
    ...
    def _exec_insert_nuance(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select a &nuance"), value=("nuance", [_("crescendo"), _("pianissimo"), _("piano"),
                                                                           _("mezzo piano"), _("mezzo forte"),
                                                                           _("forte"), _("fortissimo"),
                                                                           _("diminuendo")]), current_index=2),
    ...
    def _exec_insert_note(self):
        ...
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &note"),
                             value=("note", [_("a"), _("b"), _("c"), _("d"), _("e"), _("f"), _("g")]), current_index=2),
                ui.UiListBox(name=_("select &value of note"), value=("duration",
                                                                     [_("whole"), _("half"), _("quarter"), _("eighth"),
                                                                      _("16th"), _("32nd"), _("64th"), _("128th")]),
                             current_index=0),
    ...
    def _exec_insert_silence(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select a &rest type"), value=("type",
                                                                   [_("whole rest"), _("half rest"), _("quarter rest"),
                                                                    _("eighth rest"), _("16th rest"), _("32nd rest"),
                                                                    _("64th rest"), _("128th rest")]), current_index=0),
    ...
    def _exec_insert_bar(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &bar"), value=("type",
                                                           [_("measure"), _("end of composition"), _("end of section"),
    ...
    def _exec_insert_interval(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &interval"), value=(
                    "interval",
                    [_("seconde"), _("third"), _("fourth"), _("fifth"), _("sixth"), _("seventh"), _("octave")]),
                             current_index=0),
    ...
    def _exec_insert_clef(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("select &clef"), value=("clef", [_("treble"), _("alto"), _("basse")]),
                             current_index=0),
                ui.UiCheckBox(name=_("in &part"), value=("type", False)),
                ui.UiListBox(name=_("clef &line"), value=("line", [_("default"), _("first line"), _("second line"),
                                                                   _("third line"), _("fourth line"), _("fifth line")]),
                             current_index=0),
    ...
    def _exec_valid_insert_clef_dialog(self):
        ...
        if kwargs['type'] == False:
            if kwargs['clef'] == _("alto") and kwargs['8'] != _("no") or kwargs['line'] != _("default") and kwargs[
                '8'] != _("no"):
                self._current_dialog = ui.UiMessageDialogBox(
                    name=_("warning"),
                ...
                return False
            self.insert_in_document(self.convert_to_8_dots(
                clef_dic[kwargs['clef']] + line_dic[kwargs['line']]) + clef_begin + self.convert_to_8_dots(
                small_8_dic[kwargs['8']]) + " ")
            self._current_dialog = ui.UiMessageDialogBox(
                name=_("information"),
                message=_(
            ...
            if kwargs['clef'] == _("alto") or kwargs['8'] != _("no"):
                ...
                self.insert_in_document(
                    self.convert_to_8_dots(clef_dic[kwargs['clef']] + line_dic[kwargs['line']]) + clef_in)
    ...
    def _exec_insert_rythmic_groups(self):
        self._current_dialog = ui.UiDialogBox(
            name=_("insert"),
            item_list=[
                ui.UiListBox(name=_("&rythm type"), value=("rythm",
                                                           [_("group of 2 notes"), _("triplet"), _("group of 4 notes"),
                                                            _("group of 5 notes"), _("group of 6 notes"),
                                                            _("group of 7 notes"), _("group of 8 notes"),
                                                            _("group of 9 notes"), _("group of 10 notes")]),
                             current_index=0),
