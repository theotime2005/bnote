...
from apps.music.braille_dots import *
...
import apps.music.music_opy as music
# import apps.music.music as music
...
class MusicApp(EditorBaseApp):
    ...
    def __init__(self, put_in_function_queue, file_name=None, language=None):
        super(MusicApp, self).__init__(put_in_function_queue, file_name, language)
        ...
        return UiMenuBar(
            ...
            menu_item_list=[
                UiMenuBar(
                    name=_("&file"),
                    menu_item_list=[
                        #UiMenuItem(name=_("&shutdown"), action=self._exec_shutdown),
                        ...
                        UiMenuBar(name=_("&export"),
                                  menu_item_list=[
                                      UiMenuItem(name=_("&musicxml"), action=self._exec_export_musicxml,
                                                 shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL,
                                                 shortcut_key='M'),
                                      UiMenuItem(name=_("&bxml"), action=self._exec_export_bxml,
                                                 shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL,
                                                 shortcut_key='B'),
                                      ]),
                ...
                UiMenuBar(
                    ...
                    menu_item_list=[
                        ...
                        UiMenuItem(name=_("&key signature"), action=self._exec_insert_key_signature),
                        UiMenuItem(name=_("&clef"), action=self._exec_insert_clef),
                        self.create_sub_menu_musical_content(),
                        self.create_sub_menu_game_details(),
                        UiMenuItem(name=_("&bar"), action=self._exec_insert_bar),
                        self.create_sub_menu_accord(),
                        self.create_sub_menu_keyboard_signs(),
                        UiMenuItem(name=_("&octave sign"), action=self._exec_insert_octave),
                    ]),
                ...
                UiMenuBar(
                    name=_("au&dio"),
                    menu_item_list=[
                        UiMenuItem(name=_("&play"), action=self._exec_play_score,
                                   shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL, shortcut_key='R'),
                        UiMenuItem(name=_("&stop"), action=self._exec_stop_play_score, is_hide=True,
                                   shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_NONE,
                                   shortcut_key=Keyboard.BrailleFunction.BRAMIGRAPH_ESCAPE),
                        UiMenuItem(name=_("pa&use"), action=self._exec_pause_play_score, is_hide=True,
    ...
    def create_sub_menu_text(self):
        return UiMenuBar(
            name=_("&text"),
            menu_item_list=[
                UiMenuItem(name=_("&title"), action=self._exec_insert_title,
                           shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL+Keyboard.BrailleModifier.BRAILLE_FLAG_ALT, shortcut_key='T'),
                UiMenuItem(name=_("&sub title"), action=self._exec_insert_sub_title,
                           shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL+Keyboard.BrailleModifier.BRAILLE_FLAG_ALT, shortcut_key='S'),
                UiMenuItem(name=_("&composer"), action=self._exec_insert_composer,
                           shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL+Keyboard.BrailleModifier.BRAILLE_FLAG_ALT, shortcut_key='C'),
                UiMenuItem(name=_("&lyricist"), action=self._exec_insert_lyricist,
                           shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL+Keyboard.BrailleModifier.BRAILLE_FLAG_ALT, shortcut_key='Y'),
                UiMenuItem(name=_("&credit words"), action=self._exec_insert_text,
                           shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL+Keyboard.BrailleModifier.BRAILLE_FLAG_ALT, shortcut_key='W'),
                UiMenuItem(name=_("&part"), action=self._exec_insert_part,
                           shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL+Keyboard.BrailleModifier.BRAILLE_FLAG_ALT, shortcut_key='P'),
                UiMenuItem(name=_("&lyrics"), action=self._exec_insert_lyrics,
                           shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL+Keyboard.BrailleModifier.BRAILLE_FLAG_ALT, shortcut_key='L'),
                UiMenuItem(name=_("&karaoke"), action=self._exec_insert_karaoke,
                           shortcut_modifier=Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL+Keyboard.BrailleModifier.BRAILLE_FLAG_ALT, shortcut_key='K'),
                ]
            )
    ...
    def create_sub_menu_keyboard_signs(self):
        return UiMenuBar(
            ...
            menu_item_list=[
                UiMenuItem(name=_("&fingering"), action=self._exec_insert_keyboard_fingering),
                UiMenuItem(name=_("&pedal"), action=self._exec_insert_keyboard_pedal),
                ]
            )
    ...
    def create_sub_menu_game_details(self):
        return UiMenuBar(
            name=_("&game details"),
            menu_item_list=[
                UiMenuItem(name=_("&nuance"), action=self._exec_insert_nuance),
            ]
        )
    ...
    def create_sub_menu_musical_content(self):
        return UiMenuBar(
            ...
            menu_item_list=[
                UiMenuItem(name=_("insert &note"), action=self._exec_insert_note),
                UiMenuItem(name=_("insert &rest"), action=self._exec_insert_silence),
                UiMenuItem(name=_("rythmic &groups"), action=self._exec_insert_rythmic_groups),
                UiMenuItem(name=_("&alteration"), action=self._exec_insert_alteration),
            ]
        )
    ...
    def create_sub_menu_accord(self):
        return UiMenuBar(
            name=_("acco&rd"),
            menu_item_list=[
                UiMenuItem(name=_("&interval"), action=self._exec_insert_interval),
                UiMenuItem(name=_("&measure in-accord"), action=self._exec_insert_measure_in_accord),
            ]
        )

    @staticmethod
    def read_data_file(lou, full_file_name, language, add_line, ended, sheet_name=None):
        return music.MusicReadFile(lou, full_file_name, language, Settings().data, add_line, ended)
    ...
    def read_file_ended(self, error, file_name, sheet_list, score=None):
        ...
        self._score = score
        super(MusicApp, self).read_file_ended(error, file_name, sheet_list)
    ...
    def write_data_file(self, lou, full_file_name, get_line, on_end, function):
        ...
        if extension is None:
            print("write_data_file extension is None !")
        return music.MusicWriteFile(lou, Settings().data, full_file_name, self._score, get_line, on_end, function, extension)
    ...
    def input_function(self, *args, **kwargs) -> bool:
        ...
        done = super(MusicApp, self).input_function(*args, **kwargs)
        return done
    ...
    def input_command(self, data, modifier, key_id) -> bool:
        ...
        """
        done = super(MusicApp, self).input_command(data, modifier, key_id)
        if not done:
    ...
    def input_bramigraph(self, modifier, bramigraph) -> bool:
        ...
        :return: True if command treated, otherwise False
        """
        done = super(MusicApp, self).input_bramigraph(modifier, bramigraph)
        if not done:
            # Specific commands treatment.
            pass
        return done
    ...
    def _exec_play_score(self):
        ...
        self._current_dialog = UiInfoDialogBox(message=_("saving..."))
        ...
        extension = str(Path(self.opened_file_name.suffix)).replace(".", "")
        write_file = music.MusicWriteFile(BnoteApp.lou, Settings().data, MusicApp.MIDI_FILENAME, self._score, self._get_line, self._end_save_midi, FunctionId.FUNCTION_CLOSE_DIALOG_BOX, extension)
        write_file.start()
    ...
    def __export(self, file_name):
        if Path(file_name).exists():
            self._current_dialog = UiInfoDialogBox(
                message=_(f"file {file_name.name} already exists, do you want to overwrite it ?"),
    ...
    def _exec_write_file(self, file_name=None):
        ...
        self._put_in_function_queue(FunctionId.FUNCTION_CHANGE_LOCKED_FILE,
                                    **{'app': self, 'old_file': self._original_file_name, 'new_file': file_name})
    ...
    def insert_in_document(self, content):
        with self.lock:
            self.editor.function(editor.Editor.Functions.PUT_STRING, **{'text': content})
    ...
    def _exec_insert_title(self):
        self._current_dialog = UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("&title"), value=("title", _("score's title"))),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_title_dialog),
    ...
    def _exec_valid_insert_title_dialog(self):
        ...
        for character in text_original:
            if ord(character)==32:
                ...
                text_convert+=character
        self.insert_in_document(self.convert_to_8_dots(b56+2*b23+b2345)+text_convert)
    ...
    def _exec_insert_sub_title(self):
        self._current_dialog = UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("&sub title"), value=("sub title", _("score's sub title"))),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_sub_title_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
            ],
            action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_valid_insert_sub_title_dialog(self):
        ...
        for character in text_original:
            if ord(character)==32:
                ...
                text_convert+=character
        self.insert_in_document(self.convert_to_8_dots(b56+2*b23+b234)+text_convert)
    ...
    def _exec_insert_composer(self):
        self._current_dialog = UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("&composer"), value=("composer", _("score's composer"))),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_composer_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_valid_insert_composer_dialog(self):
        ...
        for character in text_original:
            if ord(character)==32:
                ...
                text_convert+=character
        self.insert_in_document(self.convert_to_8_dots(b56+2*b23+b14) + text_convert)
    ...
    def _exec_insert_lyricist(self):
        self._current_dialog = UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("&lyricist"), value=("lyricist", "score's lyricist")),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_lyricist_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_valid_insert_lyricist_dialog(self):
        ...
        for character in text_original:
            if ord(character)==32:
                ...
                text_convert+=character
        self.insert_in_document(self.convert_to_8_dots(b56+2*b23+b123) + text_convert)
    ...
    def _exec_insert_text(self):
        self._current_dialog = UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("&text"), value=("text", _("text outside of the score"))),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_text_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_valid_insert_text_dialog(self):
        ...
        for character in text_original:
            if ord(character)==32:
                ...
                text_convert+=character
        self.insert_in_document(self.convert_to_8_dots(b56+2*b23+b2456) + text_convert)
    ...
    def _exec_insert_part(self):
        self._current_dialog = UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("part &name"), value=("part", _("new part"))),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_part_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
        ...
        if kwargs['part']==_("piano-right") or kwargs['part']==part_right_hand:
            ...
            for character in text_original:
                if ord(character)==32:
                    ...
                    text_convert+=character
            self.insert_in_document(self.convert_to_8_dots(b56+2*b23+b1234)+text_convert)
    ...
    def _exec_insert_lyrics(self):
        self._current_dialog = UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("&lyrics"), value=("lyrics", "...")),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_lyrics_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_insert_karaoke(self):
        self._current_dialog = UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("&karaoke"), value=("karaoke", "...")),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_karaoke_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog)
           ],
           action_cancelable=self._exec_cancel_dialog,
       )
    ...
    def _exec_valid_insert_karaoke_dialog(self):
        ...
        for character in text_original:
            if ord(character)==32:
                ...
                text_convert+=character
        self.insert_in_document(self.convert_to_8_dots(b56+2*b23+b13) + text_convert)
    ...
    def _exec_insert_keyboard_fingering(self):
        ...
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("choose &finger"), value=("finger", [_("first finger"), _("second finger"), _("third finger"), _("fourth finger"), _("fifth finger")]), current_index=0),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_keyboard_fingering_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_keyboard_pedal(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("&pedal"), value=("pedal", [_("pedal down"), _("pedal up"), _("pedal under note"), _("half-pedal"), _("pedal up as soon as chord is struck")]), current_index=0),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_keyboard_pedal_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_alteration(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select &alteration of note"), value=("alteration", [_("flat"), _("natural"), _("sharp")]), current_index=1),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_alteration_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
    ...
    def _exec_valid_insert_alteration_dialog(self):
        ...
        self.insert_in_document(self.convert_to_8_dots(alteration_dic[kwargs['alteration']]))
    ...
    def _exec_insert_key_signature(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select &tonality"), value=("key", [_("do (+)/la (-)"), _("re flat (+)/la sharp (-)"), _("re (+)/si (-)"), _("mi flat (+)/do (-)"), _("mi (+)/do sharp (-)"), _("fa (+)/re (-)"), _("sol flat (+)/re sharp (-)"), _("sol (+)/mi (-)"), _("la flat (+)/fa (-)"), _("la (+)/fa sharp (-)"), _("si flat (+)/sol (-)"), _("si (+)/sol sharp (-)")]), current_index=0),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_key_signature_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_octave(self):
        ...
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select an &octave"),
                          value=("octave",
                                 [_("a below first octave"),
                                  ...
                                  _("eighth octave")]),
                          current_index=4),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_octave_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_nuance(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select a &nuance"), value=("nuance", [_("crescendo"), _("pianissimo"), _("piano"), _("mezzo piano"), _("mezzo forte"), _("forte"), _("fortissimo"), _("diminuendo")]), current_index=2),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_nuance_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_valid_insert_nuance_dialog(self):
        ...
        if nuance==_("pianissimo"):
            ...
            self._current_dialog = UiMessageDialogBox(
                ...
                buttons=[
                    UiButton(name=_("&yes"), action=self._exec_insert_octave),
            ...
            self._current_dialog = UiMessageDialogBox(
                name=_("warning"),
                message=_("You must put an octave sign before continuing to write, and after the end of the nuance. Do you want to display the octave list?"),
                buttons=[
                    UiButton(name=_("&yes"), action=self._exec_insert_octave),
                    UiButton(name=_("&no"), action=self._exec_cancel_dialog),
                ],
    ...
    def _exec_insert_note(self):
        ...
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select &note"), value=("note", [_("a"), _("b"), _("c"), _("d"), _("e"), _("f"), _("g")]), current_index=2),
                UiListBox(name=_("select &value of note"), value=("duration", [_("whole"), _("half"), _("quarter"), _("eighth"), _("16th"), _("32nd"), _("64th"), _("128th")]), current_index=0),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_note_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_valid_insert_note_dialog(self):
        ...
        self.insert_in_document(self.convert_to_8_dots(value_note_dic[kwargs['duration']]))
    ...
    def _exec_insert_silence(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select a &rest type"), value=("type", [_("whole rest"), _("half rest"), _("quarter rest"), _("eighth rest"), _("16th rest"), _("32nd rest"), _("64th rest"), _("128th rest")]), current_index=0),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_silence_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_insert_bar(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select &bar"), value=("type", [_("measure"), _("end of composition"), _("end of section"), _("simple repetition of fragment"), _("repeat fragment with prima and seconda volta")]), current_index=0),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_bar_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_valid_insert_bar_dialog(self):
        ...
        if bar==_("measure"):
            ...
            self._current_dialog = UiMessageDialogBox(
                ...
                buttons=[
                    UiButton(name=_("&yes"), action=self._exec_save),
                    UiButton(name=_("&no"), action=self._exec_cancel_dialog),
                ],
                action_cancelable=self._exec_cancel_dialog,
            )
            ...
            self.insert_in_document(part_start+"\n"+part_prima+"\n"+part_seconda)
            for character in range(2):
            ...
            self._current_dialog=UiMessageDialogBox(
                name=_("warning"),
                message=_("You need to put an octave sign before continuing to write, and after prima and seconda signs. Do you want to display the octave list?"),
                buttons=[
                    UiButton(name=_("&yes"), action=self._exec_insert_octave),
                    UiButton(name=_("&no"), action=self._exec_cancel_dialog)
                ],
    ...
    def _exec_insert_interval(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select &interval"), value=("interval", [_("seconde"), _("third"), _("fourth"), _("fifth"), _("sixth"), _("seventh"), _("octave")]), current_index=0),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_interval_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_valid_insert_interval_dialog(self):
        ...
        self.insert_in_document(self.convert_to_8_dots(interval_dic[kwargs['interval']]))
    ...
    def _exec_insert_measure_in_accord(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiEditBox(name=_("enter the number of &voice"), value=("number", "2")),
                UiCheckBox(name=_("&full-measure in-accord"), value=("type", True)),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_measure_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_valid_insert_measure_dialog(self):
        ...
        if number<1:
            ...
            if type==True:
                ...
                self._current_dialog = UiMessageDialogBox(
                    name=_("warning"),
                    message=_("The cursor is place before the accord sign. Don't forget to put an octave sign after all measure in-accord signs."),
                    buttons=[
                        UiButton(name=_("&ok"), action=self._exec_cancel_dialog),
                    ],
                    action_cancelable=self._exec_cancel_dialog,
                ...
                self._current_dialog = UiMessageDialogBox(
                    name=_("warning"),
                    message=_("Sorry, but part-measure in-accord is not suported for the moment."),
                    buttons=[
                        UiButton(name=_("&ok"), action=self._exec_cancel_dialog),
                    ],
                    action_cancelable=self._exec_cancel_dialog,
    ...
    def _exec_insert_clef(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("select &clef"), value=("clef", [_("treble"), _("alto"), _("basse")]), current_index=0),
                UiCheckBox(name=_("in &part"), value=("type", False)),
                UiListBox(name=_("clef &line"), value=("line", [_("default"), _("first line"), _("second line"), _("third line"), _("fourth line"), _("fifth line")]), current_index=0),
                UiListBox(name=_("add small &8?"), value=("8", [_("below"), _("no"), _("above")]), current_index=1),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_clef_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
    ...
    def _exec_valid_insert_clef_dialog(self):
        ...
        if kwargs['type']==False:
            if kwargs['clef']==_("alto") and kwargs['8']!=_("no") or kwargs['line']!=_("default") and kwargs['8']!=_("no"):
                self._current_dialog = UiMessageDialogBox(
                    name=_("warning"),
                    message=_("You cant select this options. This settings does not exist."),
                    buttons=[
                        UiButton(name=_("&ok"), action=self._exec_cancel_dialog),
                    ],
                    action_cancelable=self._exec_cancel_dialog,
                ...
                return False
            self.insert_in_document(self.convert_to_8_dots(clef_dic[kwargs['clef']]+line_dic[kwargs['line']])+clef_begin+self.convert_to_8_dots(small_8_dic[kwargs['8']])+" ")
            self._current_dialog=UiMessageDialogBox(
                name=_("information"),
                message=_("You must enter an octave sign to show the height of note. Do you want to display the octave list?"),
                buttons=[
                    UiButton(name=_("&yes"), action=self._exec_insert_octave),
                    UiButton(name=_("&no"), action=self._exec_cancel_dialog),
                ],
            ...
            if kwargs['clef']==_("alto") or kwargs['8']!=_("no"):
                ...
                self.insert_in_document(self.convert_to_8_dots(clef_dic[kwargs['clef']]+line_dic[kwargs['line']])+clef_in)
    ...
    def _exec_insert_rythmic_groups(self):
        self._current_dialog=UiDialogBox(
            name=_("insert"),
            item_list=[
                UiListBox(name=_("&rythm type"), value=("rythm", [_("group of 2 notes"), _("triplet"), _("group of 4 notes"), _("group of 5 notes"), _("group of 6 notes"), _("group of 7 notes"), _("group of 8 notes"), _("group of 9 notes"), _("group of 10 notes")]), current_index=0),
                UiButton(name=_("&insert"), action=self._exec_valid_insert_rythmic_groups_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_dialog),
            ],
            action_cancelable=self._exec_cancel_dialog,
        )
