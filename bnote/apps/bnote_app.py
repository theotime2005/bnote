...
from braille.braille_display import BrailleDisplay
from tools.keyboard import Keyboard

# Setup the logger for this file
from debug.colored_log import ColoredLogger, BNOTE_APP_LOG
...
class FunctionId(Enum):
    ...
    RESTART_AFTER_INSTALLATION_PLEASE = object()
...
class BnoteApp:
    ...
    def input_braille(self, data) -> bool:
        ...
        braille = BnoteApp.keyboard.decode_braille(BnoteApp.lou, data)
