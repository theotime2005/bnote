...
from apps.fman.bt_tools import BtDevices
from debug.colored_log import ColoredLogger, SEND_TO_THREAD_LOG
...
class SendToThread(threading.Thread):
    ...
    def run(self) -> None:
        ...
        while self.__running:
            ...
            channel = BtDevices.find_opush_channel(self.__to_mac_address)
