...
class MathNemethBrailleTable:
    ...
    l1llllll_opy_ = {
        l1ll11l1l_opy_.l1l1l1l11_opy_: (l1ll11l1l_opy_.l111ll11l_opy_, l1111l1ll_opy_.l1l11ll1_opy_),
        l1ll11l1l_opy_.l1l1ll1l1_opy_: (l1ll11l1l_opy_.l1ll1ll_opy_, l1111l1ll_opy_.l1111lll1_opy_),
        l1ll11l1l_opy_.l1lllll11_opy_: (l1ll11l1l_opy_.l1l1l11ll_opy_, l1111l1ll_opy_.l111ll11_opy_),
        l1ll11l1l_opy_.l11l1ll11_opy_: (l1ll11l1l_opy_.l11ll11_opy_, l1111l1ll_opy_.l111l1l11_opy_),
        l1ll11l1l_opy_.l1l1ll1_opy_: (l1ll11l1l_opy_.l111ll1l1_opy_, l1111l1ll_opy_.l1llll1l_opy_),
    }
    l11l111l_opy_ = {
...
class MathNemethParser:
    ...
    def execute(self, text):
        ...
        log.info("indexed_text={} current_text={}".format(l111l111l_opy_, self.l1l11l11l_opy_))
    ...
    def _11lll1_opy_(self, l1l11l11l_opy_):
        ...
        while True:
            ...
            try:
                ...
                l1l11l11l_opy_ = l1l11l11l_opy_[:index] + l1lll11ll_opy_('\u2212', index=l1lll1111_opy_.unary_pos) \
    ...
    def parse(self, text):
        ...
        if l1l1111l_opy_:
            l1l11ll1l_opy_, l1111lll_opy_ = self.l1l11lll1_opy_(text[0: l11l1ll_opy_], text[l11l1ll_opy_ + l1_opy_: len(text)], l1ll1lll1_opy_, text.l1l1111l1_opy_[l11l1ll_opy_])
        ...
        if l11l1ll_opy_ == 0:
            l1llllll1_opy_, l11l1l_opy_, l11l11_opy_, l1ll1l1l1_opy_ = self._1ll1111l_opy_(items,
                                                                                          l1l11l11_opy_)
            if l1llllll1_opy_ == l1_opy_ and l11l1l_opy_ == l1l1lll11_opy_ and l11l11_opy_ == l11lll1l_opy_.l111111ll_opy_:
                try:
                    ...
                    return l11l1l_opy_(text.l1l1111l1_opy_[0], l11l11_opy_,
                                          l1l1111l_opy_(text.l1l1111l1_opy_[0], l1ll1lll1_opy_, self.parse(l11llll_opy_)), self.parse(l1lll1l11_opy_))
        ...
        if pos == 0:
            ...
            if not kwargs:
                ...
                if l11ll111_opy_:
                    ...
                    raise MathException(text.l1l1111l1_opy_[len(l11ll111_opy_)] - 1,
            ...
            if l1111l111_opy_ == l1111l1ll_opy_.l111lllll_opy_:
                ...
                l11l1ll_opy_, l1l1111l_opy_, l1ll1lll1_opy_, l1_opy_ = self._1ll1111l_opy_(items, l1ll1ll1_opy_)
                if l1l1111l_opy_:
                    l1l11ll1l_opy_, l1111lll_opy_ = self.l1l11lll1_opy_(
                        l11ll1111_opy_[0: l11l1ll_opy_], l11ll1111_opy_[l11l1ll_opy_ + l1_opy_: len(l11ll1111_opy_)],
                        l1ll1lll1_opy_, l11ll1111_opy_.l1l1111l1_opy_[l11l1ll_opy_])
                    return l1l1111l_opy_(l11ll1111_opy_.l1l1111l1_opy_[l11l1ll_opy_], l1ll1lll1_opy_, l1l11ll1l_opy_, l1111lll_opy_)
                else:
                    raise MathException(l11ll1111_opy_[0], MathException.ErrorCode.BLOC_ERROR, _("malformed fraction"))
                ...
                if len(l1ll1l_opy_) == 1:
                    ...
                    if l1ll1l_opy_[0].find(l1ll11l1l_opy_.l11111l_opy_) == 0:
                        l1l1l1l1l_opy_ = l1ll1l_opy_[0][len(l1ll11l1l_opy_.l11111l_opy_): len(l1ll1l_opy_[0])]
        ...
        try:
            ...
            if len(value) == 1:
                return l111l1l1_opy_(text.l1l1111l1_opy_[0], self.l111llll1_opy_.to_text_8(value.l1ll1ll11_opy_()))
            elif len(value) > 1:
    ...
    def l1l11lll1_opy_(self, l1lll1l11_opy_, l11llll_opy_, l1ll1lll1_opy_, l111l1_opy_):
        try:
            ...
            if (l1lll1111_opy_.error_code == MathException.ErrorCode.EMPTY_ARG) and (l1ll1lll1_opy_ == l11lll1l_opy_.l1ll111ll_opy_):
                ...
                raise MathException(l111l1_opy_, l1lll1111_opy_.error_code, l1lll1111_opy_.__str__())
                    ...
                    if l1ll1llll_opy_ != -1:
                        ...
                        if l11ll11ll_opy_ != -1:
                            ...
                            self.l111ll1ll_opy_.update(
                                {l1l1llll_opy_.l1ll1ll11_opy_(): (l1ll1l1l_opy_, text[l1l1l1lll_opy_: l11ll11ll_opy_ + l1ll1l1l_opy_])})
    ...
    def _111l11ll_opy_(text):
        ...
        for l1l1ll111_opy_ in text:
            ...
            if c == l1lll1l_opy_.l1llll11l_opy_:
                if l1111111_opy_:
                    l1111ll1_opy_ = l1lll11ll_opy_().join([l1111ll1_opy_, l1lll11ll_opy_(";", i)])
                l1111111_opy_ = True
                continue
            if c == l1lll1l_opy_.l1l1ll1l_opy_:
                ...
                if l1lllll_opy_ and not l1l11l1ll_opy_:
                    l1111ll1_opy_ = l1lll11ll_opy_().join(
                        [l1111ll1_opy_, l1lll11ll_opy_(l1lll1l_opy_.l1ll11l1_opy_, l111l1l_opy_)])
                l1lllll_opy_ = False
                if c == l1lll1l_opy_.l1ll11l1_opy_:
                    ...
                    l1111ll1_opy_ = l1lll11ll_opy_().join([l1111ll1_opy_, l1lll11ll_opy_(MathNemethBrailleTable.l11l111_opy_[c], i)])
                elif l1111111_opy_ or l11lll_opy_:
                    l1111ll1_opy_ = l1lll11ll_opy_().join([l1111ll1_opy_, l1l1ll111_opy_])
                    l1l1ll1ll_opy_ = False
                else:
                    l1111ll1_opy_ = l1lll11ll_opy_().join([l1111ll1_opy_, l1l1ll111_opy_])
