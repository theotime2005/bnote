...
class MathNemethParser:
    ...
    def parse(self, text):
        ...
        if l1l1111l_opy_:
            l1l11ll1l_opy_, l1111lll_opy_ = self.l1l11lll1_opy_(text[0: l11l1ll_opy_],
                                                                text[l11l1ll_opy_ + l1_opy_: len(text)], l1ll1lll1_opy_,
        ...
        if pos == 0:
            ...
            if l1111l111_opy_ == l1111l1ll_opy_.l111lllll_opy_:
                ...
                if l1l1111l_opy_:
                    ...
                    return l1l1111l_opy_(l11ll1111_opy_.l1l1111l1_opy_[l11l1ll_opy_], l1ll1lll1_opy_, l1l11ll1l_opy_,
                                         l1111lll_opy_)
                else:
                ...
                if len(l1ll1l_opy_) == 1:
                    ...
                    return l1lll111l_opy_(l11ll1111_opy_.l1l1111l1_opy_[0] - l1ll1l1l_opy_, l1111l111_opy_,
                                          l11l1l1l_opy_)
        ...
        for l1l1ll111_opy_ in text:
            ...
            if c == l1lll1l_opy_.l1l1ll1l_opy_:
                ...
                if c == l1lll1l_opy_.l1ll11l1_opy_:
                    ...
                    l1111ll1_opy_ = l1lll11ll_opy_().join(
                        [l1111ll1_opy_, l1lll11ll_opy_(MathNemethBrailleTable.l11l111_opy_[c], i)])
