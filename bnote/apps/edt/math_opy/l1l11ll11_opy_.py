...
class l1l11l1_opy_:
    ...
    def __getitem__(self, i):
        ...
        if isinstance(i, slice):
            return l1l11l1_opy_(
                self.text[i.start : i.stop], self.l111lll_opy_[i.start : i.stop]
            )
        elif len(i) == 2:
    ...
    def replace(self, l1llll11l1l_opy_, l1llll11lll_opy_):
        ...
        while pos != -1:
            l1llll1l1l1_opy_ = [
                l1llll11111_opy_[pos] for i in range(0, len(l1llll11lll_opy_))
            ]
            l1llll11111_opy_ = (
                l1llll11111_opy_[0:pos]
                + l1llll1l1l1_opy_
            ...
            l111l1l_opy_ = (
                l111l1l_opy_[0:pos]
                + l1llll11lll_opy_
                + l111l1l_opy_[pos + len(l1llll11l1l_opy_) : len(l111l1l_opy_)]
            )
            pos = l111l1l_opy_.find(l1llll11l1l_opy_)
