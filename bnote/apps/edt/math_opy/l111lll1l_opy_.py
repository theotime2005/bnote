...
class l1lll111l_opy_(l1111_opy_):
    def __init__(self, pos, l111lllll1_opy_=l1111l1ll_opy_.l1l11ll1_opy_, l11l1lll1l_opy_=None):
    ...
    def compute(self):
        ...
        if self.l111lllll1_opy_ == l1111l1ll_opy_.l1llll1l_opy_:
            if isinstance(self.arg, l11l1_opy_):
                return self.l111llll1l_opy_(self.arg.l1ll1l_opy_[0], self.arg.l1ll1l_opy_[1])
            else:
