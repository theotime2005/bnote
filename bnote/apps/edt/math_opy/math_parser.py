...
class MathBrailleTable:
    ...
    l1llllll_opy_ = {
        l111lll11l_opy_.l1l1l1l11_opy_: (
            l111lll11l_opy_.l111ll11l_opy_,
            l1111l1ll_opy_.l1l11ll1_opy_,
        ),
        l111lll11l_opy_.l1l1ll1l1_opy_: (
            l111lll11l_opy_.l1ll1ll_opy_,
            l1111l1ll_opy_.l1111lll1_opy_,
        ),
        l111lll11l_opy_.l1lllll11_opy_: (
            l111lll11l_opy_.l1l1l11ll_opy_,
            l1111l1ll_opy_.l111ll11_opy_,
        ),
        l111lll11l_opy_.l111l1l1ll_opy_: (
            l111lll11l_opy_.l111l1ll1l_opy_,
            l1111l1ll_opy_.l111l1l11_opy_,
        ),
        l111lll11l_opy_.l11l1ll11l_opy_: (
            l111lll11l_opy_.l11l11ll11_opy_,
    ...
    l11l111l_opy_ = {
        ...
        l111lll11l_opy_.l111ll1111_opy_: (
            l1ll11111_opy_,
            l1l11111l_opy_.l11lll1ll_opy_,
        ),
        l111lll11l_opy_.l111l1l1l1_opy_: (l1ll11111_opy_, l1l11111l_opy_.l1lll1l1_opy_),
        l111lll11l_opy_.l111l1l111_opy_: (
            l1ll11111_opy_,
            l1l11111l_opy_.l1ll11ll1_opy_,
        ),
        l111lll11l_opy_.l111llll11_opy_: (
            l1ll11111_opy_,
            l1l11111l_opy_.l11l111ll_opy_,
        ),
        ...
        l111lll11l_opy_.l111l11ll1_opy_: (
            l1ll11111_opy_,
            l1l11111l_opy_.l111l11l1_opy_,
        ),
        l111lll11l_opy_.l111l1llll_opy_: (
            l1ll11111_opy_,
            l1l11111l_opy_.l11l11111_opy_,
        ),
        l111lll11l_opy_.l111ll1lll_opy_: (
            l1ll11111_opy_,
            l1l11111l_opy_.l11lll1l1_opy_,
        ),
    ...
    def parse(self, text):
        ...
        if l1l1111l_opy_:
            try:
                ...
                if (
                    l1lll1111_opy_.error_code == MathException.ErrorCode.EMPTY_ARG
                ) and (l1ll1lll1_opy_ == l11lll1l_opy_.l1ll111ll_opy_):
                    raise MathUnaryException(text.l1l1111l1_opy_[l11l1ll_opy_])
                else:
                    raise MathException(
                        text.l1l1111l1_opy_[l11l1ll_opy_],
                        l1lll1111_opy_.error_code,
        ...
        if l11l1ll_opy_ + l1_opy_ == len(text):
            ...
            if arg:
                return l1l1111l_opy_(text.l1l1111l1_opy_[0], l1ll1lll1_opy_, arg)
        l11l1ll_opy_, l1l1111l_opy_, l1ll1lll1_opy_, l1_opy_ = self._1ll1111l_opy_(
            items, l1111l1l1_opy_
        )
        if l1l1111l_opy_:
            l111l1ll11_opy_ = self.parse(text[l11l1ll_opy_ + l1_opy_ : len(text)])
            return l11l1111l_opy_(
                text.l1l1111l1_opy_[l11l1ll_opy_],
                l11l1llll_opy_.l1lllllll_opy_,
                l111l1ll11_opy_,
            )
        l11l1ll_opy_, l1l1111l_opy_, l1ll1lll1_opy_, l1_opy_ = self._1ll1111l_opy_(
        ...
        if l1l1111l_opy_:
            if (
                (self.l11l1lll_opy_ == MathBrailleTable)
                ...
                l111l11l1l_opy_, l111ll1ll1_opy_, l111ll11l1_opy_, l111lll111_opy_ = (
                    self._1ll1111l_opy_(
                        items, {(l1ll11111_opy_, l1l11111l_opy_.l1llll1l_opy_)}
                    )
                )
                if l111ll1ll1_opy_:
                    l1lll1l11_opy_ = self.parse(
                        text[l11l1ll_opy_ + l1_opy_ : l111l11l1l_opy_]
                    )
                    l11llll_opy_ = self.parse(
                        text[l111l11l1l_opy_ + l111lll111_opy_ : len(text)]
                    )
                    return l1l11l1_opy_(
                        text.l1l1111l1_opy_[l11l1ll_opy_],
                        l1111l1l_opy_.l111l11lll_opy_,
                        [l1lll1l11_opy_, l11llll_opy_],
                    )
                raise MathException(
                    text.l1l1111l1_opy_[l1_opy_],
