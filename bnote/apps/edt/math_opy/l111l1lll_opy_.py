...
from .l11ll_opy_ import ll_opy_, parameters
...
class l11l1111l_opy_(l1llll_opy_):
    def __init__(
        self,
        pos,
        l11ll1111l_opy_=l11111l1l_opy_.l1l11l11_opy_,
        l11l1ll1l1_opy_=None,
        l11l1llll1_opy_=None,
    ):
    ...
    def l11ll11l1l_opy_(self):
        ...
        if not isinstance(self.l11l1lllll_opy_, l1l1l1l1l_opy_):
            raise MathException(
                self.pos,
                MathException.ErrorCode.INVALID_ASSIGNMENT,
    ...
    def l11l1lll11_opy_(self):
        ...
        if l11ll11l11_opy_ == l11ll111ll_opy_:
            ...
            raise MathException(
                ...
                _("weighted arithmetic mean invalid"),
            )
