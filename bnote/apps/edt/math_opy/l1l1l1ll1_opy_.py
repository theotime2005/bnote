...
class l1l11l1_opy_(l1111_opy_):
    ...
    def display_tree(self, level):
        text = ''.join([('    ' * level), self.function.name, l1111_opy_.display_tree(self, level), "\n"])
    ...
    def l11111l11l_opy_(self):
        return l1l11l1_opy_.__1111ll1l1_opy_(l1l11l1_opy_.__1111l11ll_opy_, self.__111l11111_opy_())

    def l1111l1l11_opy_(self):
        return l1l11l1_opy_.__1111ll1l1_opy_(l1l11l1_opy_.__11111l1l1_opy_, self.__111l11111_opy_())

    def l11111ll11_opy_(self):
        return l1l11l1_opy_.__1111ll1l1_opy_(l1l11l1_opy_.__11111lll1_opy_, self.__111l11111_opy_())

    def l11111ll1l_opy_(self):
        return l1l11l1_opy_.__1111ll1l1_opy_(l1l11l1_opy_.__1111ll1ll_opy_, self.__111l11111_opy_())
    ...
    def l11111l111_opy_(values):
        l1111l1l1l_opy_ = l1l11l1_opy_.__1111ll1l1_opy_(l1l11l1_opy_.__11111l1l1_opy_, values)
        l111111ll1_opy_ = l1l11l1_opy_.__1111ll1l1_opy_(l1l11l1_opy_.__1111l11ll_opy_, values)
        try:
    ...
    def l111l1111l_opy_(self):
        values = l1l11l1_opy_.__1111ll1l1_opy_(l1l11l1_opy_.__111l111ll_opy_, self.__111l11111_opy_())
