...
class l1lll11ll_opy_:
    ...
    def __getitem__(self, i):
        ...
        if isinstance(i, slice):
            return l1lll11ll_opy_(
                self.text[i.start : i.stop], self.l1l1111l1_opy_[i.start : i.stop]
            )
        elif len(i) == 2:
            return l1lll11ll_opy_(
                self.text[i[0] : i[1]], self.l1l1111l1_opy_[i[0] : i[1]]
            )
        else:
    ...
    def replace(self, l1llll11lll_opy_, l1llll11111_opy_):
        ...
        while pos != -1:
            l1llll11l11_opy_ = [
                l1llll1l111_opy_[pos] for i in range(0, len(l1llll11111_opy_))
            ]
            l1llll1l111_opy_ = (
                l1llll1l111_opy_[0:pos]
                + l1llll11l11_opy_
            ...
            l1111ll1_opy_ = (
                l1111ll1_opy_[0:pos]
                + l1llll11111_opy_
                + l1111ll1_opy_[pos + len(l1llll11lll_opy_) : len(l1111ll1_opy_)]
            )
            pos = l1111ll1_opy_.find(l1llll11lll_opy_)
