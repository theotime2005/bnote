...
class WriteBrfFile(threading.Thread):
    def __init__(self, get_line, full_file_name, language, braille_type, line_length, page_line, max_page, first_page,
                 braille_table, on_end):
        ...
        if len(self.page_document) > self.max_page:
            ...
            while self.page_document:
                ...
                volume_to_insert = self._cut_document(
                    self.first_page + [volume_title] + self.__get_lines(len(self.first_page + [volume_title])))
