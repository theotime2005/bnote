...
class Editor:
    ...
    def function(self, function, **kwarg):
        ...
        func = switcher.get(function, None)
    ...
    def print_line(self):
        line, first_x, last_x = self.get_line()
    ...
    def _move_down(self, **kwargs):
        ...
        return self._move_next_line(shift)
    ...
    def __delete(self):
        ...
        if not self._caret.is_selection_empty():
            ...
            log.info("add_char_insertion start={}, end={}, char={}".
                     format(self._caret.end, move_caret.end, deleted_char))
    ...
    def _replace_and_find(self, **kwargs):
        ...
        """
        # kwarg decoding
        log.info(f"in _replace_and_find {type(kwargs['replace_parameters'])=} {kwargs['replace_parameters']=}")
        if ('shift' in kwargs) and kwargs['shift']:
