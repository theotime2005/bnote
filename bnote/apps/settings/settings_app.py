...
class SettingsApp(BnoteApp):
    ...
    def __create_action_and_action_param(self):
        ...
        return {
            ...
            ('speech', 'synthesis'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'speech', 'key': 'synthesis'}},
            ('speech', 'voice'): {'action': self.__dialog_set_settings,
                                  'action_param': {'section': 'speech', 'key': 'voice'}},
            ('speech', 'volume'): {'action': self.__dialog_set_volume,
                                   'action_param': {'section': 'speech', 'key': 'volume'},
                                   'shortcut_modifier': Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL,
                                   'shortcut_key': "v"},
            ('speech', 'speed'): {'action': self.__dialog_set_speed,
                                  'action_param': {'section': 'speech', 'key': 'speed'}},
            ('stm32', 'usb_a_hid_keyboard'): {'action': self.__dialog_set_stm32,
                                              'action_param': {'section': 'stm32', 'key': 'usb_a_hid_keyboard'}},
            ('stm32', 'usb_b_hid_keyboard'): {'action': self.__dialog_set_stm32,
                                              'action_param': {'section': 'stm32', 'key': 'usb_b_hid_keyboard'}},
            ('stm32', 'usb_simul_esys'): {'action': self.__dialog_set_stm32,
                                          'action_param': {'section': 'stm32', 'key': 'usb_simul_esys'}},
            ('bluetooth', 'power'): {'action': self.__dialog_set_bluetooth_power,
                                     'action_param': {'section': 'bluetooth', 'key': 'power'}},
            ('bluetooth', 'bnote_name'): {'action': self.__dialog_set_settings,
                                          'action_param': {'section': 'bluetooth', 'key': 'bnote_name'}},
            ('bluetooth', 'bnote_visible'): {'action': self.__dialog_set_settings,
                                             'action_param': {'section': 'bluetooth', 'key': 'bnote_visible'}},
            ('bluetooth', "paired_devices"): {'action': self.__dialog_show_paired_devices,
                                              'action_param': {'section': 'bluetooth', 'key': "paired_devices"}},
            ('bluetooth', 'auto_switch'): {'action': self.__dialog_set_auto_switch,
                                           'action_param': {'section': 'bluetooth', 'key': 'auto_switch'}},
            ('bluetooth', 'speech'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'bluetooth', 'key': 'speech'}},
            ('bluetooth', 'bt_simul_esys'): {'action': self.__dialog_set_settings,
                                             'action_param': {'section': 'bluetooth', 'key': 'bt_simul_esys'}},
            ('wifi', 'power'): {'action': self.__dialog_set_wifi_power,
                                'action_param': {'section': 'wifi', 'key': 'power'}},
            ('wifi', 'connected_to'): {'action': None, 'action_param': {'section': 'wifi', 'key': 'connected_to'}},
            ('wifi', 'favorites'): {'action': self.__dialog_set_wifi_favorites_settings,
                                    'action_param': {'section': 'wifi', 'key': 'favorites'}},
            ('system', 'braille_type'): {'action': self.__dialog_set_settings,
            ...
            ('system', 'developer'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'system', 'key': 'developer'}},
            ('system', 'app_explorer'): {'action': self.__dialog_set_settings,
                                         'action_param': {'section': 'system', 'key': 'app_explorer'}},
            ('system', 'app_settings'): {'action': self.__dialog_set_settings,
                                         'action_param': {'section': 'system', 'key': 'app_settings'}},
            ('system', 'app_agenda'): {'action': self.__dialog_set_settings,
                                       'action_param': {'section': 'system', 'key': 'app_agenda'}},
            ('system', 'app_radio'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'system', 'key': 'app_radio'}},
            ('system', 'app_wikipedia'): {'action': self.__dialog_set_settings,
                                          'action_param': {'section': 'system', 'key': 'app_wikipedia'}},
            ('system', 'app_mp3'): {'action': self.__dialog_set_settings,
                                    'action_param': {'section': 'system', 'key': 'app_mp3'}},
            ('system', 'app_timer'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'system', 'key': 'app_timer'}},
            ('system', 'app_translator'): {'action': self.__dialog_set_settings,
                                           'action_param': {'section': 'system', 'key': 'app_translator'}},
            ('system', 'app_write_word'): {'action': self.__dialog_set_settings,
                                           'action_param': {'section': 'system', 'key': 'app_write_word'}},
            ('system', 'app_operation'): {'action': self.__dialog_set_settings,
                                          'action_param': {'section': 'system', 'key': 'app_operation'}},
            ('system', 'app_mines'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'system', 'key': 'app_mines'}},
            ('system', 'app_mastermind'): {'action': self.__dialog_set_settings,
                                           'action_param': {'section': 'system', 'key': 'app_mastermind'}},
            ('explorer', 'empty_bluetooth_shutdown'): {'action': self.__dialog_set_settings,
                                                       'action_param': {'section': 'explorer',
                                                                        'key': 'empty_bluetooth_shutdown'}},
            ('explorer', 'empty_trash_shutdown'): {'action': self.__dialog_set_settings,
                                                   'action_param': {'section': 'explorer',
                                                                    'key': 'empty_trash_shutdown'}},
            ('explorer', 'number_recent_files'): {'action': self.__dialog_set_settings,
                                                  'action_param': {'section': 'explorer',
                                                                   'key': 'number_recent_files'}},
            ('editor', 'braille_type'): {'action': self.__dialog_set_settings,
                                         'action_param': {'section': 'editor', 'key': 'braille_type'}},
            ('editor', 'line_length'): {'action': self.__dialog_set_settings,
                                        'action_param': {'section': 'editor', 'key': 'line_length'}},
            ('editor', 'forward_display_mode'): {'action': self.__dialog_set_settings,
                                                 'action_param': {'section': 'editor', 'key': 'forward_display_mode'}},
            ('editor', 'autoscroll'): {'action': self.__dialog_set_settings,
                                       'action_param': {'section': 'editor', 'key': 'autoscroll'}},
            ('editor', 'cursor_visible'): {'action': self.__dialog_set_settings,
                                           'action_param': {'section': 'editor', 'key': 'cursor_visible'}},
            ('editor', 'dot78_visible'): {'action': self.__dialog_set_settings,
                                          'action_param': {'section': 'editor', 'key': 'dot78_visible'}},
            ('math', 'format'): {'action': self.__dialog_set_settings,
                                 'action_param': {'section': 'math', 'key': 'format'}},
            ('math', 'precision'): {'action': self.__dialog_set_settings,
                                    'action_param': {'section': 'math', 'key': 'precision'}},
            ('math', 'fraction'): {'action': self.__dialog_set_settings,
                                   'action_param': {'section': 'math', 'key': 'fraction'}},
            ('math', 'angle'): {'action': self.__dialog_set_settings,
                                'action_param': {'section': 'math', 'key': 'angle'}},
            ('music_xml', 'edit_mode'): {'action': self.__dialog_set_settings,
                                         'action_param': {'section': 'music_xml', 'key': 'edit_mode'}},
            ('music_xml', 'braille_type'): {'action': self.__dialog_set_settings,
                                            'action_param': {'section': 'music_xml', 'key': 'braille_type'}},
            ('music_xml', 'notes_dots'): {'action': self.__dialog_set_settings,
                                          'action_param': {'section': 'music_xml', 'key': 'notes_dots'}},
            ('music_xml', 'ascending_chords'): {'action': self.__dialog_set_settings,
                                                'action_param': {'section': 'music_xml', 'key': 'ascending_chords'}},
            ('music_xml', 'fingering'): {'action': self.__dialog_set_settings,
                                         'action_param': {'section': 'music_xml', 'key': 'fingering'}},
            ('music_xml', 'clef'): {'action': self.__dialog_set_settings,
                                    'action_param': {'section': 'music_xml', 'key': 'clef'}},
            ('music_xml', 'parts'): {'action': self.__dialog_set_settings,
                                     'action_param': {'section': 'music_xml', 'key': 'parts'}},
            ('music_xml', 'measure_b123'): {'action': self.__dialog_set_settings,
                                            'action_param': {'section': 'music_xml', 'key': 'measure_b123'}},
            ('music_xml', 'measure_number'): {'action': self.__dialog_set_settings,
                                              'action_param': {'section': 'music_xml', 'key': 'measure_number'}},
            ('music_xml', 'measure_every'): {'action': self.__dialog_set_settings,
                                             'action_param': {'section': 'music_xml', 'key': 'measure_every'}},
            ('music_xml', 'view'): {'action': self.__dialog_set_settings,
                                    'action_param': {'section': 'music_xml', 'key': 'view'}},
            ('music_xml', 'section'): {'action': self.__dialog_set_settings,
                                       'action_param': {'section': 'music_xml', 'key': 'section'}},
            ('music_xml', 'measures_per_section'): {'action': self.__dialog_set_settings,
                                                    'action_param': {'section': 'music_xml',
                                                                     'key': 'measures_per_section'}},
            ('music_xml', 'words'): {'action': self.__dialog_set_settings,
                                     'action_param': {'section': 'music_xml', 'key': 'words'}},
            ('music_xml', 'credit_words'): {'action': self.__dialog_set_settings,
                                            'action_param': {'section': 'music_xml', 'key': 'credit_words'}},
            ('music_xml', 'lyrics'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'music_xml', 'key': 'lyrics'}},
            ('music_bxml', 'edit_mode'): {'action': self.__dialog_set_settings,
                                          'action_param': {'section': 'music_bxml', 'key': 'edit_mode'}},
            ('music_bxml', 'braille_type'): {'action': self.__dialog_set_settings,
                                             'action_param': {'section': 'music_bxml', 'key': 'braille_type'}},
            ('music_bxml', 'notes_dots'): {'action': self.__dialog_set_settings,
                                           'action_param': {'section': 'music_bxml', 'key': 'notes_dots'}},
            ('music_bxml', 'ascending_chords'): {'action': self.__dialog_set_settings,
                                                 'action_param': {'section': 'music_bxml', 'key': 'ascending_chords'}},
            ('music_bxml', 'fingering'): {'action': self.__dialog_set_settings,
                                          'action_param': {'section': 'music_bxml', 'key': 'fingering'}},
            ('music_bxml', 'clef'): {'action': self.__dialog_set_settings,
                                     'action_param': {'section': 'music_bxml', 'key': 'clef'}},
            ('music_bxml', 'parts'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'music_bxml', 'key': 'parts'}},
            ('music_bxml', 'measure_b123'): {'action': self.__dialog_set_settings,
                                             'action_param': {'section': 'music_bxml', 'key': 'measure_b123'}},
            ('music_bxml', 'measure_number'): {'action': self.__dialog_set_settings,
                                               'action_param': {'section': 'music_bxml', 'key': 'measure_number'}},
            ('music_bxml', 'measure_every'): {'action': self.__dialog_set_settings,
                                              'action_param': {'section': 'music_bxml', 'key': 'measure_every'}},
            ('music_bxml', 'view'): {'action': self.__dialog_set_settings,
                                     'action_param': {'section': 'music_bxml', 'key': 'view'}},
            ('music_bxml', 'section'): {'action': self.__dialog_set_settings,
                                        'action_param': {'section': 'music_bxml', 'key': 'section'}},
            ('music_bxml', 'measures_per_section'): {'action': self.__dialog_set_settings,
                                                     'action_param': {'section': 'music_bxml',
                                                                      'key': 'measures_per_section'}},
            ('music_bxml', 'words'): {'action': self.__dialog_set_settings,
                                      'action_param': {'section': 'music_bxml', 'key': 'words'}},
            ('music_bxml', 'credit_words'): {'action': self.__dialog_set_settings,
                                             'action_param': {'section': 'music_bxml', 'key': 'credit_words'}},
            ('music_bxml', 'lyrics'): {'action': self.__dialog_set_settings,
                                       'action_param': {'section': 'music_bxml', 'key': 'lyrics'}},
            ('music_bxml', 'karaoke'): {'action': self.__dialog_set_settings,
                                        'action_param': {'section': 'music_bxml', 'key': 'karaoke'}},
            ('agenda', 'default_presentation'): {'action': self.__dialog_set_settings,
                                                 'action_param': {'section': 'agenda', 'key': 'default_presentation'}},
            ('agenda', 'remember'): {'action': self.__dialog_set_settings,
                                     'action_param': {'section': 'agenda', 'key': 'remember'}},
            ('braille_learning', 'use_vocal'): {'action': self.__dialog_set_settings,
                                                'action_param': {'section': 'braille_learning', 'key': 'use_vocal'}},
            ('braille_learning', 'keep_spaces'): {'action': self.__dialog_set_settings,
                                                  'action_param': {'section': 'braille_learning',
                                                                   'key': 'keep_spaces'}},
            ('braille_learning', 'write_all'): {'action': self.__dialog_set_settings,
                                                'action_param': {'section': 'braille_learning', 'key': 'write_all'}},
            ('stm32', 'language_message'): {'action': self.__dialog_set_stm32,
                                            'action_param': {'section': 'stm32', 'key': 'language_message'}},
            ('stm32', 'language_keyboard'): {'action': self.__dialog_set_stm32,
                                             'action_param': {'section': 'stm32', 'key': 'language_keyboard'}},
            ('speech', 'language'): {'action': self.__dialog_set_settings,
                                     'action_param': {'section': 'speech', 'key': 'language'}},
            ('wlan', 'country'): {'action': self.__dialog_set_wlan_country,
                                  'action_param': {'section': 'wlan', 'key': 'country'}},
            ('stm32', 'keyboard_mode'): {'action': self.__dialog_set_stm32,
                                         'action_param': {'section': 'stm32', 'key': 'keyboard_mode'}},
            ('stm32', 'keyboard_b78'): {'action': self.__dialog_set_stm32,
                                        'action_param': {'section': 'stm32', 'key': 'keyboard_b78'}},
            ('stm32', 'keyboard_invertion'): {'action': self.__dialog_set_stm32,
                                              'action_param': {'section': 'stm32', 'key': 'keyboard_invertion'}},
            ('stm32', 'keyboard_light_press'): {'action': self.__dialog_set_stm32,
                                                'action_param': {'section': 'stm32', 'key': 'keyboard_light_press'}},
            ('stm32', 'keyboard_strong_press'): {'action': self.__dialog_set_stm32,
                                                 'action_param': {'section': 'stm32', 'key': 'keyboard_strong_press'}},
            ('stm32', 'keyboard_consecutive_press'): {'action': self.__dialog_set_stm32,
                                                      'action_param': {'section': 'stm32',
                                                                       'key': 'keyboard_consecutive_press'}},
            ('stm32', 'keyboard_double_light_press'): {'action': self.__dialog_set_stm32,
                                                       'action_param': {'section': 'stm32',
                                                                        'key': 'keyboard_double_light_press'}},
            ('stm32', 'keyboard_double_strong_press'): {'action': self.__dialog_set_stm32,
                                                        'action_param': {'section': 'stm32',
                                                                         'key': 'keyboard_double_strong_press'}},
            ('stm32', 'standby_transport'): {'action': self.__dialog_set_stm32,
            ...
            ('update', 'auto_check'): {'action': self.__dialog_set_settings,
    ...
    def __create_settings_app_music_xml_menu(self):
        return ui.UiMenuBar(name=_("&musicxml"),
                            menu_item_list=[
                                ...
                                ui.UiMenuItem(name=_("&section"),
                                              **self.__action_and_action_param[('music_xml', 'section')]),
                                ui.UiMenuItem(name=_("measures per sec&tion"),
                                              **self.__action_and_action_param[('music_xml', 'measures_per_section')]),
                                ui.UiMenuItem(name=_("&words"),
                                              **self.__action_and_action_param[('music_xml', 'words')]),
                                ui.UiMenuItem(name=_("cre&dit words"),
                                              **self.__action_and_action_param[('music_xml', 'credit_words')]),
                                ui.UiMenuItem(name=_("&lyrics"),
    ...
    def __create_settings_app_music_bxml_menu(self):
        return ui.UiMenuBar(name=_("&bxml"),
                            menu_item_list=[
                                ...
                                ui.UiMenuItem(name=_("&ascending chords"),
                                              **self.__action_and_action_param[('music_bxml', 'ascending_chords')]),
                                ui.UiMenuItem(name=_("&fingering"),
                                              **self.__action_and_action_param[('music_bxml', 'fingering')]),
                                ui.UiMenuItem(name=_("&clef"),
        ...
        return ui.UiMenuBar(
            ...
            menu_item_list=[
                ...
                ui.UiMenuBar(
                    name=_("&usb"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("usb-&a-hid keyboard"),
                                      **self.__action_and_action_param[('stm32', 'usb_a_hid_keyboard')]),
                        ui.UiMenuItem(name=_("usb-&b-hid keyboard"),
                                      **self.__action_and_action_param[('stm32', 'usb_b_hid_keyboard')]),
                        ui.UiMenuItem(name=_("simulation &esys"),
                                      **self.__action_and_action_param[('stm32', 'usb_simul_esys')]),
                    ]),
                ui.UiMenuBar(
                    name=_("&bluetooth"),
                    menu_item_list=[
                        ...
                        ui.UiMenuItem(name=_("&visibility"),
                                      **self.__action_and_action_param[('bluetooth', 'bnote_visible')]),
                        ui.UiMenuItem(name=_("&paired devices"),
                                      **self.__action_and_action_param[('bluetooth', 'paired_devices')]),
                        ui.UiMenuItem(name=_("simulation &esys"),
                                      **self.__action_and_action_param[('bluetooth', 'bt_simul_esys')]),
                    ]),
                ui.UiMenuBar(
                    name=_("&wifi"),
                    menu_item_list=[
                ...
                ui.UiMenuBar(
                    ...
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&message language"),
                                      **self.__action_and_action_param[('stm32', 'language_message')]),
                        ui.UiMenuItem(name=_("&braille language"),
                                      **self.__action_and_action_param[('stm32', 'language_keyboard')]),
                        ui.UiMenuItem(name=_("braille &type"),
                                      **self.__action_and_action_param[('system', 'braille_type')]),
                        ui.UiMenuItem(name=_("spaces in &label"),
                                      **self.__action_and_action_param[('system', 'spaces_in_label')]),
                        ui.UiMenuItem(name=_("visible &shortcuts"),
                                      **self.__action_and_action_param[('system', 'shortcuts_visible')]),
                        ui.UiMenuItem(name=_("&developer mode"),
                ...
                ui.UiMenuBar(
                    name=_("main me&nu"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&explorer"),
                                      **self.__action_and_action_param[('system', 'app_explorer')]),
                        ui.UiMenuItem(name=_("&settings"),
                                      **self.__action_and_action_param[('system', 'app_settings')]),
                        ...
                        ui.UiMenuItem(name=_("wi&kipedia"),
                                      **self.__action_and_action_param[('system', 'app_wikipedia')]),
                        ui.UiMenuItem(name=_("&timer"), **self.__action_and_action_param[('system', 'app_timer')]),
                        ui.UiMenuItem(name=_("trans&lator"),
                                      **self.__action_and_action_param[('system', 'app_translator')]),
                        ui.UiMenuItem(name=_("write &word"),
                                      **self.__action_and_action_param[('system', 'app_write_word')]),
                        ui.UiMenuItem(name=_("&operation"),
                                      **self.__action_and_action_param[('system', 'app_operation')]),
                ...
                ui.UiMenuBar(
                    name=_("e&xplorer"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("empty the &bluetooth folder once shutdown"),
                                      **self.__action_and_action_param[('explorer', 'empty_bluetooth_shutdown')]),
                        ui.UiMenuItem(name=_("empty the &trash folder once shutdown"),
                                      **self.__action_and_action_param[('explorer', 'empty_trash_shutdown')]),
                        ui.UiMenuItem(name=_("&number of recent files"),
                                      **self.__action_and_action_param[('explorer', 'number_recent_files')]),
                    ]),
                ...
                ui.UiMenuBar(
                    ...
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&braille type"),
                                      **self.__action_and_action_param[('editor', 'braille_type')]),
                        ui.UiMenuItem(name=_("&line length"),
                                      **self.__action_and_action_param[('editor', 'line_length')]),
                        ui.UiMenuItem(name=_("&forward display"),
                                      **self.__action_and_action_param[('editor', 'forward_display_mode')]),
                        ui.UiMenuItem(name=_("&autoscroll display"),
                                      **self.__action_and_action_param[('editor', 'autoscroll')]),
                        ui.UiMenuItem(name=_("&cursor visible"),
                                      **self.__action_and_action_param[('editor', 'cursor_visible')]),
                        ui.UiMenuItem(name=_("&dot78 visible"),
                                      **self.__action_and_action_param[('editor', 'dot78_visible')]),
                    ]),
                ...
                ui.UiMenuBar(
                    name=_("a&genda"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("default &presentation"),
                                      **self.__action_and_action_param[('agenda', 'default_presentation')]),
                        ui.UiMenuItem(name=_("&report events not done"),
                ...
                ui.UiMenuBar(
                    ...
                    menu_item_list=[
                        ui.UiMenuItem(name=_("use the &vocalize"),
                                      **self.__action_and_action_param[('braille_learning', 'use_vocal')]),
                        ui.UiMenuItem(name=_("&keep the spaces"),
                                      **self.__action_and_action_param[('braille_learning', 'keep_spaces')]),
                        ui.UiMenuItem(name=_("&allow all characters"),
                                      **self.__action_and_action_param[('braille_learning', 'write_all')])
                    ]
                ),
                ...
                ui.UiMenuBar(
                    ...
                    menu_item_list=[
                        ...
                        ui.UiMenuItem(name=_("&invertion"),
                                      **self.__action_and_action_param[('stm32', 'keyboard_invertion')]),
                        ui.UiMenuItem(name=_("&light press"),
                                      **self.__action_and_action_param[('stm32', 'keyboard_light_press')]),
                        ui.UiMenuItem(name=_("&strong press"),
                                      **self.__action_and_action_param[('stm32', 'keyboard_strong_press')]),
                        ui.UiMenuItem(name=_("&consecutive press"),
                                      **self.__action_and_action_param[('stm32', 'keyboard_consecutive_press')]),
                        ui.UiMenuItem(name=_("&double light press"),
                                      **self.__action_and_action_param[('stm32', 'keyboard_double_light_press')]),
                        ui.UiMenuItem(name=_("double st&rong press"),
                                      **self.__action_and_action_param[('stm32', 'keyboard_double_strong_press')]),
                    ]),

                ui.UiMenuBar(
                    name=_("&standby"),
                    menu_item_list=[
                        ui.UiMenuItem(name=_("&transport"),
                                      **self.__action_and_action_param[('stm32', 'standby_transport')]),
                        ui.UiMenuItem(name=_("&shutdown"),
                                      **self.__action_and_action_param[('stm32', 'standby_shutdown')]),
                    ]),
                ...
                ui.UiMenuBar(
                    ...
                    menu_item_list=[
                        ...
                        ui.UiMenuItem(name=_("&auto check"),
    ...
    def __update_document_line(self, index):
        ...
        if line['auto_refresh_on_timer'] == 'time':
            ...
            line['data_line_text'] = self.format_label_value(_("keyboard USB-A-HID"),
                                                             self.__get_stm32_value('stm32', 'usb_a_hid_keyboard'))
        elif line['auto_refresh_on_timer'] == 'usb_b_hid_keyboard':
            line['data_line_text'] = self.format_label_value(_("keyboard USB-B-HID"),
            ...
            line['data_line_text'] = self.format_label_value(_("message language"),
                                                             self.__get_message_language_country_value())
        elif line['auto_refresh_on_timer'] == 'language_keyboard':
            line['data_line_text'] = self.format_label_value(_("braille language"),
                                                             self.__get_keyboard_language_country_value())
        elif line['auto_refresh_on_timer'] == 'standby_transport':
            line['data_line_text'] = self.format_label_value(_("transport timeout minute (0 none)"),
                                                             self.__get_stm32_value('stm32', 'standby_transport'))
        elif line['auto_refresh_on_timer'] == 'standby_shutdown':
            line['data_line_text'] = self.format_label_value(_("shutdown timeout minute (0 none)"),
    ...
    def __update_document(self, update_computers_and_paired_device=False):
        ...
        self.__append_line_in_document(param_label=_("time"), param_value=self.__get_time_value(),
                                       dialog_box_name=_("time"), dialog_box_param_name=_("time"), section='stm32',
                                       key='time', auto_refresh_on_timer='time', is_tab_stop=True)
        self.__append_line_in_document(param_label=_("date"), param_value=self.__get_date_value(),
                                       dialog_box_name=_("date"), dialog_box_param_name=_("date"), section='stm32',
                                       key='date', auto_refresh_on_timer='date', )
        self.__append_line_in_document(param_label=_("auto sync date"),
        ...
        self.__append_line_in_document(param_label=_("battery"), param_value=self.__get_battery_value(),
                                       auto_refresh_on_timer='battery', is_tab_stop=True)

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("synthesis"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("volume"), param_value=self.__get_volume_value(),
                                       dialog_box_name=_("volume"), dialog_box_param_name=_("&value"), section='speech',
                                       key='volume', auto_refresh_on_timer='volume')
        self.__append_line_in_document(param_label=_("speed"), param_value=self.__get_settings_value('speech', 'speed'),
                                       dialog_box_name=_("speed"), dialog_box_param_name=_("&value"), section='speech',
                                       key='speed')
        self.__append_line_in_document(param_label=_("language"), param_value=self.__get_speech_language_value(),
                                       dialog_box_name=_("language"), dialog_box_param_name=_("language"),
                                       section='speech', key='language', auto_refresh_on_timer='speech_language')
        self.__append_line_in_document(param_label=_("synthesis"),
                                       param_value=self.__get_settings_value('speech', 'synthesis'),
                                       dialog_box_name=_("synthesis"), dialog_box_param_name=_("&synthesis"),
                                       section='speech', key='synthesis')
        self.__append_line_in_document(param_label=_("voice"), param_value=self.__get_settings_value('speech', 'voice'),
                                       dialog_box_name=_("voice"), dialog_box_param_name=_("&voice"), section='speech',
                                       key='voice')
        if Gpio().gpio_hardware_v2():
            # Show only for bnote v2.
            self.__append_line_in_document(param_label=_("jack"), param_value=self.__get_jack_value(),
                                           auto_refresh_on_timer='jack')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("usb"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("keyboard USB-A-HID"),
                                       param_value=self.__get_stm32_value('stm32', 'usb_a_hid_keyboard'),
                                       dialog_box_name=_("keyboard"), dialog_box_param_name=_("usb-a hid mode"),
                                       section='stm32', key='usb_a_hid_keyboard',
                                       auto_refresh_on_timer='usb_a_hid_keyboard')
        self.__append_line_in_document(param_label=_("keyboard USB-B-HID"),
                                       param_value=self.__get_stm32_value('stm32', 'usb_b_hid_keyboard'),
                                       dialog_box_name=_("keyboard"), dialog_box_param_name=_("usb-b hid mode"),
                                       section='stm32', key='usb_b_hid_keyboard',
                                       auto_refresh_on_timer='usb_b_hid_keyboard')
        self.__append_line_in_document(param_label=_("simulation esys"),
                                       param_value=self.__get_stm32_value('stm32', 'usb_simul_esys'),
                                       dialog_box_name=_("simulation esys"), dialog_box_param_name=_("simulation esys"),
                                       section='stm32', key='usb_simul_esys')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("bluetooth"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("power"), param_value=self.__get_bluetooth_power(),
                                       dialog_box_name=_("bluetooth power"), dialog_box_param_name=_("&powered"),
                                       section='bluetooth', key='power')
        self.__append_line_in_document(param_label=_("name"), param_value=self.__get_bluetooth_name_value(),
                                       dialog_box_name=_('bluetooth'), dialog_box_param_name=_("&bnote name"),
                                       section='bluetooth', key='bnote_name')
        self.__append_line_in_document(param_label=_("visible"), param_value=self.__get_bluetooth_visible_value(),
                                       dialog_box_name=_('bluetooth'), dialog_box_param_name=_("&bnote visible"),
                                       section='bluetooth', key='bnote_visible')
        self.__append_line_in_document(param_label=_("paired devices"),
                                       param_value=self.__get_bluetooth_pairing_value(), dialog_box_name=_('bluetooth'),
                                       dialog_box_param_name=_("&paired devices"), section='bluetooth',
                                       key="paired_devices", auto_refresh_on_timer='paired_devices')
        ...
        for key, value in self.__paired_devices.items():
            ...
            self.__append_line_in_document(param_label=value, param_value=auto_switch_value,
                                           dialog_box_name=_("bluetooth auto switch"), dialog_box_param_name=value,
                                           section='bluetooth', key='auto_switch')
        ...
        self.__append_line_in_document(param_label=_("simulation esys"),
                                       ...
                                       dialog_box_param_name=_("simulation &esys"), section='bluetooth',
                                       key='bt_simul_esys')
        self.__append_line_in_document()
        # ip address
        self.__append_line_in_document(param_label=_("wifi"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("power"), param_value=self.__get_wifi_power(),
                                       dialog_box_name=_("wifi power"), dialog_box_param_name=_("&powered"),
                                       section='wifi', key='power')
        self.__append_line_in_document(param_label=_("connected to"), param_value=self.__get_wifi_connected_to(),
                                       dialog_box_name=_("connected to"), dialog_box_param_name=_("&connected"),
                                       section='wifi', key='connected_to', auto_refresh_on_timer='connected_to')
        self.__append_line_in_document(param_label=_("favorites"), param_value=self.__get_wifi_favorites_str(),
                                       dialog_box_name=_("favorites"), dialog_box_param_name=_("&favorites"),
                                       section='wifi', key='favorites')
        self.__append_line_in_document(param_label=_("country"), param_value=self.__get_wlan_country_value(),
                                       dialog_box_name=_("wlan country"), dialog_box_param_name=_("wlan country"),
                                       section='wlan', key='country')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("user interface"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("message language"),
                                       param_value=self.__get_message_language_country_value(),
                                       dialog_box_name=_("language"), dialog_box_param_name=_("message"),
                                       section='stm32', key='language_message',
                                       auto_refresh_on_timer='language_message')
        self.__append_line_in_document(param_label=_("braille language"),
                                       param_value=self.__get_keyboard_language_country_value(),
                                       dialog_box_name=_("language"), dialog_box_param_name=_("braille"),
                                       section='stm32', key='language_keyboard',
                                       auto_refresh_on_timer='language_keyboard')
        self.__append_line_in_document(param_label=_("braille type"),
                                       param_value=self.__get_settings_value('system', 'braille_type'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&braille type"),
                                       section='system', key='braille_type')
        self.__append_line_in_document(param_label=_("spaces in label"),
                                       param_value=self.__get_settings_value('system', 'spaces_in_label'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("spaces in &label"),
                                       section='system', key='spaces_in_label')
        self.__append_line_in_document(param_label=_("visible shortcuts"),
                                       param_value=self.__get_settings_value('system', 'shortcuts_visible'),
                                       dialog_box_name=_("user interface"),
                                       dialog_box_param_name=_("visible &shortcuts"), section='system',
                                       key='shortcuts_visible')
        self.__append_line_in_document(param_label=_("developer mode"),
                                       param_value=self.__get_settings_value('system', 'developer'),
                                       dialog_box_name=_("user interface"), dialog_box_param_name=_("&developer mode"),
                                       section='system', key='developer')
        ...
        self.__append_line_in_document(param_label=_("empty the bluetooth folder once shutdown"),
                                       param_value=self.__get_settings_value('explorer', 'empty_bluetooth_shutdown'),
                                       dialog_box_name=_('explorer'),
                                       dialog_box_param_name=_("&empty the bluetooth once shutdown"),
                                       section='explorer', key='empty_bluetooth_shutdown')
        self.__append_line_in_document(param_label=_("empty the trash folder once shutdown"),
                                       param_value=self.__get_settings_value('explorer', 'empty_trash_shutdown'),
                                       dialog_box_name=_('explorer'),
                                       dialog_box_param_name=_("&empty the trash once shutdown"), section='explorer',
                                       key='empty_trash_shutdown')
        self.__append_line_in_document(param_label=_("number of recent files"),
                                       param_value=self.__get_settings_value('explorer', 'number_recent_files'),
                                       dialog_box_name=_('explorer'), dialog_box_param_name=_("files &number"),
                                       section='explorer', key='number_recent_files')
        ...
        self.__append_line_in_document(param_label=_("braille type"),
                                       ...
                                       dialog_box_name=_('editor'), dialog_box_param_name=_("&braille type"),
                                       section='editor', key='braille_type')
        self.__append_line_in_document(param_label=_("line length"),
                                       param_value=self.__get_settings_value('editor', 'line_length'),
                                       dialog_box_name=_('editor'), dialog_box_param_name=_("lines &length"),
                                       section='editor', key='line_length')
        self.__append_line_in_document(param_label=_("forward display"),
                                       param_value=self.__get_settings_value('editor', 'forward_display_mode'),
                                       dialog_box_name=_('editor'), dialog_box_param_name=_("&forward display"),
                                       section='editor', key='forward_display_mode')
        self.__append_line_in_document(param_label=_("autoscroll display"),
                                       param_value="{}s".format(self.__get_settings_value('editor', 'autoscroll')),
                                       dialog_box_name=_('editor'), dialog_box_param_name=_("&autoscroll display"),
                                       section='editor', key='autoscroll')
        self.__append_line_in_document(param_label=_("cursor visible"),
                                       param_value=self.__get_settings_value('editor', 'cursor_visible'),
                                       dialog_box_name=_('editor'), dialog_box_param_name=_("&cursor visible"),
                                       section='editor', key='cursor_visible')
        self.__append_line_in_document(param_label=_("dot78 visible"),
                                       param_value=self.__get_settings_value('editor', 'dot78_visible'),
                                       dialog_box_name=_('editor'), dialog_box_param_name=_("&dot 78 visible"),
                                       section='editor', key='dot78_visible')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("math"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("format"), param_value=self.__get_settings_value('math', 'format'),
                                       dialog_box_name=_("math"), dialog_box_param_name=_("&format"), section='math',
                                       key='format')
        self.__append_line_in_document(param_label=_("precision"),
                                       param_value=self.__get_settings_value('math', 'precision'),
                                       dialog_box_name=_("math"), dialog_box_param_name=_("&precision"), section='math',
                                       key='precision')
        self.__append_line_in_document(param_label=_("fraction"),
                                       param_value=self.__get_settings_value('math', 'fraction'),
                                       dialog_box_name=_("math"), dialog_box_param_name=_("&fraction result"),
                                       section='math', key='fraction')
        self.__append_line_in_document(param_label=_("angle"), param_value=self.__get_settings_value('math', 'angle'),
                                       dialog_box_name=_("math"), dialog_box_param_name=_("&angle"), section='math',
                                       key='angle')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("music"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("musicxml edit and play mode"),
                                       param_value=self.__get_settings_value('music_xml', 'edit_mode'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&edit and play mode"),
                                       section='music_xml', key='edit_mode')
        self.__append_line_in_document(param_label=_("musicxml braille type"),
                                       param_value=self.__get_settings_value('music_xml', 'braille_type'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("braille &type"),
                                       section='music_xml', key='braille_type')
        self.__append_line_in_document(param_label=_("musicxml notes dots"),
                                       param_value=self.__get_settings_value('music_xml', 'notes_dots'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&notes dots"),
                                       section='music_xml', key='notes_dots')
        self.__append_line_in_document(param_label=_("musicxml ascending chords"),
                                       param_value=self.__get_settings_value('music_xml', 'ascending_chords'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&ascending chords"),
                                       section='music_xml', key='ascending_chords')
        self.__append_line_in_document(param_label=_("musicxml fingering"),
                                       param_value=self.__get_settings_value('music_xml', 'fingering'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&fingering"),
                                       section='music_xml', key='fingering')
        self.__append_line_in_document(param_label=_("musicxml clef"),
                                       param_value=self.__get_settings_value('music_xml', 'clef'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&clef"),
                                       section='music_xml', key='clef')
        self.__append_line_in_document(param_label=_("musicxml parts"),
                                       param_value=self.__get_settings_value('music_xml', 'parts'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&parts"),
                                       section='music_xml', key='parts')
        self.__append_line_in_document(param_label=_("musicxml measure b123"),
                                       param_value=self.__get_settings_value('music_xml', 'measure_b123'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&measure b123"),
                                       section='music_xml', key='measure_b123')
        self.__append_line_in_document(param_label=_("musicxml measure number"),
                                       param_value=self.__get_settings_value('music_xml', 'measure_number'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&measure number"),
                                       section='music_xml', key='measure_number')
        self.__append_line_in_document(param_label=_("musicxml measure every"),
                                       param_value=self.__get_settings_value('music_xml', 'measure_every'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&measure every"),
                                       section='music_xml', key='measure_every')
        self.__append_line_in_document(param_label=_("musicxml view"),
                                       param_value=self.__get_settings_value('music_xml', 'view'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&view"),
                                       section='music_xml', key='view')
        self.__append_line_in_document(param_label=_("musicxml section"),
                                       param_value=self.__get_settings_value('music_xml', 'section'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&section"),
                                       section='music_xml', key='section')
        self.__append_line_in_document(param_label=_("musicxml measures per section"),
                                       param_value=self.__get_settings_value('music_xml', 'measures_per_section'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&measures per section"),
                                       section='music_xml', key='measures_per_section')
        self.__append_line_in_document(param_label=_("musicxml words"),
                                       param_value=self.__get_settings_value('music_xml', 'words'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&words"),
                                       section='music_xml', key='words')
        self.__append_line_in_document(param_label=_("musicxml credit words"),
                                       param_value=self.__get_settings_value('music_xml', 'credit_words'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&credit words"),
                                       section='music_xml', key='credit_words')
        self.__append_line_in_document(param_label=_("musicxml lyrics"),
                                       param_value=self.__get_settings_value('music_xml', 'lyrics'),
                                       dialog_box_name=_("music xml"), dialog_box_param_name=_("&lyrics"),
                                       section='music_xml', key='lyrics')
        self.__append_line_in_document(param_label=_("bxml edit and play mode"),
                                       param_value=self.__get_settings_value('music_bxml', 'edit_mode'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&edit and play mode"),
                                       section='music_bxml', key='edit_mode')
        self.__append_line_in_document(param_label=_("bxml braille type"),
                                       param_value=self.__get_settings_value('music_bxml', 'braille_type'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("braille &type"),
                                       section='music_bxml', key='braille_type')
        self.__append_line_in_document(param_label=_("bxml notes dots"),
                                       param_value=self.__get_settings_value('music_bxml', 'notes_dots'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&notes dots"),
                                       section='music_bxml', key='notes_dots')
        self.__append_line_in_document(param_label=_("bxml ascending chords"),
                                       param_value=self.__get_settings_value('music_bxml', 'ascending_chords'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&ascending chords"),
                                       section='music_bxml', key='ascending_chords')
        self.__append_line_in_document(param_label=_("bxml fingering"),
                                       param_value=self.__get_settings_value('music_bxml', 'fingering'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&fingering"),
                                       section='music_bxml', key='fingering')
        self.__append_line_in_document(param_label=_("bxml clef"),
                                       param_value=self.__get_settings_value('music_bxml', 'clef'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&clef"),
                                       section='music_bxml', key='clef')
        self.__append_line_in_document(param_label=_("bxml parts"),
                                       param_value=self.__get_settings_value('music_bxml', 'parts'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&parts"),
                                       section='music_bxml', key='parts')
        self.__append_line_in_document(param_label=_("bxml measure b123"),
                                       param_value=self.__get_settings_value('music_bxml', 'measure_b123'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&measure b123"),
                                       section='music_bxml', key='measure_b123')
        self.__append_line_in_document(param_label=_("bxml measure number"),
                                       param_value=self.__get_settings_value('music_bxml', 'measure_number'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&measure number"),
                                       section='music_bxml', key='measure_number')
        self.__append_line_in_document(param_label=_("bxml measure every"),
                                       param_value=self.__get_settings_value('music_bxml', 'measure_every'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&measure every"),
                                       section='music_bxml', key='measure_every')
        self.__append_line_in_document(param_label=_("bxml view"),
                                       param_value=self.__get_settings_value('music_bxml', 'view'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&view"),
                                       section='music_bxml', key='view')
        self.__append_line_in_document(param_label=_("bxml section"),
                                       param_value=self.__get_settings_value('music_bxml', 'section'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&section"),
                                       section='music_bxml', key='section')
        self.__append_line_in_document(param_label=_("bxml measures per section"),
                                       param_value=self.__get_settings_value('music_bxml', 'measures_per_section'),
                                       dialog_box_name=_("music bxml"),
                                       dialog_box_param_name=_("&measures per section"), section='music_bxml',
                                       key='measures_per_section')
        self.__append_line_in_document(param_label=_("bxml words"),
                                       param_value=self.__get_settings_value('music_bxml', 'words'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&words"),
                                       section='music_bxml', key='words')
        self.__append_line_in_document(param_label=_("bxml credit words"),
                                       param_value=self.__get_settings_value('music_bxml', 'credit_words'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&credit words"),
                                       section='music_bxml', key='credit_words')
        self.__append_line_in_document(param_label=_("bxml lyrics"),
                                       param_value=self.__get_settings_value('music_bxml', 'lyrics'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&lyrics"),
                                       section='music_bxml', key='lyrics')
        self.__append_line_in_document(param_label=_("bxml karaoke"),
                                       param_value=self.__get_settings_value('music_bxml', 'karaoke'),
                                       dialog_box_name=_("music bxml"), dialog_box_param_name=_("&karaoke"),
                                       section='music_bxml', key='karaoke')

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("agenda"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("default presentation"),
                                       param_value=self.__get_settings_value('agenda', 'default_presentation'),
                                       dialog_box_name=_("agenda"), dialog_box_param_name=_("&presentation"),
                                       section='agenda', key='default_presentation')
        self.__append_line_in_document(param_label=_("at startup, report events not done"),
                                       param_value=self.__get_settings_value('agenda', 'remember'),
                                       dialog_box_name=_("agenda"), dialog_box_param_name=_("report events"),
                                       section='agenda', key='remember')

        self.__append_line_in_document()
        self.__append_line_in_document(_("write word and operation"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("use the vocal synthesis"),
                                       param_value=self.__get_settings_value('braille_learning', 'use_vocal'),
                                       dialog_box_name=_("braille learning"), dialog_box_param_name=_("&vocal"),
                                       section='braille_learning', key='use_vocal')
        self.__append_line_in_document(param_label=_("keeping spaces"),
                                       param_value=self.__get_settings_value('braille_learning', 'keep_spaces'),
                                       dialog_box_name=_("braille learning"), dialog_box_param_name=_("&spaces"),
                                       section='braille_learning', key='keep_spaces')
        self.__append_line_in_document(param_label=_("allow the wrong hit"),
                                       param_value=self.__get_settings_value('braille_learning', 'write_all'),
                                       dialog_box_name=_("braille learning"), dialog_box_param_name=_("&allow all"),
                                       section='braille_learning', key="write_all")

        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("keyboards"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("mode"),
                                       param_value=self.__get_stm32_value('stm32', 'keyboard_mode'),
                                       dialog_box_name=_("keyboard"), dialog_box_param_name=_("braille keyboard mode"),
                                       section='stm32', key='keyboard_mode')
        self.__append_line_in_document(param_label=_("b78"),
                                       param_value=self.__get_stm32_value('stm32', 'keyboard_b78'),
                                       dialog_box_name=_("keyboard"), dialog_box_param_name=_("braille keyboard b78"),
                                       section='stm32', key='keyboard_b78')
        self.__append_line_in_document(param_label=_("invertion"),
                                       param_value=self.__get_stm32_value('stm32', 'keyboard_invertion'),
                                       dialog_box_name=_("keyboard"), dialog_box_param_name=_("inversion"),
                                       section='stm32', key='keyboard_invertion')
        self.__append_line_in_document(param_label=_("light press"),
                                       param_value=self.__get_stm32_value('stm32', 'keyboard_light_press'),
                                       dialog_box_name=_("routing keyboard"), dialog_box_param_name=_("light press"),
                                       section='stm32', key='keyboard_light_press')
        self.__append_line_in_document(param_label=_("strong press"),
                                       param_value=self.__get_stm32_value('stm32', 'keyboard_strong_press'),
                                       dialog_box_name=_("routing keyboard"), dialog_box_param_name=_("strong press"),
                                       section='stm32', key='keyboard_strong_press')
        self.__append_line_in_document(param_label=_("consecutive press"),
                                       param_value=self.__get_stm32_value('stm32', 'keyboard_consecutive_press'),
                                       dialog_box_name=_("routing keyboard"), dialog_box_param_name=_("consecutive"),
                                       section='stm32', key='keyboard_consecutive_press')
        self.__append_line_in_document(param_label=_("double light press"),
                                       param_value=self.__get_stm32_value('stm32', 'keyboard_double_light_press'),
                                       dialog_box_name=_("routing keyboard"), dialog_box_param_name=_("double light"),
                                       section='stm32', key='keyboard_double_light_press')
        self.__append_line_in_document(param_label=_("double strong press"),
                                       param_value=self.__get_stm32_value('stm32', 'keyboard_double_strong_press'),
                                       dialog_box_name=_("routing keyboard"), dialog_box_param_name=_("double strong"),
                                       section='stm32', key='keyboard_double_strong_press')

        # Standby
        self.__append_line_in_document()
        self.__append_line_in_document(param_label=_("standby"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("transport timeout minute (0 none)"),
                                       param_value=self.__get_stm32_value('stm32', 'standby_transport'),
                                       dialog_box_name=_("standby"), dialog_box_param_name=_("transport"),
                                       section='stm32', key='standby_transport',
                                       auto_refresh_on_timer='standby_transport')
        self.__append_line_in_document(param_label=_("shutdown timeout minute (0 none)"),
                                       param_value=self.__get_stm32_value('stm32', 'standby_shutdown'),
                                       dialog_box_name=_("standby"), dialog_box_param_name=_("shutdown"),
                                       section='stm32', key='standby_shutdown',
                                       auto_refresh_on_timer='standby_shutdown')

        self.__append_line_in_document()
        # Update
        self.__append_line_in_document(param_label=_("update"), is_tab_stop=True)
        self.__append_line_in_document(param_label=_("automatically check for updates"),
                                       param_value=self.__get_settings_value('update', 'auto_check'),
                                       dialog_box_name=_("update"), dialog_box_param_name=_("&auto checking"),
                                       section='update', key='auto_check')
        ...
        self.__append_line_in_document(param_label=_("applications"), param_value=version.__version__,
                                       dialog_box_name=_("application versions"), dialog_box_param_name=_("version"),
                                       section='version', key='application')
        # Firmware version
        self.__append_line_in_document(param_label=_("firmware"),
    ...
    def __get_stm32_value(self, section, key, in_braille=False):
        try:
            return self.__translation_settings_dict(in_braille=in_braille)[(section, key)][
    ...
    def __get_stm32_current_value(self, section, key):
        values = {('stm32', 'usb_a_hid_keyboard'): braille_device_characteristics.get_usb_hid_mode(0),
                  ...
                  (
                      'stm32',
                      'keyboard_strong_press'): braille_device_characteristics.get_keyboard_routing_strong_press(),
                  ('stm32',
                   'keyboard_consecutive_press'): braille_device_characteristics.get_keyboard_routing_consecutive_press(),
                  ('stm32',
                   'keyboard_double_light_press'): braille_device_characteristics.get_keyboard_routing_double_light_press(),
                  ('stm32',
                   'keyboard_double_strong_press'): braille_device_characteristics.get_keyboard_routing_double_strong_press(),
    ...
    def __set_stm32_current_value(self, section, key, value):
        set_value_function = {('stm32', 'usb_a_hid_keyboard'): self.__set_usb_a_hid_mode,
                              ...
                              (
                                  'stm32',
                                  'keyboard_double_strong_press'): self.__set_keyboard_routing_double_strong_press,
    ...
    def __get_disk_space_value(self):
        ...
        msg = _("Total: {:.1f} GiB, Used: {:.1f} GiB, Free: {:.1f} GiB").format(total // (2 ** 30), used // (2 ** 30),
                                                                                free // (2 ** 30))
        return msg
    ...
    def __languages(filter_with_availables_translation=False, filter_with_available_speech_languages=False,
        ...
        if filter_with_available_speech_languages:
            ...
            filtered_languages_dict = {k: v for (k, v) in Translate.languages_dict.items() if
                                       k in available_speech_languages}
            return OrderedDict(sorted(filtered_languages_dict.items(), key=lambda t: t[1]))
    ...
    def __translation_settings_dict(self, in_braille=True):
        translated_dict = {
            ...
            ('music_xml', 'edit_mode'): {'expert': _("expert"), 'read': _("read"), 'edit': _("edit"),
                                         'listen': _("listen")},
            ('music_xml', 'braille_type'): {'dot-8': _("dot 8"), 'grade1': _("grade 1")},
            ('music_xml', 'notes_dots'): {"8_dots": _("8 dots"), "6_dots": _("6 dots"),
            ...
            ('music_xml', 'lyrics'): {"no": _("no"), "after_each_note": _("after each note"),
                                      "before_each_section": _("before each section"),
                                      "after_each_section": _("after each section")},
            ('music_bxml', 'edit_mode'): {'expert': _("expert"), 'read': _("read"), 'edit': _("edit"),
                                          'listen': _("listen")},
            ('music_bxml', 'braille_type'): {'dot-8': _("dot 8"), 'grade1': _("grade 1")},
            ('music_bxml', 'notes_dots'): {"8_dots": _("8 dots"), "6_dots": _("6 dots"),
                                           "6_dots_with_group": _("6 dots with group")},
            ...
            ('music_bxml', 'lyrics'): {"no": _("no"), "after_each_note": _("after each note"),
                                       "before_each_section": _("before each section"),
                                       "after_each_section": _("after each section")},
            ('system', 'braille_type'): {'dot-8': _("dot 8"), 'grade1': _("grade 1"), 'grade2': _("grade 2")},
            ('system', 'app_explorer'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                         'more_apps_menu': _("in more apps menu")},
            ('system', 'app_settings'): {'main_apps_menu': _("in main apps menu"),
                                         'more_apps_menu': _("in more apps menu")},
            ('system', 'app_agenda'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                       'more_apps_menu': _("in more apps menu")},
            ('system', 'app_radio'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                      'more_apps_menu': _("in more apps menu")},
            ('system', 'app_mp3'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                    'more_apps_menu': _("in more apps menu")},
            ('system', 'app_wikipedia'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                          'more_apps_menu': _("in more apps menu")},
            ('system', 'app_timer'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                      'more_apps_menu': _("in more apps menu")},
            ('system', 'app_translator'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                           'more_apps_menu': _("in more apps menu")},
            ('system', 'app_write_word'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                           'more_apps_menu': _("in more apps menu")},
            ('system', 'app_operation'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                          'more_apps_menu': _("in more apps menu")},
            ('system', 'app_mines'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                      'more_apps_menu': _("in more apps menu")},
            ('system', 'app_mastermind'): {'invisible': _("invisible"), 'main_apps_menu': _("in main apps menu"),
                                           'more_apps_menu': _("in more apps menu")},
            ...
            ('stm32', 'usb_a_hid_keyboard'): {
                braille_device_characteristics.UsbHidMode.KEYS_SEND_TO_SCREEN_READER: _("send to screen reader"),
            ...
            ('agenda', 'default_presentation'): {"standard": _("standard"), "not done": _("not done"),
                                                 "today": _("today"), "calendar": _("calendar")},
            ('agenda', 'remember'): {'no': _("no"), 'same': _("for the same day"), 'tomorrow': _("for the next day"),
    ...
    def __dialog_set_auto_switch(self, section, key, **kwargs):
        ...
        value = self.__document_area[self.__document_area_current_line_index]["mac_name"] in Settings().data[section][
            key]
    ...
    def __dialog_show_paired_devices(self, section, key, **kwargs):
        if bt_util.bluetooth_on_off():
            ...
            self._current_dialog = ui.UiDialogBox(
                ...
                item_list=[
                    ui.UiListBox(
                        name=self.__document_area[self.__document_area_current_line_index]["dialog_box_param_name"],
            ...
            self._current_dialog = ui.UiInfoDialogBox(message=_("bluetooth adapter is not powered"),
    ...
    def __dialog_set_wifi_favorites_settings(self, section, key, **kwargs):
        if WifiNmcliCommand.network_on_off():
            ...
            self._current_dialog = ui.UiInfoDialogBox(message=_("wifi adapter is not powered"),
                                                      action=self._exec_cancel_dialog)
    ...
    def _exec_valid_add_wifi_favorites_dialog(self):
        ...
        # Failed to delete access point.
        self._current_dialog = ui.UiInfoDialogBox(
            message=_("add failed"), action=self._exec_cancel_dialog,
    ...
    def __change_clock_date_and_time(self, *args, **kwargs) -> (bool, object()):
        ...
        try:
            ...
            self.__put_in_stm32_tx_queue(
                Stm32Frame(key=stm32_keys.KEY_DEVICE_DATE_AND_TIME, data=new_date_time.encode()))
        except ValueError:
            pass
    ...
    def _thread_check_update_ended(self, **kwargs):
        if self.update.version_to_install == 'up_to_date':
            if self.is_in_dialog:
                self._current_dialog = ui.UiInfoDialogBox(message=_("your b.note is up to date"),
                                                          action=self._exec_cancel_dialog)
            return
    ...
    def _exec_ask_download(self):
        message = _("the version {} of applications is available. Do you want to install it?").format(
            self.update.version_to_install)
        self._current_dialog = ui.UiMessageDialogBox(
            name=_("update"),
            message=message,
            buttons=[
    ...
    def _exec_auto_switch_ok_dialog(self, new_value):
        ...
        if new_value:
            ...
            if self.__document_area[self.__document_area_current_line_index]["mac_name"] not in \
            ...
            if self.__document_area[self.__document_area_current_line_index]["mac_name"] in Settings().data[section][
                key]:
        ...
        if not done:
            ...
            function_switcher = {
                ...
                (Keyboard.BrailleModifier.BRAILLE_FLAG_SHIFT,
                 Keyboard.BrailleFunction.BRAMIGRAPH_RIGHT): self._caret_right,
                (Keyboard.BrailleModifier.BRAILLE_FLAG_SHIFT, Keyboard.BrailleFunction.BRAMIGRAPH_UP): self._caret_up,
                (Keyboard.BrailleModifier.BRAILLE_FLAG_SHIFT,
                 Keyboard.BrailleFunction.BRAMIGRAPH_DOWN): self._caret_down,
                ...
                (
                    ...
                    Keyboard.BrailleFunction.BRAMIGRAPH_DOWN): self._caret_down,
                (Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL,
                 Keyboard.BrailleFunction.BRAMIGRAPH_HOME): self._caret_start_of_document,
                (Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL,
                 Keyboard.BrailleFunction.BRAMIGRAPH_END): self._caret_end_of_document,

                (Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL + Keyboard.BrailleModifier.BRAILLE_FLAG_SHIFT,
                 Keyboard.BrailleFunction.BRAMIGRAPH_LEFT): self._caret_up,
                (Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL + Keyboard.BrailleModifier.BRAILLE_FLAG_SHIFT,
                 Keyboard.BrailleFunction.BRAMIGRAPH_RIGHT): self._caret_right,
                (Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL + Keyboard.BrailleModifier.BRAILLE_FLAG_SHIFT,
                 Keyboard.BrailleFunction.BRAMIGRAPH_UP): self._caret_up,
                (Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL + Keyboard.BrailleModifier.BRAILLE_FLAG_SHIFT,
                 Keyboard.BrailleFunction.BRAMIGRAPH_DOWN): self._caret_down,
            }
    ...
    def _exec_valid_change_update_source(self):
        ...
        if test_new_source(new_source):
            ...
            self._current_dialog = UiInfoDialogBox(message=_("source not valid..."),
    ...
    def _exec_import_settings(self):
        ...
        self._current_dialog = ui.UiDialogBox(
            ...
            item_list=[
                ui.UiListBox(name=_("setting"), value=('files', files_list), current_index=0,
