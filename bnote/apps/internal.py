...
class Internal:
    ...
    def __init__(self, lou, put_in_function_queue, put_in_stm32_tx_queue):
        ...
        self.apps_descriptor = {
            "usb_1": self.AppDescriptor(
                "", _("usb-&a"), self._exec_usb_1, is_hide=False, is_auto_switch=False
            ),
            "usb_2": self.AppDescriptor(
                "", _("usb-&b"), self._exec_usb_2, is_hide=False, is_auto_switch=False
            ),
            "bluetooth_1": self.AppDescriptor(
                "",
                "bluetooth_&1",
                self._exec_bluetooth_1,
                is_hide=True,
                is_auto_switch=False,
            ),
            "bluetooth_2": self.AppDescriptor(
                "",
                "bluetooth_&2",
                self._exec_bluetooth_2,
                is_hide=True,
                is_auto_switch=False,
            ),
            "bluetooth_3": self.AppDescriptor(
                "",
                "bluetooth_&3",
                self._exec_bluetooth_3,
                is_hide=True,
                is_auto_switch=False,
            ),
            "bluetooth_4": self.AppDescriptor(
                "",
                "bluetooth_&4",
                self._exec_bluetooth_4,
                is_hide=True,
                is_auto_switch=False,
            ),
            "editor_1": self.AppDescriptor(
                "", "editor_&5", self._exec_editor_1, is_hide=True, is_auto_switch=True
            ),
            "editor_2": self.AppDescriptor(
                "", "editor_&6", self._exec_editor_2, is_hide=True, is_auto_switch=True
            ),
            "editor_3": self.AppDescriptor(
                "", "editor_&7", self._exec_editor_3, is_hide=True, is_auto_switch=True
            ),
            "editor_4": self.AppDescriptor(
                "", "editor_&8", self._exec_editor_4, is_hide=True, is_auto_switch=True
            ),
            "editor_5": self.AppDescriptor(
                "", "editor_&9", self._exec_editor_5, is_hide=True, is_auto_switch=True
            ),
            "explorer": self.AppDescriptor(
                "",
                self.__app_translate("explorer"),
                self._exec_explorer,
                is_hide=False,
                is_auto_switch=True,
            ),
            "settings": self.AppDescriptor(
                "",
                self.__app_translate("settings"),
                self._exec_settings,
                is_hide=False,
                is_auto_switch=True,
            ),
            "agenda": self.AppDescriptor(
                "",
                self.__app_translate("agenda"),
                self._exec_agenda,
                is_hide=False,
                is_auto_switch=True,
            ),
            "radio": self.AppDescriptor(
                "",
                self.__app_translate("radio"),
                self._exec_radio,
                is_hide=False,
                is_auto_switch=True,
            ),
            "mp3": self.AppDescriptor(
                "",
                self.__app_translate("mp3"),
                self._exec_mp3,
                is_hide=False,
                is_auto_switch=True,
            ),
            "wikipedia": self.AppDescriptor(
                "",
                self.__app_translate("wikipedia"),
                self._exec_wikipedia,
                is_hide=False,
                is_auto_switch=True,
            ),
            "timer": self.AppDescriptor(
                "",
                self.__app_translate("timer"),
                self._exec_timer,
                is_hide=False,
                is_auto_switch=True,
            ),
            "translator": self.AppDescriptor(
                "",
                _("trans&lator"),
                self._exec_translator,
                is_hide=False,
                is_auto_switch=True,
            ),
            "write_word": self.AppDescriptor(
                "",
                self.__app_translate("write_word"),
                self._exec_write_word,
                is_hide=False,
                is_auto_switch=True,
            ),
            "operation": self.AppDescriptor(
                "",
                self.__app_translate("operation"),
                self._exec_operation,
                is_hide=False,
                is_auto_switch=True,
            ),
            "mines": self.AppDescriptor(
                "",
                self.__app_translate("mines"),
                self._exec_mines,
                is_hide=False,
                is_auto_switch=True,
            ),
            "mastermind": self.AppDescriptor(
                "",
                self.__app_translate("mastermind"),
                self._exec_mastermind,
                is_hide=False,
                is_auto_switch=True,
            ),
            "skeleton": self.AppDescriptor(
                "",
            ...
            "more_apps_menu": self.AppDescriptor(
                "sub_menu",
                self.__app_translate("more_apps_menu"),
                self._more_apps_menu,
                is_hide=False,
                is_auto_switch=True,
            ),
            "explorer_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("explorer_2"),
                self._exec_explorer_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "settings_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("settings_2"),
                self._exec_settings_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "agenda_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("agenda_2"),
                self._exec_agenda_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "radio_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("radio_2"),
                self._exec_radio_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "mp3_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("mp3_2"),
                self._exec_mp3_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "wikipedia_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("wikipedia_2"),
                self._exec_wikipedia_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "timer_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("timer_2"),
                self._exec_timer_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "translator_2": self.AppDescriptor(
                "more_apps_menu",
                _("trans&lator"),
                self._exec_translator_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "write_word_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("write_word_2"),
                self._exec_write_word_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "operation_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("operation_2"),
                self._exec_operation_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "mines_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("mines_2"),
                self._exec_mines_2,
                is_hide=False,
                is_auto_switch=True,
            ),
            "mastermind_2": self.AppDescriptor(
                "more_apps_menu",
                self.__app_translate("mastermind_2"),
                self._exec_mastermind_2,
                is_hide=False,
                is_auto_switch=True,
            ),
        }
            ...
            if app_descriptor.parent == "sub_menu":
                ...
                for submenu_key, submenu_app_descriptor in self.apps_descriptor.items():
                    if submenu_app_descriptor.parent == key:
                        submenu_items.append(
                            ui.UiMenuItem(
                                name=submenu_app_descriptor.name,
                                action=submenu_app_descriptor.action,
                            )
                        )
                ...
                menu_item_list.append(
                    ui.UiMenuBar(
                        name=app_descriptor.name,
                        action=app_descriptor.action,
                        menu_item_list=submenu_items,
                    ),
                )
        # Add turn off sub-menu
        menu_item_list.append(
            ui.UiMenuItem(name=_("transport"), action=self._exec_ask_transport)
        ),
        menu_item_list.append(
            ui.UiMenuItem(name=_("shutdown"), action=self._exec_ask_shutdown)
        ),
        # Add menu bar title.
        ...
        self.apps_descriptor["explorer"].instance = FileManagerApp(
            self._put_in_function_queue, report_a_crash=report_a_crash
        )
        if report_a_crash:
    ...
    def verify_agenda_or_restore_editor(self):
        if (
            Settings().data["agenda"]["remember"] == "same"
    ...
    def restore_editor(self):
        if editor.Context.is_integrity_then_delete():
            while True:
                ...
                if filename:
                    self.__add_editor_app(
                        language="FR", filename=Path(filename), editor_app=editor_app
                    )
    ...
    def translate_ui(self):
        ...
        for key, app_descriptor in self.apps_descriptor.items():
            if not (
                (key in self.apps_editor)
                or (key in self.apps_bluetooth)
                or (key == "usb_1")
                or (key == "usb_2")
            ):
                # Retranslate all menu app items except editor, bluetooth and usb apps.
                self._menu.rename_item(
                    self.__app_translate(key), braille_type, app_descriptor.action
                )
    ...
    def usb_app_name_changed(self, data):
        ...
        if usb_a_name == "":
            self._menu.rename_item(
                _("usb_&a"), braille_type, self.apps_descriptor["usb_1"].action
            )
        else:
            self._menu.rename_item(
                usb_a_name, braille_type, self.apps_descriptor["usb_1"].action
            )
        if usb_b_name == "":
            self._menu.rename_item(
                _("usb_&b"), braille_type, self.apps_descriptor["usb_2"].action
            )
        else:
            self._menu.rename_item(
                usb_b_name, braille_type, self.apps_descriptor["usb_2"].action
            )
            ...
            if isinstance(self._current_app, BluetoothApp):
                if self._current_app.activate_channel():
                    self._put_in_stm32_tx_queue(
                        Stm32Frame(
                            key=stm32_keys.KEY_BLUETOOTH_FUNCTION_ENTER, data=b""
                        )
                    )
            else:
    ...
    def _exec_agenda(self):
        ...
        if not self.apps_descriptor["agenda"].instance:
            self.apps_descriptor["agenda"].instance = AgendaApp(
    ...
    def _exec_write_word(self):
        ...
        if not self.apps_descriptor["write_word"].instance:
            self.apps_descriptor["write_word"].instance = WriteWordApp(
                self._put_in_function_queue
            )
    ...
    def _exec_operation(self):
        ...
        if not self.apps_descriptor["operation"].instance:
            self.apps_descriptor["operation"].instance = OperationApp(
                self._put_in_function_queue
            )
    ...
    def _exec_skeleton(self):
        ...
        if not self.apps_descriptor["skeleton"].instance:
            self.apps_descriptor["skeleton"].instance = SkeletonApp(
                self._put_in_function_queue
            )
    ...
    def _exec_timer(self):
        if not self.apps_descriptor["timer"].instance:
            self.apps_descriptor["timer"].instance = TimerApp(
                self._put_in_function_queue
            )
    ...
    def _exec_translator(self, **kwargs):
        if not self.apps_descriptor["translator"].instance:
            self.apps_descriptor["translator"].instance = TranslatorApp(
                self._put_in_function_queue, **kwargs
            )
        else:
    ...
    def _exec_radio(self):
        ...
        if not self.apps_descriptor["radio"].instance:
            self.apps_descriptor["radio"].instance = RadioApp(
                self._put_in_function_queue
            )
    ...
    def _exec_mp3(self, **kwargs):
        ...
        if not self.apps_descriptor["mp3"].instance:
            self.apps_descriptor["mp3"].instance = Mp3App(
                self._put_in_function_queue, **kwargs
            )
        else:
    ...
    def _exec_wikipedia(self, **kwargs):
        if not self.apps_descriptor["wikipedia"].instance:
            self.apps_descriptor["wikipedia"].instance = WikipediaApp(
                self._put_in_function_queue, **kwargs
            )
    ...
    def _exec_mines(self):
        ...
        if not self.apps_descriptor["mines"].instance:
            self.apps_descriptor["mines"].instance = MinesApp(
                self._put_in_function_queue
            )
    ...
    def _exec_mastermind(self):
        ...
        if not self.apps_descriptor["mastermind"].instance:
            self.apps_descriptor["mastermind"].instance = MasterMindApp(
                self._put_in_function_queue
            )
    ...
    def __change_editor_name(self, app_instance, new_file, old_file):
        ...
        for editor_app in editor_apps:
            if app_instance == self.apps_descriptor[editor_app].instance:
                ui_object = self._menu.get_object_from_action(
                    self.apps_descriptor[editor_app].action
                )
                ui_object.rename_without_shortcut(
                    Path(app_instance.get_filename()).name
                )
                break
    ...
    def input_function(self, *args, **kwargs) -> bool:
        ...
        if not done:
            if "app" in kwargs.keys():
                ...
                if function_id == FunctionId.FUNCTION_SAVE_AND_DELETE_ORIGINAL:
                    ...
                    self.__change_editor_name(
                        app_instance,
                        app_instance.get_filename(),
                    ...
                    log.error(
                        f"FUNCTION_CHANGE_LOCKED_FILE {kwargs['old_file']=} {kwargs['new_file']=}"
                    )
                    self.__change_editor_name(
                        app_instance, kwargs["new_file"], kwargs["old_file"]
                    )
                    done = True
                else:
        ...
        if not done:
            ...
            if function_id == FunctionId.APPLICATIONS:
                ...
                self.apps_descriptor["explorer"].instance.synch_to_file(
                    Path(str(kwargs["filename"]) + ".txt")
                )
                self.__refresh_display_after_function()
    ...
    def input_braille(self, data) -> bool:
        ...
        if self._current_app and not isinstance(self._current_app, BluetoothApp):
            (braille_type, braille_modifier, braille_value) = (
                BnoteApp.keyboard.decode_braille(BnoteApp.lou, data)
            )
            log.info(f"{braille_type=} {braille_modifier=} {braille_value=}")
            if braille_modifier == Keyboard.BrailleModifier.BRAILLE_FLAG_WIN:
                if (
                    braille_type == Keyboard.BrailleType.FUNCTION
                    and braille_value == Keyboard.BrailleFunction.BRAMIGRAPH_LWIN
                ):
                    self._put_in_function_queue(FunctionId.APPLICATIONS)
                    return True
                else:
        ...
        if (
            braille_modifier == Keyboard.BrailleModifier.BRAILLE_FLAG_CTRL
        ...
        if self._current_app:
            log.info(
                "call self._apps[self._current_app_index].input_character({})".format(
                    data
                )
            )
            ...
            if braille_type == Keyboard.BrailleType.CHARACTER:
                done = self._menu.input_character(
                    braille_modifier, str(braille_value), data
                )
    ...
    def input_command(self, data, modifier, key_id) -> bool:
        ...
        if key_id == Keyboard.KeyId.KEY_MEDIA_VOLUME_DOWN:
            ...
            log.info(
                "call self._apps[self._current_app_index].input_command({})".format(
                    data
                )
            )
    ...
    def shutdown_apps(self):
        for app_descriptor in self.apps_descriptor.values():
            if app_descriptor.instance:
                ...
                app_descriptor.instance.shutdown(
                    self._current_app == app_descriptor.instance
                )
        for app_descriptor in self.apps_descriptor.values():
            if app_descriptor.instance:
    ...
    def __settings_change(self, **kwargs):
        if (
            ((kwargs["section"] == "system") and (kwargs["key"] == "braille_type"))
            or (
                (kwargs["section"] == "system")
                and (kwargs["key"] == "shortcuts_visible")
            )
            or (
                (kwargs["section"] == "system") and (kwargs["key"] == "spaces_in_label")
            )
        ):
    ...
    def __get_used_dynamic_apps(self, apps_list):
        ...
        apps = [
            ...
            if not self._menu.get_object(self.apps_descriptor[app].action).is_hide()
        ]
        return apps
    ...
    def __add_bluetooth_app(self, *args, **kwargs):
        ...
        if "id" in kwargs and "name" in kwargs:
            ...
            log.info(f"{name=}")
            app_descriptor, ui_object = self.__get_available_dynamic_apps(
                self.apps_bluetooth
            )
            if ui_object:
                ui_object.unhide()
                ...
                app_descriptor.instance = BluetoothApp(
                    self._put_in_function_queue, self._put_in_stm32_tx_queue, id_
                )
    ...
    def __add_editor_app(self, language, filename, read_only=None, editor_app=None):
        ...
        if editor_app is None:
            ...
            for used_editor_app in editor_apps:
                log.info(
                    f"{filename=}=?{self.apps_descriptor[used_editor_app].instance.get_filename()=}"
                )
                if filename == Path(
                    self.apps_descriptor[used_editor_app].instance.get_filename()
                ):
                    # This File is already open
                    log.info("file already open")
                    app_descriptor = self.apps_descriptor[used_editor_app]
                    ui_object = self._menu.get_object(
                        self.apps_descriptor[used_editor_app].action
                    )
    ...
    def __remove_bluetooth_app(self, *args, **kwargs):
        if "id" in kwargs:
            ...
            for bluetooth_app in bluetooth_apps:
                if (
                    self.apps_descriptor[bluetooth_app].instance.get_bluetooth_id()
                    == id_
                ):
                    if (
                        self._current_app
                        == self.apps_descriptor[bluetooth_app].instance
                    ):
                    ...
                    ui_object = self._menu.get_object_from_action(
                        self.apps_descriptor[bluetooth_app].action
                    )
                    ui_object.hide()
    ...
    def __remove_editor_app(self, *args, **kwargs):
        ...
        for editor_app in editor_apps:
            if editor_instance == self.apps_descriptor[editor_app].instance:
                ...
                ui_object.hide()
                # Unlock the file
                self.apps_descriptor["explorer"].instance.remove_locked_file(
                    editor_instance.get_filename()
                )
