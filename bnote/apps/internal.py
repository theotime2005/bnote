...
from bnote.apps.terminal.terminal_app import TerminalApp
...
class Internal:
    ...
    def __init__(self, lou, put_in_function_queue, put_in_stm32_tx_queue):
        ...
        self.apps_descriptor = {
            ...
            'terminal': self.AppDescriptor('', self.__app_translate('terminal'), self._exec_terminal, is_hide=False, is_auto_switch=True),
            ...
            'terminal_2': self.AppDescriptor('more_apps_menu', self.__app_translate('terminal_2'), self._exec_terminal_2, is_hide=False, is_auto_switch=True),
        }
    ...
    def __hide_unhide_menu_items(self):
        hidden_menu = [
            ...
            ('app_terminal', self._exec_terminal, self._exec_terminal_2),
        ]
    ...
    def _exec_terminal(self):
        log.info("exec_terminal")
        if not self.apps_descriptor['terminal'].instance:
            self.apps_descriptor['terminal'].instance = TerminalApp(self._put_in_function_queue)
        self.set_current_app(self.apps_descriptor['terminal'].instance)

    def _exec_terminal_2(self):
        self._exec_terminal()
