...
class UiListBox(UiObject):
    ...
    def __init__(self, name, value, current_index=0, extra_parameters=None):
        ...
        super(UiListBox, self).__init__(**kwargs)
    ...
    def get_presentation(self):
        ...
        """
        text_objects, braille_objects, braille_blinking, id_array_objects = super(UiListBox, self).get_presentation()
    ...
    def exec_bramigraph(self, modifier, bramigraph) -> (bool, bool):
        ...
        return super(UiListBox, self).exec_bramigraph(modifier, bramigraph)
