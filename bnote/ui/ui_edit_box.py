...
from tools.clipboard import copy, paste
...
class UiEditBox(UiObject):
    ...
    def __init__(self, name, value, no_grade=False):
        ...
        # Call base class.
        super(UiEditBox, self).__init__(**kwargs)
        # manage value.
    ...
    def get_presentation(self):
        ...
        if self._is_hide:
            ...
            text_objects, braille_objects, braille_blinking, id_array_objects = super(UiEditBox, self).get_presentation()
    ...
    def on_focus_lost(self, with_speaking):
        ...
        # edit mode turn off
        self._editing = False
        super(UiEditBox, self).on_focus_lost(with_speaking)
    ...
    def exec_bramigraph(self, modifier, bramigraph) -> (bool, bool):
        ...
        return super(UiEditBox, self).exec_bramigraph(modifier, bramigraph)
    ...
    def __exec_select_all(self, **kwargs):
        self._caret = Caret()
        self._caret.end = len(self.braille_value)
    ...
    def _delete(self, **kwargs) -> (bool, bool):
        ...
        if not self._caret.is_selection_empty():
            ...
            if self._caret.end > 0:
                ...
                self._caret.end -= 1
                self._caret.start = self._caret.start
        self._is_modified_value = True
        return True, True
