...
class UiMultiLinesBox(UiContainer):
    ...
    def __init__(self, name, value, no_grade=False, is_read_only=False):
        ...
        # Call base class.
        super(UiMultiLinesBox, self).__init__(**kwargs)
        # manage value.
    ...
    def get_presentation(self):
        ...
        if self._is_hide:
            ...
            return super(UiMultiLinesBox, self).get_presentation()
        else:
    ...
    def on_focus_lost(self, with_speaking):
        ...
        # edit mode turn off
        self._editing = False
        super(UiMultiLinesBox, self).on_focus_lost(with_speaking)
    ...
    def exec_bramigraph(self, modifier, bramigraph) -> (bool, bool):
        ...
        return super(UiMultiLinesBox, self).exec_bramigraph(modifier, bramigraph)
