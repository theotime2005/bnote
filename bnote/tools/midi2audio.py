...
DP FIXME This file could be deleted later if timidity used is valid.
"""
...
class FluidSynth():
    ...
    def midi_to_audio(self, midi_file, audio_file):
        subprocess.call(['fluidsynth', '-ni', self.sound_font, midi_file, '-g', '0.8', '-F', audio_file, '-r', str(self.sample_rate)])
