...
def generate_report():
    ...
    now = datetime.now()
    date_time = "{}-{}-{} {}h{}m{}s".format(now.year, f"{now.month:02d}", f"{now.day:02d}",
    ...
    crash_file_name = FileManager.get_crash_path() / Path("crash {}.txt".format(date_time))
    ...
    with open(raw_crash_file_name, 'r') as crash_report_file:
        with open(crash_file_name, 'w') as crash_report_file_ok:
            ...
            header_lines = ["date={}\n".format(date_time), "applications={}\n".format(version.__version__),
                            "firmware={}\n".format(braille_device_characteristics.get_firmware_version()),
                            "sdcard={}\n".format(__sdcard_version),
                            "serial={}\n".format(braille_device_characteristics.get_serial_number()),
                            "exception type={}\n".format(except_type),
