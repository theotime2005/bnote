...
class VolumeDialogBox(UiDialogBox):
    def __init__(self, dialog_box_name, edit_box_name, callback_save_the_new_volume, channel='speech'):
        ...
        item_list = [
                UiButton(name=_("volume &up"), action=self._exec_volume_up, is_auto_close=False),
                UiButton(name=_("volume &down"), action=self._exec_volume_down, is_auto_close=False),
                UiEditBox(name=edit_box_name, value=("volume", str(self.__old_volume))),
                UiButton(name=_("&ok"), action=self._exec_valid_set_volume_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_set_volume_dialog)
            ]
...
class SpeedDialogBox(UiDialogBox):
    def __init__(self, dialog_box_name, edit_box_name, callback_save_the_new_speed, current_speed, speed_range):
        ...
        item_list = [
                UiButton(name=_("speed &up"), action=self._speed_up, is_auto_close=False),
                UiButton(name=_("speed &down"), action=self._speed_down, is_auto_close=False),
                UiEditBox(name=edit_box_name, value=("speed", str(self.__old_speed))),
                UiButton(name=_("&ok"), action=self._exec_valid_set_speed_dialog),
                UiButton(name=_("&cancel"), action=self._exec_cancel_set_speed_dialog)
            ]
